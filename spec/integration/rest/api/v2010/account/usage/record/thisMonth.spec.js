...
describe('ThisMonth', function() {
  ...
  it('should treat the second arg as a callback',
    function(done) {
      ...
      client.api.v2010.accounts('ACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')
                      .usage
                      .records
                      .thisMonth.each({pageSize: 20}, () => done());
  ...
  it('should find the callback in the opts object',
    function(done) {
      ...
      client.api.v2010.accounts('ACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')
                      .usage
                      .records
                      .thisMonth.each({callback: () => done()}, () => fail('wrong callback!'));
    }
  );
  it('should generate valid list request',
    function(done) {
      ...
      var url = `https://api.twilio.com/2010-04-01/Accounts/${accountSid}/Usage/Records/ThisMonth.json`;
