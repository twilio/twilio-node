...
describe('Service', function() {
  ...
  it('should generate valid fetch request',
    function(done) {
      ...
      var promise = client.ipMessaging.v1.services('ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX').fetch();
      ...
      var url = `https://ip-messaging.twilio.com/v1/Services/${sid}`;
  ...
  it('should generate valid remove request',
    function(done) {
      ...
      var promise = client.ipMessaging.v1.services('ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX').remove();
      promise.then(function() {
        throw new Error('failed');
      }, function(error) {
        expect(error.constructor).toBe(RestException.prototype.constructor);
  ...
  it('should treat the first each arg as a callback',
    function(done) {
      ...
      holodeck.mock(new Response(200, body));
      client.ipMessaging.v1.services.each(() => done());
    }
  );
  it('should treat the second arg as a callback',
    function(done) {
      ...
      holodeck.mock(new Response(200, body));
      client.ipMessaging.v1.services.each({pageSize: 20}, () => done());
      holodeck.assertHasRequest(new Request({
          method: 'GET',
          url: 'https://ip-messaging.twilio.com/v1/Services',
          params: {PageSize: 20},
  ...
  it('should find the callback in the opts object',
    function(done) {
      ...
      holodeck.mock(new Response(200, body));
      client.ipMessaging.v1.services.each({callback: () => done()}, () => fail('wrong callback!'));
    }
  );
  ...
  it('should generate valid update request',
    function(done) {
      ...
      var promise = client.ipMessaging.v1.services('ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX').update();
      promise.then(function() {
        throw new Error('failed');
      }, function(error) {
        expect(error.constructor).toBe(RestException.prototype.constructor);
