...
describe('Entity', function() {
  ...
  it('should generate valid create request',
    function() {
      ...
      var promise = client.preview.authy.services('ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')
      ...
      var url = _.template('https://preview.twilio.com/Authy/Services/<%= serviceSid %>/Entities')(solution);
  ...
  it('should treat the second arg as a callback',
    function(done) {
      ...
      holodeck.assertHasRequest(new Request({
          method: 'GET',
          url: 'https://preview.twilio.com/Authy/Services/<%= serviceSid %>/Entities',
          params: {PageSize: 20},
      }));
    }
  );
  ...
  it('should generate valid fetch request',
    function() {
      ...
      var url = _.template('https://preview.twilio.com/Authy/Services/<%= serviceSid %>/Entities/<%= identity %>')(solution);
