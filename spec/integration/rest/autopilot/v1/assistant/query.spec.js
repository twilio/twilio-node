...
describe('Query', function() {
  ...
  it('should generate valid fetch request',
    function() {
      ...
      var url = _.template('https://autopilot.twilio.com/v1/Assistants/<%= assistantSid %>/Queries/<%= sid %>')(solution);
  ...
  it('should generate valid list request',
    function() {
      ...
      var url = _.template('https://autopilot.twilio.com/v1/Assistants/<%= assistantSid %>/Queries')(solution);
