...
describe('FieldValue', function() {
  ...
  it('should generate valid fetch request',
    function() {
      ...
      var url = _.template('https://autopilot.twilio.com/v1/Assistants/<%= assistantSid %>/FieldTypes/<%= fieldTypeSid %>/FieldValues/<%= sid %>')(solution);
  ...
  it('should treat the second arg as a callback',
    function(done) {
      ...
      holodeck.assertHasRequest(new Request({
          method: 'GET',
          url: 'https://autopilot.twilio.com/v1/Assistants/<%= assistantSid %>/FieldTypes/<%= fieldTypeSid %>/FieldValues',
          params: {PageSize: 20},
      }));
    }
  );
  ...
  it('should generate valid list request',
    function() {
      ...
      var url = _.template('https://autopilot.twilio.com/v1/Assistants/<%= assistantSid %>/FieldTypes/<%= fieldTypeSid %>/FieldValues')(solution);
