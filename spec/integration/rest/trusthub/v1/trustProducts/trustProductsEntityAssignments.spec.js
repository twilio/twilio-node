...
describe('TrustProductsEntityAssignments', function() {
  beforeEach(function() {
  ...
  it('should treat the first each arg as a callback',
    function(done) {
      ...
      client.trusthub.v1.trustProducts('BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')
                        .trustProductsEntityAssignments.each(() => done());
    }
  );
  it('should treat the second arg as a callback',
    function(done) {
      ...
      holodeck.mock(new Response(200, body));
      client.trusthub.v1.trustProducts('BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')
                        .trustProductsEntityAssignments.each({pageSize: 20}, () => done());
      holodeck.assertHasRequest(new Request({
          method: 'GET',
  ...
  it('should find the callback in the opts object',
    function(done) {
      ...
      holodeck.mock(new Response(200, body));
      client.trusthub.v1.trustProducts('BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')
                        .trustProductsEntityAssignments.each({callback: () => done()}, () => fail('wrong callback!'));
    }
  );
  ...
  it('should generate valid fetch request',
    function(done) {
      ...
      var url = `https://trusthub.twilio.com/v1/TrustProducts/${trustProductSid}/EntityAssignments/${sid}`;
  ...
  it('should generate valid remove request',
    function(done) {
      ...
      var promise = client.trusthub.v1.trustProducts('BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')
                                      .trustProductsEntityAssignments('BVXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX').remove();
      promise.then(function() {
        throw new Error('failed');
      }, function(error) {
        expect(error.constructor).toBe(RestException.prototype.constructor);
