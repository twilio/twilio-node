...
describe('CustomerProfilesEvaluations', function() {
  beforeEach(function() {
  ...
  it('should generate valid create request',
    function(done) {
      ...
      var opts = {policySid: 'BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX'};
  ...
  it('should treat the first each arg as a callback',
    function(done) {
      ...
      client.trusthub.v1.customerProfiles('BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')
                        .customerProfilesEvaluations.each(() => done());
    }
  );
  it('should treat the second arg as a callback',
    function(done) {
      ...
      holodeck.mock(new Response(200, body));
      client.trusthub.v1.customerProfiles('BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')
                        .customerProfilesEvaluations.each({pageSize: 20}, () => done());
      holodeck.assertHasRequest(new Request({
          method: 'GET',
          url: 'https://trusthub.twilio.com/v1/CustomerProfiles/${customerProfileSid}/Evaluations',
          params: {PageSize: 20},
      }));
    }
  );
  it('should find the callback in the opts object',
    function(done) {
      ...
      holodeck.mock(new Response(200, body));
      client.trusthub.v1.customerProfiles('BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')
                        .customerProfilesEvaluations.each({callback: () => done()}, () => fail('wrong callback!'));
    }
  );
  it('should generate valid list request',
    function(done) {
      ...
      var promise = client.trusthub.v1.customerProfiles('BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')
                                      .customerProfilesEvaluations.list();
      promise.then(function() {
        throw new Error('failed');
      }, function(error) {
        expect(error.constructor).toBe(RestException.prototype.constructor);
  ...
  it('should generate valid fetch request',
    function(done) {
      ...
      var url = `https://trusthub.twilio.com/v1/CustomerProfiles/${customerProfileSid}/Evaluations/${sid}`;
