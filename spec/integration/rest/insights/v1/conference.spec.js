...
describe('Conference', function() {
  ...
  it('should generate valid fetch request',
    function(done) {
      ...
      var promise = client.insights.v1.conferences('CFXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX').fetch();
      ...
      var url = `https://insights.twilio.com/v1/Conferences/${conferenceSid}`;
  ...
  it('should treat the first each arg as a callback',
    function(done) {
      ...
      holodeck.mock(new Response(200, body));
      client.insights.v1.conferences.each(() => done());
    }
  );
  it('should treat the second arg as a callback',
    function(done) {
      ...
      holodeck.mock(new Response(200, body));
      client.insights.v1.conferences.each({pageSize: 20}, () => done());
      holodeck.assertHasRequest(new Request({
          method: 'GET',
  ...
  it('should find the callback in the opts object',
    function(done) {
      ...
      holodeck.mock(new Response(200, body));
      client.insights.v1.conferences.each({callback: () => done()}, () => fail('wrong callback!'));
    }
  );
  it('should generate valid list request',
    function(done) {
      ...
      var promise = client.insights.v1.conferences.list();
      promise.then(function() {
        throw new Error('failed');
      }, function(error) {
        expect(error.constructor).toBe(RestException.prototype.constructor);
      ...
      var url = 'https://insights.twilio.com/v1/Conferences';
  ...
  it('should generate valid read_with_region response',
    function(done) {
      var body = {
          'meta': {
              'page': 0,
  ...
  it('should generate valid read_with_friendlyname_startfailure response',
    function(done) {
      var body = {
          'meta': {
              'page': 0,
  ...
  it('should generate valid read_with_duplicate_identity response',
    function(done) {
      var body = {
          'meta': {
              'page': 0,
  ...
  it('should generate valid read_with_detected_issue_endreason response',
    function(done) {
      var body = {
          'meta': {
              'page': 0,
