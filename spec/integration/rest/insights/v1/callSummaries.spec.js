...
describe('CallSummaries', function() {
  ...
  it('should generate valid read_with_carrier response',
    function(done) {
      var body = {
          'meta': {
              'page': 0,
  ...
  it('should generate valid read_with_subaccount response',
    function(done) {
      var body = {
          'meta': {
              'page': 0,
  ...
  it('should generate valid read_with_trust response',
    function(done) {
      var body = {
          'meta': {
              'page': 0,
  ...
  it('should generate valid read_with_abnormal_session response',
    function(done) {
      var body = {
          'meta': {
              'page': 0,
