...
describe('Day', function() {
  ...
  it('should generate valid fetch request',
    function(done) {
      ...
      var day = 'day';
      var url = `https://bulkexports.twilio.com/v1/Exports/${resourceType}/Days/${day}`;
  ...
  it('should treat the second arg as a callback',
    function(done) {
      ...
      holodeck.assertHasRequest(new Request({
          method: 'GET',
          url: 'https://bulkexports.twilio.com/v1/Exports/${resourceType}/Days',
          params: {PageSize: 20},
      }));
    }
  );
  ...
  it('should generate valid list request',
    function(done) {
      ...
      var resourceType = 'resource_type';
      var url = `https://bulkexports.twilio.com/v1/Exports/${resourceType}/Days`;
