...
describe('UserConversation', function() {
  ...
  it('should generate valid update request',
    function(done) {
      ...
      var promise = client.conversations.v1.users('USXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')
      ...
      var url = `https://conversations.twilio.com/v1/Users/${userSid}/Conversations/${conversationSid}`;
  ...
  it('should treat the second arg as a callback',
    function(done) {
      ...
      holodeck.assertHasRequest(new Request({
          method: 'GET',
          url: 'https://conversations.twilio.com/v1/Users/${userSid}/Conversations',
          params: {PageSize: 20},
      }));
    }
  );
  ...
  it('should generate valid list request',
    function(done) {
      ...
      var userSid = 'USXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
      var url = `https://conversations.twilio.com/v1/Users/${userSid}/Conversations`;
