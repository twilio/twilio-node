...
describe('Binding', function() {
  ...
  it('should generate valid remove request',
    function(done) {
      ...
      var url = `https://conversations.twilio.com/v1/Services/${chatServiceSid}/Bindings/${sid}`;
  ...
  it('should treat the second arg as a callback',
    function(done) {
      ...
      holodeck.assertHasRequest(new Request({
          method: 'GET',
          url: 'https://conversations.twilio.com/v1/Services/${chatServiceSid}/Bindings',
          params: {PageSize: 20},
      }));
    }
  );
  ...
  it('should generate valid list request',
    function(done) {
      ...
      var chatServiceSid = 'ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
      var url = `https://conversations.twilio.com/v1/Services/${chatServiceSid}/Bindings`;
