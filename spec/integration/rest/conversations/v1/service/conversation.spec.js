...
describe('Conversation', function() {
  ...
  it('should generate valid create request',
    function(done) {
      ...
      var url = `https://conversations.twilio.com/v1/Services/${chatServiceSid}/Conversations`;
  ...
  it('should generate valid update request',
    function(done) {
      ...
      var url = `https://conversations.twilio.com/v1/Services/${chatServiceSid}/Conversations/${sid}`;
  ...
  it('should generate valid delete response',
    function(done) {
      ...
      var promise = client.conversations.v1.services('ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')
                                           .conversations('CHXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX').remove();
      promise.then(function(response) {
  ...
  it('should treat the second arg as a callback',
    function(done) {
      ...
      holodeck.mock(new Response(200, body));
      client.conversations.v1.services('ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')
                             .conversations.each({pageSize: 20}, () => done());
      holodeck.assertHasRequest(new Request({
          method: 'GET',
          url: 'https://conversations.twilio.com/v1/Services/${chatServiceSid}/Conversations',
          params: {PageSize: 20},
      }));
    }
  );
  it('should find the callback in the opts object',
    function(done) {
      ...
      holodeck.mock(new Response(200, body));
      client.conversations.v1.services('ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')
                             .conversations.each({callback: () => done()}, () => fail('wrong callback!'));
    }
  );
