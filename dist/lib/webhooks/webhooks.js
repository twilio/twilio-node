...
function validateRequest(authToken, twilioHeader, url, params) {
    ...
    const validSignatureWithPort = (0, scmp_1.default)(Buffer.from(twilioHeader), Buffer.from(signatureWithPort));
    const validSignatureWithoutPort = (0, scmp_1.default)(Buffer.from(twilioHeader), Buffer.from(signatureWithoutPort));
...
function validateBody(body, bodyHash) {
    ...
    return (0, scmp_1.default)(Buffer.from(bodyHash), Buffer.from(expectedHash));
}
