...
export class SubscribedEventContextImpl implements SubscribedEventContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<SubscribedEventInstance>) => any): Promise<ApiResponse<SubscribedEventInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<SubscribedEventResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<SubscribedEventInstance> => ({
      ...response,
  ...
  updateWithHttpInfo(params?: SubscribedEventContextUpdateOptions | ((error: Error | null, item?: ApiResponse<SubscribedEventInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<SubscribedEventInstance>) => any): Promise<ApiResponse<SubscribedEventInstance>> {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.updateWithResponseInfo<SubscribedEventResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<SubscribedEventInstance> => ({
      ...response,
      body: new SubscribedEventInstance(operationVersion, response.body, instance._solution.subscriptionSid, instance._solution.type)
    }));
...
export class SubscribedEventInstance {
  ...
  constructor(protected _version: V1, payload: SubscribedEventResource, subscriptionSid: string, type?: string) {
  ...
  update(params: SubscribedEventContextUpdateOptions, callback?: (error: Error | null, item?: SubscribedEventInstance) => any): Promise<SubscribedEventInstance>;
    ...
    update(params?: any, callback?: (error: Error | null, item?: SubscribedEventInstance) => any): Promise<SubscribedEventInstance>
    {
  ...
  updateWithHttpInfo(params: SubscribedEventContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<SubscribedEventInstance>) => any): Promise<ApiResponse<SubscribedEventInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<SubscribedEventInstance>) => any): Promise<ApiResponse<SubscribedEventInstance>>
    {
...
export function SubscribedEventListInstance(version: V1, subscriptionSid: string): SubscribedEventListInstance {
  ...
  const instance = ((type, ) => instance.get(type, )) as SubscribedEventListInstance;
  ...
  instance.create = function create(params: SubscribedEventListInstanceCreateOptions, callback?: (error: Error | null, items: SubscribedEventInstance) => any): Promise<SubscribedEventInstance> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: SubscribedEventListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<SubscribedEventInstance>) => any): Promise<ApiResponse<SubscribedEventInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<SubscribedEventResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<SubscribedEventInstance> => ({
      ...response,
  ...
  instance.page = function page(params?: SubscribedEventListInstancePageOptions | ((error: Error | null, items: SubscribedEventPage) => any), callback?: (error: Error | null, items: SubscribedEventPage) => any): Promise<SubscribedEventPage> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: SubscribedEventPage) => any): Promise<SubscribedEventPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: SubscribedEventListInstancePageOptions | ((error: Error | null, items: ApiResponse<SubscribedEventPage>) => any), callback?: (error: Error | null, items: ApiResponse<SubscribedEventPage>) => any): Promise<ApiResponse<SubscribedEventPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<SubscribedEventPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<SubscribedEventPage>) => any): Promise<ApiResponse<SubscribedEventPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<SubscribedEventPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
