...
export function YesterdayListInstance(version: V2010, accountSid: string): YesterdayListInstance {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: YesterdayListInstancePageOptions | ((error: Error | null, items: ApiResponse<YesterdayPage>) => any), callback?: (error: Error | null, items: ApiResponse<YesterdayPage>) => any): Promise<ApiResponse<YesterdayPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<YesterdayPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<YesterdayPage>) => any): Promise<ApiResponse<YesterdayPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<YesterdayPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
