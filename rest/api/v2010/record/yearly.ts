...
export function YearlyListInstance(version: V2010, accountSid: string): YearlyListInstance {
  ...
  instance.page = function page(params?: YearlyListInstancePageOptions | ((error: Error | null, items: YearlyPage) => any), callback?: (error: Error | null, items: YearlyPage) => any): Promise<YearlyPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: YearlyPage) => any): Promise<YearlyPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: YearlyListInstancePageOptions | ((error: Error | null, items: ApiResponse<YearlyPage>) => any), callback?: (error: Error | null, items: ApiResponse<YearlyPage>) => any): Promise<ApiResponse<YearlyPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<YearlyPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<YearlyPage>) => any): Promise<ApiResponse<YearlyPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<YearlyPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
...
export class YearlyInstance {
  ...
  constructor(protected _version: V2010, payload: YearlyResource, accountSid: string) {
