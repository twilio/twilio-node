...
export function MessageListInstance(version: V2010, accountSid: string): MessageListInstance {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: MessageListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<MessageInstance>) => any): Promise<ApiResponse<MessageInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
