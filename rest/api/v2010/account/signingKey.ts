...
export class SigningKeyContextImpl implements SigningKeyContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<SigningKeyInstance>) => any): Promise<ApiResponse<SigningKeyInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<SigningKeyResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<SigningKeyInstance> => ({
      ...response,
  ...
  updateWithHttpInfo(params?: SigningKeyContextUpdateOptions | ((error: Error | null, item?: ApiResponse<SigningKeyInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<SigningKeyInstance>) => any): Promise<ApiResponse<SigningKeyInstance>> {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.updateWithResponseInfo<SigningKeyResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<SigningKeyInstance> => ({
      ...response,
      body: new SigningKeyInstance(operationVersion, response.body, instance._solution.accountSid, instance._solution.sid)
    }));
...
export class SigningKeyInstance {
  ...
  constructor(protected _version: V2010, payload: SigningKeyResource, accountSid: string, sid?: string) {
  ...
  update(params: SigningKeyContextUpdateOptions, callback?: (error: Error | null, item?: SigningKeyInstance) => any): Promise<SigningKeyInstance>;
    ...
    update(params?: any, callback?: (error: Error | null, item?: SigningKeyInstance) => any): Promise<SigningKeyInstance>
    {
  ...
  updateWithHttpInfo(params: SigningKeyContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<SigningKeyInstance>) => any): Promise<ApiResponse<SigningKeyInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<SigningKeyInstance>) => any): Promise<ApiResponse<SigningKeyInstance>>
    {
...
export function SigningKeyListInstance(version: V2010, accountSid: string): SigningKeyListInstance {
  ...
  instance.page = function page(params?: SigningKeyListInstancePageOptions | ((error: Error | null, items: SigningKeyPage) => any), callback?: (error: Error | null, items: SigningKeyPage) => any): Promise<SigningKeyPage> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: SigningKeyPage) => any): Promise<SigningKeyPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: SigningKeyListInstancePageOptions | ((error: Error | null, items: ApiResponse<SigningKeyPage>) => any), callback?: (error: Error | null, items: ApiResponse<SigningKeyPage>) => any): Promise<ApiResponse<SigningKeyPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<SigningKeyPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<SigningKeyPage>) => any): Promise<ApiResponse<SigningKeyPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<SigningKeyPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
