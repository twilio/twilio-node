...
export function LocalListInstance(version: V2010, accountSid: string, countryCode: string): LocalListInstance {
...
export class LocalInstance {
  ...
  constructor(protected _version: V2010, payload: LocalResource, accountSid: string, countryCode: string) {
