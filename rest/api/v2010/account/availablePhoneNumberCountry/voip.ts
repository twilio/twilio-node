...
export function VoipListInstance(version: V2010, accountSid: string, countryCode: string): VoipListInstance {
  ...
  instance.page = function page(params?: VoipListInstancePageOptions | ((error: Error | null, items: VoipPage) => any), callback?: (error: Error | null, items: VoipPage) => any): Promise<VoipPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: VoipPage) => any): Promise<VoipPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: VoipListInstancePageOptions | ((error: Error | null, items: ApiResponse<VoipPage>) => any), callback?: (error: Error | null, items: ApiResponse<VoipPage>) => any): Promise<ApiResponse<VoipPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<VoipPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<VoipPage>) => any): Promise<ApiResponse<VoipPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<VoipPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
...
export class VoipInstance {
  ...
  constructor(protected _version: V2010, payload: VoipResource, accountSid: string, countryCode: string) {
