...
export class AuthorizedConnectAppContextImpl implements AuthorizedConnectAppContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<AuthorizedConnectAppInstance>) => any): Promise<ApiResponse<AuthorizedConnectAppInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<AuthorizedConnectAppResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<AuthorizedConnectAppInstance> => ({
      ...response,
...
export class AuthorizedConnectAppInstance {
  ...
  constructor(protected _version: V2010, payload: AuthorizedConnectAppResource, accountSid: string, connectAppSid?: string) {
...
export function AuthorizedConnectAppListInstance(version: V2010, accountSid: string): AuthorizedConnectAppListInstance {
  ...
  const instance = ((connectAppSid, ) => instance.get(connectAppSid, )) as AuthorizedConnectAppListInstance;
  ...
  instance.page = function page(params?: AuthorizedConnectAppListInstancePageOptions | ((error: Error | null, items: AuthorizedConnectAppPage) => any), callback?: (error: Error | null, items: AuthorizedConnectAppPage) => any): Promise<AuthorizedConnectAppPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: AuthorizedConnectAppPage) => any): Promise<AuthorizedConnectAppPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: AuthorizedConnectAppListInstancePageOptions | ((error: Error | null, items: ApiResponse<AuthorizedConnectAppPage>) => any), callback?: (error: Error | null, items: ApiResponse<AuthorizedConnectAppPage>) => any): Promise<ApiResponse<AuthorizedConnectAppPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<AuthorizedConnectAppPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<AuthorizedConnectAppPage>) => any): Promise<ApiResponse<AuthorizedConnectAppPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<AuthorizedConnectAppPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
