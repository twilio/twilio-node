...
export function TollFreeListInstance(version: V2010, accountSid: string): TollFreeListInstance {
  ...
  instance.create = function create(params: TollFreeListInstanceCreateOptions, callback?: (error: Error | null, items: TollFreeInstance) => any): Promise<TollFreeInstance> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: TollFreeListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<TollFreeInstance>) => any): Promise<ApiResponse<TollFreeInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationPromise = operationVersion.createWithResponseInfo<TollFreeResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<TollFreeInstance> => ({
      ...response,
  ...
  instance.page = function page(params?: TollFreeListInstancePageOptions | ((error: Error | null, items: TollFreePage) => any), callback?: (error: Error | null, items: TollFreePage) => any): Promise<TollFreePage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: TollFreePage) => any): Promise<TollFreePage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: TollFreeListInstancePageOptions | ((error: Error | null, items: ApiResponse<TollFreePage>) => any), callback?: (error: Error | null, items: ApiResponse<TollFreePage>) => any): Promise<ApiResponse<TollFreePage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<TollFreePage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<TollFreePage>) => any): Promise<ApiResponse<TollFreePage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<TollFreePage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
...
export class TollFreeInstance {
  ...
  constructor(protected _version: V2010, payload: TollFreeResource, accountSid: string) {
