...
export class AuthCallsCredentialListMappingContextImpl implements AuthCallsCredentialListMappingContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<AuthCallsCredentialListMappingInstance>) => any): Promise<ApiResponse<AuthCallsCredentialListMappingInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<AuthCallsCredentialListMappingResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<AuthCallsCredentialListMappingInstance> => ({
      ...response,
...
export class AuthCallsCredentialListMappingInstance {
  ...
  constructor(protected _version: V2010, payload: AuthCallsCredentialListMappingResource, accountSid?: string, domainSid?: string, sid?: string) {
...
export interface AuthCallsCredentialListMappingListInstance {
  ...
  (accountSid: string, domainSid: string, sid: string, ): AuthCallsCredentialListMappingContext;
  get(accountSid: string, domainSid: string, sid: string, ): AuthCallsCredentialListMappingContext;
...
export function AuthCallsCredentialListMappingListInstance(version: V2010, accountSid: string, domainSid: string): AuthCallsCredentialListMappingListInstance {
  ...
  const instance = ((accountSid, domainSid, sid, ) => instance.get(accountSid, domainSid, sid, )) as AuthCallsCredentialListMappingListInstance;

  instance.get = function get(accountSid, domainSid, sid, ): AuthCallsCredentialListMappingContext {
  ...
  instance.create = function create(params: AuthCallsCredentialListMappingListInstanceCreateOptions, callback?: (error: Error | null, items: AuthCallsCredentialListMappingInstance) => any): Promise<AuthCallsCredentialListMappingInstance> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: AuthCallsCredentialListMappingListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<AuthCallsCredentialListMappingInstance>) => any): Promise<ApiResponse<AuthCallsCredentialListMappingInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<AuthCallsCredentialListMappingResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<AuthCallsCredentialListMappingInstance> => ({
      ...response,
  ...
  instance.page = function page(params?: AuthCallsCredentialListMappingListInstancePageOptions | ((error: Error | null, items: AuthCallsCredentialListMappingPage) => any), callback?: (error: Error | null, items: AuthCallsCredentialListMappingPage) => any): Promise<AuthCallsCredentialListMappingPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: AuthCallsCredentialListMappingPage) => any): Promise<AuthCallsCredentialListMappingPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: AuthCallsCredentialListMappingListInstancePageOptions | ((error: Error | null, items: ApiResponse<AuthCallsCredentialListMappingPage>) => any), callback?: (error: Error | null, items: ApiResponse<AuthCallsCredentialListMappingPage>) => any): Promise<ApiResponse<AuthCallsCredentialListMappingPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<AuthCallsCredentialListMappingPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<AuthCallsCredentialListMappingPage>) => any): Promise<ApiResponse<AuthCallsCredentialListMappingPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<AuthCallsCredentialListMappingPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
