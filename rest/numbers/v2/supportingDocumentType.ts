...
export class SupportingDocumentTypeContextImpl implements SupportingDocumentTypeContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<SupportingDocumentTypeInstance>) => any): Promise<ApiResponse<SupportingDocumentTypeInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<SupportingDocumentTypeResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<SupportingDocumentTypeInstance> => ({
      ...response,
...
export class SupportingDocumentTypeInstance {
  ...
  constructor(protected _version: V2, payload: SupportingDocumentTypeResource, sid?: string) {
...
export function SupportingDocumentTypeListInstance(version: V2): SupportingDocumentTypeListInstance {
  const instance = ((sid, ) => instance.get(sid, )) as SupportingDocumentTypeListInstance;
  ...
  instance.page = function page(params?: SupportingDocumentTypeListInstancePageOptions | ((error: Error | null, items: SupportingDocumentTypePage) => any), callback?: (error: Error | null, items: SupportingDocumentTypePage) => any): Promise<SupportingDocumentTypePage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: SupportingDocumentTypePage) => any): Promise<SupportingDocumentTypePage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: SupportingDocumentTypeListInstancePageOptions | ((error: Error | null, items: ApiResponse<SupportingDocumentTypePage>) => any), callback?: (error: Error | null, items: ApiResponse<SupportingDocumentTypePage>) => any): Promise<ApiResponse<SupportingDocumentTypePage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<SupportingDocumentTypePage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<SupportingDocumentTypePage>) => any): Promise<ApiResponse<SupportingDocumentTypePage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<SupportingDocumentTypePage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
