...
export class InteractionChannelParticipantContextImpl implements InteractionChannelParticipantContext {
  ...
  updateWithHttpInfo(params: InteractionChannelParticipantContextUpdateOptions,callback?: (error: Error | null, item?: ApiResponse<InteractionChannelParticipantInstance>) => any): Promise<ApiResponse<InteractionChannelParticipantInstance>> {
    ...
    let operationPromise = operationVersion.updateWithResponseInfo<InteractionChannelParticipantResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<InteractionChannelParticipantInstance> => ({
      ...response,
...
export class InteractionChannelParticipantInstance {
  ...
  constructor(protected _version: V1, payload: InteractionChannelParticipantResource, interactionSid: string, channelSid: string, sid?: string) {
  ...
  update(params: InteractionChannelParticipantContextUpdateOptions, callback?: (error: Error | null, item?: InteractionChannelParticipantInstance) => any): Promise<InteractionChannelParticipantInstance>;
    ...
    update(params?: any, callback?: (error: Error | null, item?: InteractionChannelParticipantInstance) => any): Promise<InteractionChannelParticipantInstance>
    {
  ...
  updateWithHttpInfo(params: InteractionChannelParticipantContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<InteractionChannelParticipantInstance>) => any): Promise<ApiResponse<InteractionChannelParticipantInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<InteractionChannelParticipantInstance>) => any): Promise<ApiResponse<InteractionChannelParticipantInstance>>
    {
...
export function InteractionChannelParticipantListInstance(version: V1, interactionSid: string, channelSid: string): InteractionChannelParticipantListInstance {
  if (!isValidPathParam(interactionSid)) {
    throw new Error('Parameter \'interactionSid\' is not valid.');
  }
  ...
  const instance = ((sid, ) => instance.get(sid, )) as InteractionChannelParticipantListInstance;
  ...
  instance.create = function create(params: InteractionChannelParticipantListInstanceCreateOptions, callback?: (error: Error | null, items: InteractionChannelParticipantInstance) => any): Promise<InteractionChannelParticipantInstance> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: InteractionChannelParticipantListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<InteractionChannelParticipantInstance>) => any): Promise<ApiResponse<InteractionChannelParticipantInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<InteractionChannelParticipantResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<InteractionChannelParticipantInstance> => ({
      ...response,
  ...
  instance.page = function page(params?: InteractionChannelParticipantListInstancePageOptions | ((error: Error | null, items: InteractionChannelParticipantPage) => any), callback?: (error: Error | null, items: InteractionChannelParticipantPage) => any): Promise<InteractionChannelParticipantPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: InteractionChannelParticipantPage) => any): Promise<InteractionChannelParticipantPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: InteractionChannelParticipantListInstancePageOptions | ((error: Error | null, items: ApiResponse<InteractionChannelParticipantPage>) => any), callback?: (error: Error | null, items: ApiResponse<InteractionChannelParticipantPage>) => any): Promise<ApiResponse<InteractionChannelParticipantPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<InteractionChannelParticipantPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<InteractionChannelParticipantPage>) => any): Promise<ApiResponse<InteractionChannelParticipantPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<InteractionChannelParticipantPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
