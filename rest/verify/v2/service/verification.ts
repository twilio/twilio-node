...
export class VerificationContextImpl implements VerificationContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<VerificationInstance>) => any): Promise<ApiResponse<VerificationInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<VerificationResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<VerificationInstance> => ({
      ...response,
  ...
  updateWithHttpInfo(params: VerificationContextUpdateOptions,callback?: (error: Error | null, item?: ApiResponse<VerificationInstance>) => any): Promise<ApiResponse<VerificationInstance>> {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.updateWithResponseInfo<VerificationResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<VerificationInstance> => ({
      ...response,
      body: new VerificationInstance(operationVersion, response.body, instance._solution.serviceSid, instance._solution.sid)
    }));
...
export class VerificationInstance {
  ...
  constructor(protected _version: V2, payload: VerificationResource, serviceSid: string, sid?: string) {
  ...
  update(params: VerificationContextUpdateOptions, callback?: (error: Error | null, item?: VerificationInstance) => any): Promise<VerificationInstance>;
    ...
    update(params?: any, callback?: (error: Error | null, item?: VerificationInstance) => any): Promise<VerificationInstance>
    {
  ...
  updateWithHttpInfo(params: VerificationContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<VerificationInstance>) => any): Promise<ApiResponse<VerificationInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<VerificationInstance>) => any): Promise<ApiResponse<VerificationInstance>>
    {
...
export function VerificationListInstance(version: V2, serviceSid: string): VerificationListInstance {
  ...
  instance.create = function create(params: VerificationListInstanceCreateOptions, callback?: (error: Error | null, items: VerificationInstance) => any): Promise<VerificationInstance> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: VerificationListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<VerificationInstance>) => any): Promise<ApiResponse<VerificationInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<VerificationResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<VerificationInstance> => ({
      ...response,
