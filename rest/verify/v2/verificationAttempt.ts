...
export class VerificationAttemptContextImpl implements VerificationAttemptContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<VerificationAttemptInstance>) => any): Promise<ApiResponse<VerificationAttemptInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<VerificationAttemptResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<VerificationAttemptInstance> => ({
      ...response,
...
export class VerificationAttemptInstance {
  ...
  constructor(protected _version: V2, payload: VerificationAttemptResource, sid?: string) {
...
export function VerificationAttemptListInstance(version: V2): VerificationAttemptListInstance {
  const instance = ((sid, ) => instance.get(sid, )) as VerificationAttemptListInstance;
  ...
  instance.page = function page(params?: VerificationAttemptListInstancePageOptions | ((error: Error | null, items: VerificationAttemptPage) => any), callback?: (error: Error | null, items: VerificationAttemptPage) => any): Promise<VerificationAttemptPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: VerificationAttemptPage) => any): Promise<VerificationAttemptPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: VerificationAttemptListInstancePageOptions | ((error: Error | null, items: ApiResponse<VerificationAttemptPage>) => any), callback?: (error: Error | null, items: ApiResponse<VerificationAttemptPage>) => any): Promise<ApiResponse<VerificationAttemptPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<VerificationAttemptPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<VerificationAttemptPage>) => any): Promise<ApiResponse<VerificationAttemptPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<VerificationAttemptPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
