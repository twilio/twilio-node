...
export class FleetContextImpl implements FleetContext {
  ...
  updateWithHttpInfo(params?: FleetContextUpdateOptions | ((error: Error | null, item?: ApiResponse<FleetInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<FleetInstance>) => any): Promise<ApiResponse<FleetInstance>> {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.updateWithResponseInfo<FleetResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<FleetInstance> => ({
      ...response,
      body: new FleetInstance(operationVersion, response.body, instance._solution.sid)
    }));
...
export class FleetInstance {
  ...
  updateWithHttpInfo(params: FleetContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<FleetInstance>) => any): Promise<ApiResponse<FleetInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<FleetInstance>) => any): Promise<ApiResponse<FleetInstance>>
    {
...
export function FleetListInstance(version: V1): FleetListInstance {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: FleetListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<FleetInstance>) => any): Promise<ApiResponse<FleetInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<FleetResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<FleetInstance> => ({
      ...response,
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: FleetListInstancePageOptions | ((error: Error | null, items: ApiResponse<FleetPage>) => any), callback?: (error: Error | null, items: ApiResponse<FleetPage>) => any): Promise<ApiResponse<FleetPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<FleetPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<FleetPage>) => any): Promise<ApiResponse<FleetPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<FleetPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
