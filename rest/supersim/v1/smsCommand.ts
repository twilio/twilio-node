...
export class SmsCommandContextImpl implements SmsCommandContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<SmsCommandInstance>) => any): Promise<ApiResponse<SmsCommandInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<SmsCommandResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<SmsCommandInstance> => ({
      ...response,
...
export class SmsCommandInstance {
  ...
  constructor(protected _version: V1, payload: SmsCommandResource, sid?: string) {
...
export function SmsCommandListInstance(version: V1): SmsCommandListInstance {
  ...
  instance.create = function create(params: SmsCommandListInstanceCreateOptions, callback?: (error: Error | null, items: SmsCommandInstance) => any): Promise<SmsCommandInstance> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: SmsCommandListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<SmsCommandInstance>) => any): Promise<ApiResponse<SmsCommandInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<SmsCommandResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<SmsCommandInstance> => ({
      ...response,
  ...
  instance.page = function page(params?: SmsCommandListInstancePageOptions | ((error: Error | null, items: SmsCommandPage) => any), callback?: (error: Error | null, items: SmsCommandPage) => any): Promise<SmsCommandPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: SmsCommandPage) => any): Promise<SmsCommandPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: SmsCommandListInstancePageOptions | ((error: Error | null, items: ApiResponse<SmsCommandPage>) => any), callback?: (error: Error | null, items: ApiResponse<SmsCommandPage>) => any): Promise<ApiResponse<SmsCommandPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<SmsCommandPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<SmsCommandPage>) => any): Promise<ApiResponse<SmsCommandPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<SmsCommandPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
