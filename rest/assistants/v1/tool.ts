...
export class ToolContextImpl implements ToolContext {
  ...
  fetchWithHttpInfo(
    ...
    let operationPromise = operationVersion
      ...
      .then((response): ApiResponse<ToolInstance> => ({
        ...response,
  ...
  update(
    ...
    if (params instanceof Function) {
      callback = params;
      params =
        {} as Partial<AssistantsV1ServiceUpdateToolRequest> as AssistantsV1ServiceUpdateToolRequest;
    } else {
      params =
        params ||
        ({} as Partial<AssistantsV1ServiceUpdateToolRequest> as AssistantsV1ServiceUpdateToolRequest);
...
export function ToolListInstance(version: V1): ToolListInstance {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(
    ...
    let operationPromise = operationVersion
      ...
      .then((response): ApiResponse<ToolPage> => ({
