...
export class DomainCertsContextImpl implements DomainCertsContext {
  ...
  updateWithHttpInfo(params: DomainCertsContextUpdateOptions,callback?: (error: Error | null, item?: ApiResponse<DomainCertsInstance>) => any): Promise<ApiResponse<DomainCertsInstance>> {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.updateWithResponseInfo<DomainCertsResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<DomainCertsInstance> => ({
      ...response,
      body: new DomainCertsInstance(operationVersion, response.body, instance._solution.domainSid)
    }));
...
export class DomainCertsInstance {
  ...
  constructor(protected _version: V1, payload: DomainCertsResource, domainSid?: string) {
  ...
  update(params: DomainCertsContextUpdateOptions, callback?: (error: Error | null, item?: DomainCertsInstance) => any): Promise<DomainCertsInstance>;
    ...
    update(params?: any, callback?: (error: Error | null, item?: DomainCertsInstance) => any): Promise<DomainCertsInstance>
    {
  ...
  updateWithHttpInfo(params: DomainCertsContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<DomainCertsInstance>) => any): Promise<ApiResponse<DomainCertsInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<DomainCertsInstance>) => any): Promise<ApiResponse<DomainCertsInstance>>
    {
