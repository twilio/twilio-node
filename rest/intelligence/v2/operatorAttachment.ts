...
export class OperatorAttachmentContextImpl implements OperatorAttachmentContext {
  ...
  createWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<OperatorAttachmentInstance>) => any): Promise<ApiResponse<OperatorAttachmentInstance>> {
    ...
    let operationPromise = operationVersion.createWithResponseInfo<OperatorAttachmentResource>({ uri: instance._uri, method: "post", headers}).then((response) : ApiResponse<OperatorAttachmentInstance> => ({
      ...response,
