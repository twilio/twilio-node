...
export interface RuleExecutionListInstance {
   ...
   */
  create(params: CreateRuleExecutionRequest, headers?: any, callback?: (error: Error | null, item?: RuleExecutionInstance) => any): Promise<RuleExecutionInstance>;
   ...
   */
  createWithHttpInfo(params: CreateRuleExecutionRequest, headers?: any, callback?: (error: Error | null, item?: ApiResponse<RuleExecutionInstance>) => any): Promise<ApiResponse<RuleExecutionInstance>>;
...
export function RuleExecutionListInstance(version: V3): RuleExecutionListInstance {
  ...
  instance.create = function create(params: CreateRuleExecutionRequest, headers?: any, callback?: (error: Error | null, items: RuleExecutionInstance) => any): Promise<RuleExecutionInstance> {
    ...
    operationPromise = operationPromise.then(payload => new RuleExecutionInstance(operationVersion, payload));
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: CreateRuleExecutionRequest, headers?: any, callback?: (error: Error | null, items: ApiResponse<RuleExecutionInstance>) => any): Promise<ApiResponse<RuleExecutionInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationPromise = operationVersion.createWithResponseInfo<RuleExecutionResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<RuleExecutionInstance> => ({
      ...response,
