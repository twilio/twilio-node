...
export function GetApiKeysListInstance(version: V1): GetApiKeysListInstance {
  ...
  instance.page = function page(params: GetApiKeysListInstancePageOptions, callback?: (error: Error | null, items: GetApiKeysPage) => any): Promise<GetApiKeysPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params: GetApiKeysListInstancePageOptions, callback?: (error: Error | null, items: ApiResponse<GetApiKeysPage>) => any): Promise<ApiResponse<GetApiKeysPage>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<GetApiKeysPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<GetApiKeysPage>) => any): Promise<ApiResponse<GetApiKeysPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<GetApiKeysPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
