...
export class SourceIpMappingContextImpl implements SourceIpMappingContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<SourceIpMappingInstance>) => any): Promise<ApiResponse<SourceIpMappingInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<SourceIpMappingResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<SourceIpMappingInstance> => ({
      ...response,
  ...
  updateWithHttpInfo(params: SourceIpMappingContextUpdateOptions,callback?: (error: Error | null, item?: ApiResponse<SourceIpMappingInstance>) => any): Promise<ApiResponse<SourceIpMappingInstance>> {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.updateWithResponseInfo<SourceIpMappingResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<SourceIpMappingInstance> => ({
      ...response,
      body: new SourceIpMappingInstance(operationVersion, response.body, instance._solution.sid)
    }));
...
export class SourceIpMappingInstance {
  ...
  updateWithHttpInfo(params: SourceIpMappingContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<SourceIpMappingInstance>) => any): Promise<ApiResponse<SourceIpMappingInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<SourceIpMappingInstance>) => any): Promise<ApiResponse<SourceIpMappingInstance>>
    {
...
export function SourceIpMappingListInstance(version: V1): SourceIpMappingListInstance {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: SourceIpMappingListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<SourceIpMappingInstance>) => any): Promise<ApiResponse<SourceIpMappingInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<SourceIpMappingResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<SourceIpMappingInstance> => ({
      ...response,
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: SourceIpMappingListInstancePageOptions | ((error: Error | null, items: ApiResponse<SourceIpMappingPage>) => any), callback?: (error: Error | null, items: ApiResponse<SourceIpMappingPage>) => any): Promise<ApiResponse<SourceIpMappingPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<SourceIpMappingPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<SourceIpMappingPage>) => any): Promise<ApiResponse<SourceIpMappingPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<SourceIpMappingPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
