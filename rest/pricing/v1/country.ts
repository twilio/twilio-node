...
export class CountryInstance {
  ...
  constructor(protected _version: V1, payload: CountryResource, isoCountry?: string) {
    
    this.country = (payload.country);
    this.isoCountry = (payload.iso_country);
    this.outboundSmsPrices =  payload.outbound_sms_prices !== null && payload.outbound_sms_prices !== undefined ? payload.outbound_sms_prices.map(
      (payload: any) => new PricingV1MessagingMessagingCountryInstanceOutboundSmsPrices(payload)
    ) : null;
    this.inboundSmsPrices =  payload.inbound_sms_prices !== null && payload.inbound_sms_prices !== undefined ? payload.inbound_sms_prices.map(
      (payload: any) => new PricingV1MessagingMessagingCountryInstanceInboundSmsPrices(payload)
    ) : null;
    this.priceUnit = (payload.price_unit);
    this.url = (payload.url);
    this.phoneNumberPrices =  payload.phone_number_prices !== null && payload.phone_number_prices !== undefined ? payload.phone_number_prices.map(
      (payload: any) => new PricingV1PhoneNumberPhoneNumberCountryInstancePhoneNumberPrices(payload)
    ) : null;
    this.outboundPrefixPrices =  payload.outbound_prefix_prices !== null && payload.outbound_prefix_prices !== undefined ? payload.outbound_prefix_prices.map(
      (payload: any) => new PricingV1VoiceVoiceCountryInstanceOutboundPrefixPrices(payload)
    ) : null;
    this.inboundCallPrices =  payload.inbound_call_prices !== null && payload.inbound_call_prices !== undefined ? payload.inbound_call_prices.map(
      (payload: any) => new PricingV1VoiceVoiceCountryInstanceInboundCallPrices(payload)
    ) : null;
