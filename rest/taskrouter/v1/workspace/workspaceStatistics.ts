...
export class WorkspaceStatisticsContextImpl implements WorkspaceStatisticsContext {
  ...
  fetchWithHttpInfo(params?: WorkspaceStatisticsContextFetchOptions | ((error: Error | null, item?: ApiResponse<WorkspaceStatisticsInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<WorkspaceStatisticsInstance>) => any): Promise<ApiResponse<WorkspaceStatisticsInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<WorkspaceStatisticsResource>({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<WorkspaceStatisticsInstance> => ({
      ...response,
...
export class WorkspaceStatisticsInstance {
  ...
  fetchWithHttpInfo(params: WorkspaceStatisticsContextFetchOptions, callback?: (error: Error | null, item?: ApiResponse<WorkspaceStatisticsInstance>) => any): Promise<ApiResponse<WorkspaceStatisticsInstance>>;
    ...
    fetchWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<WorkspaceStatisticsInstance>) => any): Promise<ApiResponse<WorkspaceStatisticsInstance>>
    {
