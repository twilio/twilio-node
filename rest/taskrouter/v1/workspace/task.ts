...
export class TaskContextImpl implements TaskContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<TaskInstance>) => any): Promise<ApiResponse<TaskInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<TaskResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<TaskInstance> => ({
      ...response,
  ...
  updateWithHttpInfo(params?: TaskContextUpdateOptions | ((error: Error | null, item?: ApiResponse<TaskInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<TaskInstance>) => any): Promise<ApiResponse<TaskInstance>> {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.updateWithResponseInfo<TaskResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<TaskInstance> => ({
      ...response,
      body: new TaskInstance(operationVersion, response.body, instance._solution.workspaceSid, instance._solution.sid)
    }));
...
export class TaskInstance {
  ...
  constructor(protected _version: V1, payload: TaskResource, workspaceSid: string, sid?: string) {
  ...
  update(params: TaskContextUpdateOptions, callback?: (error: Error | null, item?: TaskInstance) => any): Promise<TaskInstance>;
    ...
    update(params?: any, callback?: (error: Error | null, item?: TaskInstance) => any): Promise<TaskInstance>
    {
  ...
  updateWithHttpInfo(params: TaskContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<TaskInstance>) => any): Promise<ApiResponse<TaskInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<TaskInstance>) => any): Promise<ApiResponse<TaskInstance>>
    {
...
export function TaskListInstance(version: V1, workspaceSid: string): TaskListInstance {
  if (!isValidPathParam(workspaceSid)) {
    throw new Error('Parameter \'workspaceSid\' is not valid.');
  }
  ...
  instance.create = function create(params?: TaskListInstanceCreateOptions | ((error: Error | null, items: TaskInstance) => any), callback?: (error: Error | null, items: TaskInstance) => any): Promise<TaskInstance> {
    if (params instanceof Function) {
      callback = params;
      params = {} as any;
    } else {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params?: TaskListInstanceCreateOptions | ((error: Error | null, items: ApiResponse<TaskInstance>) => any), callback?: (error: Error | null, items: ApiResponse<TaskInstance>) => any): Promise<ApiResponse<TaskInstance>> {
    if (params instanceof Function) {
      callback = params;
      params = {} as any;
    } else {
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<TaskResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<TaskInstance> => ({
      ...response,
  ...
  instance.page = function page(params?: TaskListInstancePageOptions | ((error: Error | null, items: TaskPage) => any), callback?: (error: Error | null, items: TaskPage) => any): Promise<TaskPage> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    data["Priority"] = params["priority"];
    if (params["assignmentStatus"] !== undefined)
    data["AssignmentStatus"] = serialize.map(params["assignmentStatus"], (e: string) => (e));
    if (params["workflowSid"] !== undefined)
    data["WorkflowSid"] = params["workflowSid"];
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: TaskPage) => any): Promise<TaskPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: TaskListInstancePageOptions | ((error: Error | null, items: ApiResponse<TaskPage>) => any), callback?: (error: Error | null, items: ApiResponse<TaskPage>) => any): Promise<ApiResponse<TaskPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<TaskPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<TaskPage>) => any): Promise<ApiResponse<TaskPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<TaskPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
