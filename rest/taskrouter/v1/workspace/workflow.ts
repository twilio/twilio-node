...
export class WorkflowContextImpl implements WorkflowContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<WorkflowInstance>) => any): Promise<ApiResponse<WorkflowInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<WorkflowResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<WorkflowInstance> => ({
      ...response,
  ...
  updateWithHttpInfo(params?: WorkflowContextUpdateOptions | ((error: Error | null, item?: ApiResponse<WorkflowInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<WorkflowInstance>) => any): Promise<ApiResponse<WorkflowInstance>> {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.updateWithResponseInfo<WorkflowResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<WorkflowInstance> => ({
      ...response,
      body: new WorkflowInstance(operationVersion, response.body, instance._solution.workspaceSid, instance._solution.sid)
    }));
...
export class WorkflowInstance {
  ...
  constructor(protected _version: V1, payload: WorkflowResource, workspaceSid: string, sid?: string) {
  ...
  update(params: WorkflowContextUpdateOptions, callback?: (error: Error | null, item?: WorkflowInstance) => any): Promise<WorkflowInstance>;
    ...
    update(params?: any, callback?: (error: Error | null, item?: WorkflowInstance) => any): Promise<WorkflowInstance>
    {
  ...
  updateWithHttpInfo(params: WorkflowContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<WorkflowInstance>) => any): Promise<ApiResponse<WorkflowInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<WorkflowInstance>) => any): Promise<ApiResponse<WorkflowInstance>>
    {
...
export function WorkflowListInstance(version: V1, workspaceSid: string): WorkflowListInstance {
  ...
  instance.create = function create(params: WorkflowListInstanceCreateOptions, callback?: (error: Error | null, items: WorkflowInstance) => any): Promise<WorkflowInstance> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: WorkflowListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<WorkflowInstance>) => any): Promise<ApiResponse<WorkflowInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<WorkflowResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<WorkflowInstance> => ({
      ...response,
  ...
  instance.page = function page(params?: WorkflowListInstancePageOptions | ((error: Error | null, items: WorkflowPage) => any), callback?: (error: Error | null, items: WorkflowPage) => any): Promise<WorkflowPage> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: WorkflowPage) => any): Promise<WorkflowPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: WorkflowListInstancePageOptions | ((error: Error | null, items: ApiResponse<WorkflowPage>) => any), callback?: (error: Error | null, items: ApiResponse<WorkflowPage>) => any): Promise<ApiResponse<WorkflowPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<WorkflowPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<WorkflowPage>) => any): Promise<ApiResponse<WorkflowPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<WorkflowPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
