...
export class UserContextImpl implements UserContext {
  ...
  updateWithHttpInfo(params?: UserContextUpdateOptions | ((error: Error | null, item?: ApiResponse<UserInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<UserInstance>) => any): Promise<ApiResponse<UserInstance>> {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.updateWithResponseInfo<UserResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<UserInstance> => ({
      ...response,
      body: new UserInstance(operationVersion, response.body, instance._solution.serviceSid, instance._solution.sid)
    }));
...
export class UserInstance {
  ...
  constructor(protected _version: V2, payload: UserResource, serviceSid: string, sid?: string) {
...
export function UserListInstance(version: V2, serviceSid: string): UserListInstance {
  if (!isValidPathParam(serviceSid)) {
    throw new Error('Parameter \'serviceSid\' is not valid.');
  }
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: UserListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<UserInstance>) => any): Promise<ApiResponse<UserInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
