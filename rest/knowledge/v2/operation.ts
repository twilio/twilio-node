...
export class OperationInstance {
  ...
  constructor(protected _version: V2, _payload: OperationResource, operationId?: string) {
    ...
    this.result = payload.result !== null && payload.result !== undefined ? new OperationResultResourceId(payload.result) : null;
    this.error = payload.error !== null && payload.error !== undefined ? new OperationStatusError(payload.error) : null;
  ...
  private get _proxy(): OperationContext {
    this._context = this._context || new OperationContextImpl(this._version, this._solution.operationId);
...
export function OperationListInstance(version: V2): OperationListInstance {
  const instance = ((operationId, ) => instance.get(operationId, )) as OperationListInstance;
