...
export class CustomerProfilesEntityAssignmentsContextImpl implements CustomerProfilesEntityAssignmentsContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<CustomerProfilesEntityAssignmentsInstance>) => any): Promise<ApiResponse<CustomerProfilesEntityAssignmentsInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<CustomerProfilesEntityAssignmentsResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<CustomerProfilesEntityAssignmentsInstance> => ({
      ...response,
...
export class CustomerProfilesEntityAssignmentsInstance {
  ...
  constructor(protected _version: V1, payload: CustomerProfilesEntityAssignmentsResource, customerProfileSid: string, sid?: string) {
...
export function CustomerProfilesEntityAssignmentsListInstance(version: V1, customerProfileSid: string): CustomerProfilesEntityAssignmentsListInstance {
  if (!isValidPathParam(customerProfileSid)) {
    throw new Error('Parameter \'customerProfileSid\' is not valid.');
  }

  const instance = ((sid, ) => instance.get(sid, )) as CustomerProfilesEntityAssignmentsListInstance;
  ...
  instance.create = function create(params: CustomerProfilesEntityAssignmentsListInstanceCreateOptions, callback?: (error: Error | null, items: CustomerProfilesEntityAssignmentsInstance) => any): Promise<CustomerProfilesEntityAssignmentsInstance> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: CustomerProfilesEntityAssignmentsListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<CustomerProfilesEntityAssignmentsInstance>) => any): Promise<ApiResponse<CustomerProfilesEntityAssignmentsInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<CustomerProfilesEntityAssignmentsResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<CustomerProfilesEntityAssignmentsInstance> => ({
      ...response,
  ...
  instance.page = function page(params?: CustomerProfilesEntityAssignmentsListInstancePageOptions | ((error: Error | null, items: CustomerProfilesEntityAssignmentsPage) => any), callback?: (error: Error | null, items: CustomerProfilesEntityAssignmentsPage) => any): Promise<CustomerProfilesEntityAssignmentsPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: CustomerProfilesEntityAssignmentsPage) => any): Promise<CustomerProfilesEntityAssignmentsPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: CustomerProfilesEntityAssignmentsListInstancePageOptions | ((error: Error | null, items: ApiResponse<CustomerProfilesEntityAssignmentsPage>) => any), callback?: (error: Error | null, items: ApiResponse<CustomerProfilesEntityAssignmentsPage>) => any): Promise<ApiResponse<CustomerProfilesEntityAssignmentsPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<CustomerProfilesEntityAssignmentsPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<CustomerProfilesEntityAssignmentsPage>) => any): Promise<ApiResponse<CustomerProfilesEntityAssignmentsPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<CustomerProfilesEntityAssignmentsPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
