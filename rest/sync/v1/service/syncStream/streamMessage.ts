...
export function StreamMessageListInstance(version: V1, serviceSid: string, streamSid: string): StreamMessageListInstance {
  ...
  instance.create = function create(params: StreamMessageListInstanceCreateOptions, callback?: (error: Error | null, items: StreamMessageInstance) => any): Promise<StreamMessageInstance> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: StreamMessageListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<StreamMessageInstance>) => any): Promise<ApiResponse<StreamMessageInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationPromise = operationVersion.createWithResponseInfo<StreamMessageResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<StreamMessageInstance> => ({
      ...response,
...
export class StreamMessageInstance {
  ...
  constructor(protected _version: V1, payload: StreamMessageResource, serviceSid: string, streamSid: string) {
