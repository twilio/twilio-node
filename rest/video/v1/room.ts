...
export class RoomContextImpl implements RoomContext {
  ...
  get transcriptions(): TranscriptionsListInstance {
    this._transcriptions = this._transcriptions || TranscriptionsListInstance(this._version, this._solution.sid);
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<RoomInstance>) => any): Promise<ApiResponse<RoomInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<RoomResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<RoomInstance> => ({
      ...response,
  ...
  updateWithHttpInfo(params: RoomContextUpdateOptions,callback?: (error: Error | null, item?: ApiResponse<RoomInstance>) => any): Promise<ApiResponse<RoomInstance>> {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.updateWithResponseInfo<RoomResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<RoomInstance> => ({
      ...response,
      body: new RoomInstance(operationVersion, response.body, instance._solution.sid)
    }));
...
export class RoomInstance {
  ...
  update(params: RoomContextUpdateOptions, callback?: (error: Error | null, item?: RoomInstance) => any): Promise<RoomInstance>;
    ...
    update(params?: any, callback?: (error: Error | null, item?: RoomInstance) => any): Promise<RoomInstance>
    {
  ...
  updateWithHttpInfo(params: RoomContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<RoomInstance>) => any): Promise<ApiResponse<RoomInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<RoomInstance>) => any): Promise<ApiResponse<RoomInstance>>
    {
...
export function RoomListInstance(version: V1): RoomListInstance {
  ...
  instance.create = function create(params?: RoomListInstanceCreateOptions | ((error: Error | null, items: RoomInstance) => any), callback?: (error: Error | null, items: RoomInstance) => any): Promise<RoomInstance> {
    ...
    data["VideoCodecs"] = serialize.map(params["videoCodecs"], (e: RoomVideoCodec) => (e));
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params?: RoomListInstanceCreateOptions | ((error: Error | null, items: ApiResponse<RoomInstance>) => any), callback?: (error: Error | null, items: ApiResponse<RoomInstance>) => any): Promise<ApiResponse<RoomInstance>> {
    if (params instanceof Function) {
      callback = params;
      params = {} as any;
    } else {
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<RoomResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<RoomInstance> => ({
      ...response,
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: RoomListInstancePageOptions | ((error: Error | null, items: ApiResponse<RoomPage>) => any), callback?: (error: Error | null, items: ApiResponse<RoomPage>) => any): Promise<ApiResponse<RoomPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<RoomPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<RoomPage>) => any): Promise<ApiResponse<RoomPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<RoomPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
