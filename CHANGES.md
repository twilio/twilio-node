...
[2026-09-09] Version 6.1.1
--------------------------
**Library - Fix**
- [PR #1211](https://github.com/twilio/twilio-node/pull/1211): lockfile hygiene maintenance. Thanks to [@shrutiburman](https://github.com/shrutiburman)!
- [PR #1205](https://github.com/twilio/twilio-node/pull/1205): Update Artifactory OIDC Auth action version. Thanks to [@shrutiburman](https://github.com/shrutiburman)!
...
[2026-08-11] Version 6.1.0
--------------------------
**Library - Chore**
- [PR #1202](https://github.com/twilio/twilio-node/pull/1202): Update deploy.yml to modify tag handling. Thanks to [@kridai](https://github.com/kridai)!
- [PR #1199](https://github.com/twilio/twilio-node/pull/1199): remove assistants API. Thanks to [@shrutiburman](https://github.com/shrutiburman)!

**Library - Fix**
- [PR #1196](https://github.com/twilio/twilio-node/pull/1196): updates to release process. Thanks to [@shrutiburman](https://github.com/shrutiburman)!
