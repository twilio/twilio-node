 ...
 */
Client.prototype.getPhoneNumber = function(num) {
    return new PhoneNumber(this, num);
};
 ...
 */
function PhoneNumber(client, num) {
...
sys.inherits(EventEmitter, OutgoingSms);
...
OutgoingSms.prototype.setup = function(fn) {
    ...
    this.rest.sendSms(from, to, body, statusUri, function(res) {
        self.smsDetails = res;
        fn(self);
    });
};
