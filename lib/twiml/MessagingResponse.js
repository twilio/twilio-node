 ...
 * @param {phone_number} [attributes.to] Phone Number to send Message to
 * @param {phone_number} [attributes.from] Phone Number to send Message from
 ...
 */
/* jshint ignore:end */
MessagingResponse.prototype.message = function message(attributes, message) {
  return new Message(this.response.ele('Message', attributes, message));
};
