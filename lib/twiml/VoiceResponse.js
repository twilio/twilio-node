 ...
 * @param {enum:trim} [attributes.record] Record the call
 * @param {enum:trim} [attributes.trim] Trim the recording
 ...
 * @param {enum:ring_tone} [attributes.ringTone] Ringtone allows you to override the ringback tone that Twilio will play back to the caller while executing the Dial
 ...
 *
 * @param {object} attributes - ...
 * @param {enum:input} [attributes.input] Input type Twilio should accept
 * @param {url} [attributes.action] Action URL
 * @param {http_method} [attributes.method] Action URL method
 ...
 * @param {enum:language} [attributes.language] Language to use
 ...
 *
 * @param {object} attributes - ...
 * @param {enum:reason} [attributes.reason] Rejection reason
 */
/* jshint ignore:end */
 ...
 *
 * @param {object} attributes - ...
 * @param {enum:voice} [attributes.voice] Voice to use
 * @param {integer} [attributes.loop] Times to loop message
 * @param {enum:language} [attributes.language] Message langauge
 ...
 * @param {enum:event} [attributes.statusCallbackEvent] Events to trigger status callback
 * @param {url} [attributes.statusCallback] Status Callback URL
 ...
 * @param {enum:beep} [attributes.beep] Play beep when joining
 ...
 * @param {enum:record} [attributes.record] Record the conference
 * @param {enum:region} [attributes.region] Conference region
 * @param {sid} [attributes.whisper] Call whisper
 * @param {enum:trim} [attributes.trim] Trim the conference recording
 * @param {enum:event} [attributes.statusCallbackEvent] Events to call status callback URL
 * @param {url} [attributes.statusCallback] Status callback URL
 * @param {http_method} [attributes.statusCallbackMethod] Status callback URL method
 * @param {url} [attributes.recordingStatusCallback] Recording status callback URL
 * @param {http_method} [attributes.recordingStatusCallbackMethod] Recording status callback URL method
 ...
 * @param {enum:event} [attributes.statusCallbackEvent] Events to call status callback
 * @param {url} [attributes.statusCallback] Status callback URL
 * @param {http_method} [attributes.statusCallbackMethod] Status callback URL method
 ...
 * @param {url} [attributes.url] Action URL
 * @param {http_method} [attributes.method] Action URL method
 * @param {enum:event} [attributes.statusCallbackEvent] Status callback events
 * @param {url} [attributes.statusCallback] Status callback URL
 * @param {http_method} [attributes.statusCallbackMethod] Status callback URL method
