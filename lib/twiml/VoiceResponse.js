 ...
 * @param {record} [attributes.record] Record the call
 * @param {trim} [attributes.trim] Trim the recording
 ...
 * @param {recording_event} [attributes.recordingStatusCallbackEvent] Recording status callback events
 * @param {boolean} [attributes.answerOnBridge] Preserve the ringing behavior of the inbound call until the Dialed call picks up
 * @param {ring_tone} [attributes.ringTone] Ringtone allows you to override the ringback tone that Twilio will play back to the caller while executing the Dial
 ...
 *
 * @param {object} attributes - ...
 * @param {input} [attributes.input] Input type Twilio should accept
 * @param {string} [attributes.action] Action URL
 * @param {string} [attributes.method] Action URL method
 ...
 * @param {language} [attributes.language] Language to use
 ...
 *
 * @param {object} attributes - ...
 * @param {reason} [attributes.reason] Rejection reason
 */
/* jshint ignore:end */
 ...
 *
 * @param {object} attributes - ...
 * @param {voice} [attributes.voice] Voice to use
 * @param {number} [attributes.loop] Times to loop message
 * @param {language} [attributes.language] Message langauge
 ...
 * @param {event} [attributes.statusCallbackEvent] Events to trigger status callback
 * @param {string} [attributes.statusCallback] Status Callback URL
 ...
 * @param {beep} [attributes.beep] Play beep when joining
 ...
 * @param {record} [attributes.record] Record the conference
 * @param {region} [attributes.region] Conference region
 * @param {string} [attributes.whisper] Call whisper
 * @param {trim} [attributes.trim] Trim the conference recording
 * @param {event} [attributes.statusCallbackEvent] Events to call status callback URL
 * @param {string} [attributes.statusCallback] Status callback URL
 * @param {string} [attributes.statusCallbackMethod] Status callback URL method
 * @param {string} [attributes.recordingStatusCallback] Recording status callback URL
 * @param {string} [attributes.recordingStatusCallbackMethod] Recording status callback URL method
 ...
 * @param {event} [attributes.statusCallbackEvent] Events to call status callback
 * @param {string} [attributes.statusCallback] Status callback URL
 * @param {string} [attributes.statusCallbackMethod] Status callback URL method
 ...
 * @param {string} [attributes.url] Action URL
 * @param {string} [attributes.method] Action URL method
 * @param {event} [attributes.statusCallbackEvent] Status callback events
 * @param {string} [attributes.statusCallback] Status callback URL
 * @param {string} [attributes.statusCallbackMethod] Status callback URL method
