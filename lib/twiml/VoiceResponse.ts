...
class VoiceResponse extends TwiML {
  ...
  dial(attributes?: VoiceResponse.DialAttributes | string, number?: string): VoiceResponse.Dial {
  ...
  enqueue(attributes?: VoiceResponse.EnqueueAttributes | string, name?: string): VoiceResponse.Enqueue {
    if (typeof attributes === 'string') {
        name = attributes
        attributes = {}
    }
  ...
  play(attributes?: VoiceResponse.PlayAttributes | string, url?: string): VoiceResponse.Play {
    if (typeof attributes === 'string') {
        url = attributes
        attributes = {}
    }
  ...
  queue(attributes: VoiceResponse.QueueAttributes | string, name?: string): VoiceResponse.Queue {
    if (typeof attributes === 'string') {
        name = attributes
        attributes = {}
    }
  ...
  redirect(attributes: VoiceResponse.RedirectAttributes | string, url?: string): VoiceResponse.Redirect {
    if (typeof attributes === 'string') {
        url = attributes
        attributes = {}
    }
  ...
  say(attributes: VoiceResponse.SayAttributes | string, message?: string): VoiceResponse.Say {
    if (typeof attributes === 'string') {
        message = attributes
        attributes = {}
    }
  ...
  sms(attributes: VoiceResponse.SmsAttributes | string, message?: string): VoiceResponse.Sms {
    if (typeof attributes === 'string') {
        message = attributes
        attributes = {}
    }
...
namespace VoiceResponse {
  ...
  export class Connect extends TwiML {
    ...
    room(attributes: VoiceResponse.RoomAttributes | string, name?: string): VoiceResponse.Room {
      if (typeof attributes === 'string') {
          name = attributes
          attributes = {}
      }
  ...
  export class Dial extends TwiML {
    ...
    client(attributes?: VoiceResponse.ClientAttributes | string, identity?: string): VoiceResponse.Client {
      if (typeof attributes === 'string') {
          identity = attributes
          attributes = {}
      }
    ...
    conference(attributes: VoiceResponse.ConferenceAttributes | string, name?: string): VoiceResponse.Conference {
      if (typeof attributes === 'string') {
          name = attributes
          attributes = {}
      }
    ...
    number(attributes: VoiceResponse.NumberAttributes | string, phoneNumber?: string): VoiceResponse.Number {
      if (typeof attributes === 'string') {
    ...
    sip(attributes: VoiceResponse.SipAttributes | string, sipUrl?: string): VoiceResponse.Sip {
      if (typeof attributes === 'string') {
          sipUrl = attributes
          attributes = {}
      }
  ...
  export class Enqueue extends TwiML {
    ...
    task(attributes: VoiceResponse.TaskAttributes | string, body?: string): VoiceResponse.Task {
      if (typeof attributes === 'string') {
          body = attributes
          attributes = {}
      }
  ...
  export class Say extends TwiML {
    ...
    emphasis(attributes: VoiceResponse.SsmlEmphasisAttributes | string, words?: string): VoiceResponse.SsmlEmphasis {
      if (typeof attributes === 'string') {
          words = attributes
          attributes = {}
      }
    ...
    lang(attributes: VoiceResponse.SsmlLangAttributes | string, words?: string): VoiceResponse.SsmlLang {
      if (typeof attributes === 'string') {
          words = attributes
          attributes = {}
      }
    ...
    prosody(attributes: VoiceResponse.SsmlProsodyAttributes | string, words?: string): VoiceResponse.SsmlProsody {
      if (typeof attributes === 'string') {
          words = attributes
          attributes = {}
      }
    ...
    sayAs(attributes: VoiceResponse.SsmlSayAsAttributes | string, words?: string): VoiceResponse.SsmlSayAs {
      if (typeof attributes === 'string') {
          words = attributes
          attributes = {}
      }
    ...
    sub(attributes: VoiceResponse.SsmlSubAttributes | string, words?: string): VoiceResponse.SsmlSub {
      if (typeof attributes === 'string') {
          words = attributes
          attributes = {}
      }
    ...
    w(attributes: VoiceResponse.SsmlWAttributes | string, words?: string): VoiceResponse.SsmlW {
      if (typeof attributes === 'string') {
          words = attributes
          attributes = {}
      }
