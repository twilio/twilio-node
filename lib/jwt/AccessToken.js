 ...
 */
function ProgrammableVoiceGrant(options) {
  options = options || {};
...
_.extend(ProgrammableVoiceGrant.prototype, {
  key: 'programmable_voice',
  toPayload: function() {
    var grant = {};
    if (this.outgoingApplicationSid) {
      grant.outgoing_application_sid = this.outgoingApplicationSid;
    }
    if (this.outgoingApplicationParams) {
      grant.outgoing_application_params = this.outgoingApplicationParams;
    }
    if (this.pushCredentialSid) {
      grant.push_credential_sid = this.pushCredentialSid;
    }
...
AccessToken.ProgrammableVoiceGrant = ProgrammableVoiceGrant;
