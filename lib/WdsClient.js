/**
 ...
 in the Twilio WDS API.  Tries to map very closely to the resource structure
...
/**
 ...
 - @member {string} host - host for the Twilio API (default: wds.twilio.com)
 - @member {string} apiVersion - the Twilio REST API version to use for requests (default: v1)
 */
function WdsClient(sid, tkn, workspaceSid, options) {
    ...
    options = options || {};
    WdsClient.super_.call(this, sid, tkn, options.host || 'wds.twilio.com', options.apiVersion || 'v1', options.timeout);

    //REST Resource - shorthand for just "workspace" and "workspaces" to match the REST API
    var workspaceResource = require('./resources/wds/Workspaces')(this);
...
util.inherits(WdsClient, Client);

module.exports = WdsClient;
