...
SinkList = function SinkList(version) {
   ...
   * @param {string} opts.description - The description
   * @param {object} opts.sinkConfiguration - The sink_configuration
   * @param {sink.sink_type} opts.sinkType - The sink_type
 ...
 * @property {object} sinkConfiguration - The sink_configuration
 * @property {sink.sink_type} sinkType - The sink_type
 * @property {sink.status} status - The status
