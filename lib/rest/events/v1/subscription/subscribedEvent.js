...
SubscribedEventList = function SubscribedEventList(version, subscriptionSid) {
   ...
   * @param {number} [opts.version] - The version
  ...
  SubscribedEventListInstance.create = function create(opts, callback) {
    ...
    var deferred = Q.defer();
    var data = values.of({'Type': _.get(opts, 'type'), 'Version': _.get(opts, 'version')});
 ...
 * @property {string} subscriptionSid - The subscription_sid
 * @property {string} url - The url
 *
 * @param {V1} version - Version of the resource
 * @param {SubscribedEventPayload} payload - The instance payload
 * @param {sid} subscriptionSid - The subscription_sid
 * @param {string} type - The type
 */
/* jshint ignore:end */
...
SubscribedEventContext.prototype.update = function update(opts, callback) {
  ...
  if (_.isUndefined(opts.version)) {
    throw new Error('Required parameter "opts.version" missing.');
  }

  var deferred = Q.defer();
  var data = values.of({'Version': _.get(opts, 'version')});
