...
function EventList(version) {
  ...
  EventListInstance.page = function page(opts) {
    var params = values.of({
      'ActorSid': opts.actorSid || values.unset,
      'EndDate<': opts.enddatebefore || values.unset,
      'EndDate': opts.endDate || values.unset,
      'EndDate>': opts.enddateafter || values.unset,
      'EventType': opts.eventType || values.unset,
      'ResourceSid': opts.resourceSid || values.unset,
      'SourceIpAddress': opts.sourceIpAddress || values.unset,
      'StartDate<': opts.startdatebefore || values.unset,
      'StartDate': opts.startDate || values.unset,
      'StartDate>': opts.startdateafter || values.unset,
