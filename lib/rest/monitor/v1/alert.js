...
function AlertList(version) {
   ...
   */
  AlertListInstance.read = function stream(opts) {
   ...
   */
  AlertListInstance.read = function list(opts) {
    return this.page();
  };
   ...
   */
  AlertListInstance.read = function page(opts, page_token=values.unset,
