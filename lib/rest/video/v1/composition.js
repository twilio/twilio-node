 ...
 * @property {string} audioSourcesExcluded - The audio_sources_excluded
 * @property {string} videoLayout - The video_layout
 * @property {string} resolution - The resolution
 * @property {boolean} trim - The trim
 * @property {composition.format} format - The format
 * @property {number} bitrate - The bitrate
 * @property {string} size - The size
...
CompositionInstance = function CompositionInstance(version, payload, sid) {
  ...
  this.size = payload.size; // jshint ignore:line
