 ...
 */
/* jshint ignore:end */
function RecordingList(version) {
  /* jshint ignore:start */
  /**
   * @function recordings
  ...
  RecordingListInstance.page = function page(opts, callback) {
    ...
    var data = values.of({
      ...
      'SourceSid': _.get(opts, "sourceSid", undefined),
 ...
 */
/* jshint ignore:end */
function RecordingInstance(version, payload, sid) {
 ...
 */
/* jshint ignore:end */
function RecordingContext(version, sid) {
  this._version = version;
