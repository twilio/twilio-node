...
var RoomParticipantList = require('./room/roomParticipant').RoomParticipantList;
 ...
 * @instance
 *
 * @returns {Twilio.Video.V1.RoomContext.RoomParticipantList}
 */
/* jshint ignore:end */
 ...
 *          recordings resource
 * @property {Twilio.Video.V1.RoomContext.RoomParticipantList} participants -
...
Object.defineProperty(RoomContext.prototype,
  ...
  get: function() {
    if (!this._participants) {
      this._participants = new RoomParticipantList(this._version, this._solution.sid);
    }
