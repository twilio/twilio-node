...
function RoomList(version) {
  ...
  RoomListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      'EnableTurn': _.get(opts, "enableTurn", undefined),
      'Type': _.get(opts, "type", undefined),
      ...
      'RecordParticipantsOnConnect': _.get(opts, "recordParticipantsOnConnect", undefined)
    });
   ...
   * @param {Date} [opts.startTimeAfter] - The start_time_after
   * @param {Date} [opts.startTimeBefore] - The start_time_before
   * @param {string} [opts.uniqueName] - The unique_name
  ...
  RoomListInstance.page = function page(opts, callback) {
    ...
    var data = values.of({
      ...
      'StartTimeAfter': serialize.iso8601DateTime(_.get(opts, "startTimeAfter", undefined)),
      'StartTimeBefore': serialize.iso8601DateTime(_.get(opts, "startTimeBefore", undefined)),
      'UniqueName': _.get(opts, "uniqueName", undefined),
 ...
 */
/* jshint ignore:end */
function RoomPage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function RoomInstance(version, payload, sid) {
 ...
 */
/* jshint ignore:end */
function RoomContext(version, sid) {
  this._version = version;
