...
SubscribedTrackList = function SubscribedTrackList(version, roomSid,
  ...
  SubscribedTrackListInstance._uri = _.template(
    '/Rooms/<%= roomSid %>/Participants/<%= participantSid %>/SubscribedTracks' // jshint ignore:line
...
SubscribedTrackContext = function SubscribedTrackContext(version, roomSid,
  ...
  this._uri = _.template(
    '/Rooms/<%= roomSid %>/Participants/<%= participantSid %>/SubscribedTracks/<%= sid %>' // jshint ignore:line
  )(this._solution);
};
