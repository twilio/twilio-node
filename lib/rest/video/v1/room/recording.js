...
/* jshint ignore:start */
/**
 * @constructor Twilio.Video.V1.RoomContext.RecordingList
 ...
 */
/* jshint ignore:end */
RecordingList = function RecordingList(version, roomSid) {
  /* jshint ignore:start */
  /**
   * @function recordings
   ...
   *
   * @returns {Twilio.Video.V1.RoomContext.RecordingContext}
   */
  /* jshint ignore:end */
   ...
   *
   * @function each
   * @memberof Twilio.Video.V1.RoomContext.RecordingList
   * @instance
   *
...
/* jshint ignore:start */
/**
 * @constructor Twilio.Video.V1.RoomContext.RecordingPage
 * @augments Page
 ...
 * @memberof Twilio.Video.V1.RoomContext.RecordingPage
 * @instance
 *
...
/* jshint ignore:start */
/**
 * @constructor Twilio.Video.V1.RoomContext.RecordingInstance
 ...
 */
/* jshint ignore:end */
RecordingInstance = function RecordingInstance(version, payload, roomSid, sid) {
 ...
 *
 * @function fetch
 * @memberof Twilio.Video.V1.RoomContext.RecordingInstance
 * @instance
 *
...
/* jshint ignore:start */
/**
 * @constructor Twilio.Video.V1.RoomContext.RecordingContext
 * @description Initialize the RecordingContext
 *
 * @param {Twilio.Video.V1} version - Version of the resource
 * @param {sid} roomSid - The room_sid
 ...
 */
/* jshint ignore:end */
RecordingContext = function RecordingContext(version, roomSid, sid) {
  this._version = version;
 ...
 *
 * @function fetch
 * @memberof Twilio.Video.V1.RoomContext.RecordingContext
 * @instance
 *
 * @param {function} [callback] - Callback to handle processed record
 *
