 ...
 * @memberof Twilio.Verify.V2.ServiceContext.EntityContext.FactorInstance#
 *
 * @returns {Twilio.Verify.V2.ServiceContext.EntityContext.FactorContext.ChallengeList}
 */
/* jshint ignore:end */
 ...
 *
 * @property {Twilio.Verify.V2.ServiceContext.EntityContext.FactorContext.ChallengeList} challenges -
 *          challenges resource
 *
 * @param {V2} version - Version of the resource
 * @param {sid} serviceSid - Service Sid.
