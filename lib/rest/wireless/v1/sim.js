...
SimList = function SimList(version) {
   ...
   * @param {string} [opts.ratePlan] - Only return Sim resources with this Rate Plan
 ...
 * @property {sim.status} status - The status of the SIM
 ...
 * @param {sim.status} [opts.status] - The new status of the resource
 ...
 * @param {string} [opts.smsMethod] - The HTTP method we use to call sms_url
