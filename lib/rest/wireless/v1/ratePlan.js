...
RatePlanList = function RatePlanList(version) {
   ...
   * @param {string} [opts.dataEnabled] - The data_enabled
   * @param {number} [opts.dataLimit] - The data_limit
   * @param {string} [opts.dataMetering] - The data_metering
   * @param {string} [opts.messagingEnabled] - The messaging_enabled
   * @param {string} [opts.voiceEnabled] - The voice_enabled
   * @param {string} [opts.nationalRoamingEnabled] - The national_roaming_enabled
  ...
  RatePlanListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      ...
      'DataEnabled': _.get(opts, 'dataEnabled'),
      'DataLimit': _.get(opts, 'dataLimit'),
      'DataMetering': _.get(opts, 'dataMetering'),
      'MessagingEnabled': _.get(opts, 'messagingEnabled'),
      'VoiceEnabled': _.get(opts, 'voiceEnabled'),
      'NationalRoamingEnabled': _.get(opts, 'nationalRoamingEnabled'),
      'InternationalRoaming': _.get(opts, 'internationalRoaming')
    });
 ...
 * @property {string} dataEnabled - The data_enabled
 * @property {string} dataMetering - The data_metering
 * @property {number} dataLimit - The data_limit
 * @property {string} messagingEnabled - The messaging_enabled
 * @property {string} voiceEnabled - The voice_enabled
 * @property {string} nationalRoamingEnabled - The national_roaming_enabled
