...
function BindingList(version, serviceSid) {
  ...
  BindingListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      'Endpoint': _.get(opts, "endpoint", undefined),
      'Identity': _.get(opts, "identity", undefined),
      'BindingType': _.get(opts, "bindingType", undefined),
      'Address': _.get(opts, "address", undefined),
      'Tag': _.get(opts, "tag", undefined),
      'NotificationProtocolVersion': _.get(opts, "notificationProtocolVersion", undefined),
      'CredentialSid': _.get(opts, "credentialSid", undefined)
    });
  ...
  BindingListInstance.page = function page(opts, callback) {
    ...
    var deferred = Q.defer();
    var data = values.of({
      'StartDate': serialize.iso8601Date(_.get(opts, "startDate", undefined)),
      'EndDate': serialize.iso8601Date(_.get(opts, "endDate", undefined)),
      'Identity': _.get(opts, "identity", undefined),
      'Tag': _.get(opts, "tag", undefined),
