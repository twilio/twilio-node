...
function NotificationList(version, serviceSid) {
  ...
  NotificationListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      'Identity': _.get(opts, "identity", undefined),
      'Tag': _.get(opts, "tag", undefined),
      'Body': _.get(opts, "body", undefined),
      'Priority': _.get(opts, "priority", undefined),
      'Ttl': _.get(opts, "ttl", undefined),
      'Title': _.get(opts, "title", undefined),
      'Sound': _.get(opts, "sound", undefined),
      'Action': _.get(opts, "action", undefined),
      'Data': _.get(opts, "data", undefined),
      'Apn': _.get(opts, "apn", undefined),
      'Gcm': _.get(opts, "gcm", undefined),
      'Sms': _.get(opts, "sms", undefined),
      'FacebookMessenger': serialize.object(_.get(opts, "facebookMessenger", undefined)),
      'Fcm': _.get(opts, "fcm", undefined)
    });
