 ...
 * @param {SegmentSolution} solution - Path solution
 *
 * @returns SegmentPage
 */
/* jshint ignore:end */
 ...
 *
 * @param {SegmentPayload} payload - Payload response from the API
 *
 ...
 *
 * @param {V1} version - Version of the resource
 * @param {SegmentPayload} payload - The instance payload
 ...
 */
/* jshint ignore:end */
SegmentInstance.prototype.toJSON = function toJSON() {
  let clone = {};
