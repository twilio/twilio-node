...
function ServiceList(version) {
  ...
  ServiceListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      ...
      'ApnCredentialSid': _.get(opts, "apnCredentialSid", undefined),
      'GcmCredentialSid': _.get(opts, "gcmCredentialSid", undefined),
      'MessagingServiceSid': _.get(opts, "messagingServiceSid", undefined),
      'FacebookMessengerPageId': _.get(opts, "facebookMessengerPageId", undefined),
      'DefaultApnNotificationProtocolVersion': _.get(opts, "defaultApnNotificationProtocolVersion", undefined),
      'DefaultGcmNotificationProtocolVersion': _.get(opts, "defaultGcmNotificationProtocolVersion", undefined),
      'FcmCredentialSid': _.get(opts, "fcmCredentialSid", undefined),
      'DefaultFcmNotificationProtocolVersion': _.get(opts, "defaultFcmNotificationProtocolVersion", undefined)
    });
