...
/* jshint ignore:start */
/**
 * @constructor Twilio.Notifications.V1.ServiceContext.NotificationPage
 * @augments Page
 ...
 * @memberof Twilio.Notifications.V1.ServiceContext.NotificationPage
 * @instance
 *
...
/* jshint ignore:start */
/**
 * @constructor Twilio.Notifications.V1.ServiceContext.NotificationList
...
function NotificationList(version, serviceSid) {
   ...
   *
   * @returns {Twilio.Notifications.V1.ServiceContext.NotificationContext}
   */
  /* jshint ignore:end */
   ...
   *
   * @function create
   * @memberof Twilio.Notifications.V1.ServiceContext.NotificationList
   * @instance
   *
...
/* jshint ignore:start */
/**
 * @constructor Twilio.Notifications.V1.ServiceContext.NotificationInstance
