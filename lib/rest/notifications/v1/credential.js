...
/* jshint ignore:start */
/**
 * @constructor Twilio.Notifications.V1.CredentialPage
 * @augments Page
 ...
 */
/* jshint ignore:end */
function CredentialPage(version, response) {
 ...
 * @memberof Twilio.Notifications.V1.CredentialPage
 * @instance
 *
...
/* jshint ignore:start */
/**
 * @constructor Twilio.Notifications.V1.CredentialList
...
function CredentialList(version) {
   ...
   *
   * @returns {Twilio.Notifications.V1.CredentialContext}
   */
  /* jshint ignore:end */
   ...
   *
   * @function each
   * @memberof Twilio.Notifications.V1.CredentialList
   * @instance
   *
   ...
   * @param {string} [opts.sandbox] - The sandbox
...
/* jshint ignore:start */
/**
 * @constructor Twilio.Notifications.V1.CredentialInstance
 ...
 */
/* jshint ignore:end */
function CredentialInstance(version, payload, sid) {
 ...
 *
 * @function fetch
 * @memberof Twilio.Notifications.V1.CredentialInstance
 * @instance
 *
 * @param {function} [callback] - Callback to handle processed record
 *
...
/* jshint ignore:start */
/**
 * @constructor Twilio.Notifications.V1.CredentialContext
 * @description Initialize the CredentialContext
 *
 * @param {Twilio.Notifications.V1} version - Version of the resource
 * @param {sid} sid - The sid
 */
/* jshint ignore:end */
function CredentialContext(version, sid) {
  this._version = version;
 ...
 *
 * @function fetch
 * @memberof Twilio.Notifications.V1.CredentialContext
 * @instance
 *
 * @param {function} [callback] - Callback to handle processed record
 *
