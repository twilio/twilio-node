...
export function CustomerProfilesEvaluationsListInstance(version: V1, customerProfileSid: string): CustomerProfilesEvaluationsListInstance {
  const instance = ((sid) => instance.get(sid)) as CustomerProfilesEvaluationsListInstanceImpl;
  ...
  instance.create = function create(params: any, callback?: any): Promise<CustomerProfilesEvaluationsInstance> {
  ...
  instance.page = function page(params?: any, callback?: any): Promise<CustomerProfilesEvaluationsPage> {
    ...
    operationPromise = operationPromise.then(payload => new CustomerProfilesEvaluationsPage(operationVersion, payload, this._solution));
  ...
  instance.getPage = function getPage(targetUrl?: any, callback?: any): Promise<CustomerProfilesEvaluationsPage> {
    let operationPromise = this._version._domain.twilio.request({method: "get", uri: targetUrl});

    operationPromise = operationPromise.then(payload => new CustomerProfilesEvaluationsPage(this._version, payload, this._solution));
    operationPromise = this._version.setPromiseCallback(operationPromise,callback);
    return operationPromise;
  }
