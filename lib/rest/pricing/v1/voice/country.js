 ...
 * @param {V1} version - Version that contains the resource
 *
 * @returns {function} - CountryListInstance
 */
function CountryList(version) {
   ...
   * @memberof CountryList
   *
   * @description Streams CountryInstance records from the API.
   *
   ...
   * @memberof CountryList
   *
   * @description Retrieve a single page of CountryInstance records from the API.
   ...
   * @memberof CountryList
   *
   * @description Constructs a CountryContext
   *
...
/**
 * @description Fetch a CountryInstance
 *
