...
function CredentialList(version) {
  ...
  CredentialListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      ...
      'Certificate': _.get(opts, "certificate", undefined),
      'PrivateKey': _.get(opts, "privateKey", undefined),
      'Sandbox': _.get(opts, "sandbox", undefined),
      'ApiKey': _.get(opts, "apiKey", undefined),
      'Secret': _.get(opts, "secret", undefined)
    });
