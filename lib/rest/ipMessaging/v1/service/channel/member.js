 ...
 */
/* jshint ignore:end */
function MemberList(version, serviceSid, channelSid) {
  /* jshint ignore:start */
  /**
   * @function members
  ...
  MemberListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      ...
      'RoleSid': _.get(opts, "roleSid", undefined)
    });
 ...
 */
/* jshint ignore:end */
function MemberPage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function MemberInstance(version, payload, serviceSid, channelSid, sid) {
 ...
 */
/* jshint ignore:end */
function MemberContext(version, serviceSid, channelSid, sid) {
  this._version = version;
...
MemberContext.prototype.update = function update(opts, callback) {
  ...
  var data = values.of({
    'RoleSid': _.get(opts, "roleSid", undefined),
    'LastConsumedMessageIndex': _.get(opts, "lastConsumedMessageIndex", undefined)
  });
