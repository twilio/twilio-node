 ...
 */
/* jshint ignore:end */
function InvitePage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function InviteList(version, serviceSid, channelSid) {
  /* jshint ignore:start */
  /**
   * @function invites
 ...
 */
/* jshint ignore:end */
function InviteInstance(version, payload, serviceSid, channelSid, sid) {
 ...
 */
/* jshint ignore:end */
function InviteContext(version, serviceSid, channelSid, sid) {
  this._version = version;
