 ...
 */
/* jshint ignore:end */
function MessageList(version, serviceSid, channelSid) {
  /* jshint ignore:start */
  /**
   * @function messages
 ...
 */
/* jshint ignore:end */
function MessageInstance(version, payload, serviceSid, channelSid, sid) {
 ...
 */
/* jshint ignore:end */
function MessageContext(version, serviceSid, channelSid, sid) {
  this._version = version;
