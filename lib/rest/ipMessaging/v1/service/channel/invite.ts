...
export interface InviteContext {
   ...
   */
  remove(callback?: (error: Error | null, item?: InviteInstance) => any): Promise<boolean>
...
export class InviteInstance {
  ...
  constructor(protected _version: V1, payload: InvitePayload, serviceSid: string, channelSid: string, sid?: string) {
...
export function InviteListInstance(version: V1, serviceSid: string, channelSid: string): InviteListInstance {
  ...
  instance.create = function create(params: any, callback?: any): Promise<InviteInstance> {
