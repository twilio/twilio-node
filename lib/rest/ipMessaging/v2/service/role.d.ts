...
interface RoleResource {
  ...
  permissions: string;
  /**
   * The unique id of the [Service](https://www.twilio.com/docs/chat/api/services) this role belongs to.
   */
  service_sid: string;
  /**
  ...
  sid: string;
  /**
   * What kind of role this is. Either `channel` for [Channel](https://www.twilio.com/docs/chat/api/channels) roles or `deployment` for [Service](https://www.twilio.com/docs/chat/api/services) roles.
   */
  type: RoleRoleType;
  /**
...
interface RoleListCreateOptions {
  ...
  permission: string[];
  /**
   * What kind of role this is. Either `channel` for [Channel](https://www.twilio.com/docs/chat/api/channels) roles or `deployment` for [Service](https://www.twilio.com/docs/api/chat/rest/services) roles.
   */
  type: RoleRoleType;
}
