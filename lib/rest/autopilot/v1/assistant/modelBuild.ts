...
export interface ModelBuildContext {
   ...
   */
  remove(callback?: (error: Error | null, item?: ModelBuildInstance) => any): Promise<boolean>
...
export class ModelBuildContextImpl implements ModelBuildContext {
  ...
  fetch(callback?: any): Promise<ModelBuildInstance> {
    ...
    operationPromise = operationPromise.then(payload => new ModelBuildInstance(operationVersion, payload, this._solution.assistantSid, this._solution.sid));
...
export class ModelBuildInstance {
  ...
  constructor(protected _version: V1, payload: ModelBuildPayload, assistantSid: string, sid?: string) {
  ...
  private get _proxy(): ModelBuildContext {
    this._context = this._context || new ModelBuildContextImpl(this._version, this._solution.assistantSid, this._solution.sid);
...
export class ModelBuildPage extends Page<V1, ModelBuildPayload, ModelBuildResource, ModelBuildInstance> {
  /**
...
export function ModelBuildListInstance(version: V1, assistantSid: string): ModelBuildListInstance {
  ...
  instance.create = function create(params?: any, callback?: any): Promise<ModelBuildInstance> {
    if (typeof params === "function") {
      callback = params;
      params = {};
    } else {
    ...
    operationPromise = operationPromise.then(payload => new ModelBuildInstance(operationVersion, payload, this._solution.assistantSid));
  ...
  instance.page = function page(params?: any, callback?: any): Promise<ModelBuildPage> {
    ...
    operationPromise = operationPromise.then(payload => new ModelBuildPage(operationVersion, payload, this._solution));
  ...
  instance.getPage = function getPage(targetUrl?: any, callback?: any): Promise<ModelBuildPage> {
    let operationPromise = this._version._domain.twilio.request({method: 'get', uri: targetUrl});

    operationPromise = operationPromise.then(payload => new ModelBuildPage(this._version, payload, this._solution));
    operationPromise = this._version.setPromiseCallback(operationPromise,callback);
    return operationPromise;
  }
