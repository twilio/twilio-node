...
export class WebhookInstance {
  ...
  constructor(protected _version: V1, payload: WebhookPayload, assistantSid: string, sid?: string) {
  ...
  private get _proxy(): WebhookContext {
    this._context = this._context || new WebhookContextImpl(this._version, this._solution.assistantSid, this._solution.sid);
...
export function WebhookListInstance(version: V1, assistantSid: string): WebhookListInstance {
