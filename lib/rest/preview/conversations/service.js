...
/* jshint ignore:start */
/**
 * @constructor Twilio.Preview.Conversations.ServiceList
...
ServiceList = function ServiceList(version) {
  ...
  /**
   * @function services
   * @memberof Twilio.Preview.Conversations
   * @instance
   *
   * @param {string} sid - sid of instance
   *
   * @returns {Twilio.Preview.Conversations.ServiceContext}
   */
  /* jshint ignore:end */
   ...
   *
   * @function each
   * @memberof Twilio.Preview.Conversations.ServiceList
   * @instance
   *
  ...
  ServiceListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      ...
      'AutoCreate': _.get(opts, 'autoCreate'),
...
/* jshint ignore:start */
/**
 * @constructor Twilio.Preview.Conversations.ServicePage
 * @augments Page
 ...
 * @memberof Twilio.Preview.Conversations.ServicePage
 * @instance
 *
...
/* jshint ignore:start */
/**
 * @constructor Twilio.Preview.Conversations.ServiceInstance
 ...
 *
 * @function fetch
 * @memberof Twilio.Preview.Conversations.ServiceInstance
 * @instance
 *
 * @param {function} [callback] - Callback to handle processed record
 *
 ...
 * @instance
 *
 * @returns {Twilio.Preview.Conversations.ServiceContext.ConversationList}
 */
/* jshint ignore:end */
...
/* jshint ignore:start */
/**
 * @constructor Twilio.Preview.Conversations.ServiceContext
 * @description Initialize the ServiceContext
 *
 * @property {Twilio.Preview.Conversations.ServiceContext.ConversationList} conversations -
