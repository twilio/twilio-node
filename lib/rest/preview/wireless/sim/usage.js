 ...
 */
/* jshint ignore:end */
function UsageList(version, simSid) {
  /* jshint ignore:start */
  /**
   * @function usage
 ...
 */
/* jshint ignore:end */
function UsageInstance(version, payload, simSid) {
 ...
 */
/* jshint ignore:end */
function UsageContext(version, simSid) {
  this._version = version;
...
UsageContext.prototype.fetch = function fetch(opts, callback) {
  ...
  var data = values.of({
    'End': _.get(opts, "end", undefined),
    'Start': _.get(opts, "start", undefined)
  });
