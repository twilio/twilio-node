...
function RatePlanList(version) {
  ...
  RatePlanListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      ...
      'Roaming': _.get(opts, "roaming", undefined),
      'DataLimit': _.get(opts, "dataLimit", undefined),
      'DataMetering': _.get(opts, "dataMetering", undefined),
      'CommandsEnabled': _.get(opts, "commandsEnabled", undefined),
      'Renewal': _.get(opts, "renewal", undefined)
    });
