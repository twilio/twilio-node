...
function CommandList(version) {
  ...
  CommandListInstance.page = function page(opts, callback) {
    ...
    var deferred = Q.defer();
    var data = values.of({
      'Device': _.get(opts, "device", undefined),
      'Sim': _.get(opts, "sim", undefined),
      'Status': _.get(opts, "status", undefined),
      'Direction': _.get(opts, "direction", undefined),
  ...
  CommandListInstance.create = function create(opts, callback) {
    ...
    var deferred = Q.defer();
    var data = values.of({
      'Command': _.get(opts, "command", undefined),
      'Device': _.get(opts, "device", undefined),
      'Sim': _.get(opts, "sim", undefined),
      'CallbackMethod': _.get(opts, "callbackMethod", undefined),
      'CallbackUrl': _.get(opts, "callbackUrl", undefined),
      'CommandMode': _.get(opts, "commandMode", undefined),
      'IncludeSid': _.get(opts, "includeSid", undefined)
    });
