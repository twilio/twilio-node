 ...
 */
/* jshint ignore:end */
function SyncMapPermissionList(version, serviceSid, mapSid) {
  /* jshint ignore:start */
  /**
  ...
  SyncMapPermissionListInstance.page = function page(opts, callback) {
    ...
    promise = promise.then(function(payload) {
      deferred.resolve(new SyncMapPermissionPage(
        this._version,
        payload,
        this._solution
      ));
 ...
 */
/* jshint ignore:end */
function SyncMapPermissionPage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function SyncMapPermissionInstance(version, payload, serviceSid, mapSid,
                                    identity) {
 ...
 */
/* jshint ignore:end */
function SyncMapPermissionContext(version, serviceSid, mapSid, identity) {
  this._version = version;
