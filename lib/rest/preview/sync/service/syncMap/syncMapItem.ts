 ...
 *
 * @property { SyncMapItemEnumQueryResultOrder } [order] 
 * @property { string } [from] 
 * @property { SyncMapItemEnumQueryFromBoundType } [bounds] 
...
export class SyncMapItemContextImpl implements SyncMapItemContext {
  protected _solution: SyncMapItemSolution;
  protected _uri: string;


  constructor(protected _version: Sync, serviceSid: string, mapSid: string, key: string) {
...
export class SyncMapItemInstance {
  ...
  constructor(protected _version: Sync, payload: SyncMapItemPayload, serviceSid: string, mapSid: string, key?: string) {
...
export function SyncMapItemListInstance(version: Sync, serviceSid: string, mapSid: string): SyncMapItemListInstance {
