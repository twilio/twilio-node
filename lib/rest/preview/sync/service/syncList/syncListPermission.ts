...
export interface SyncListPermissionContext {
   ...
   */
  remove(callback?: (error: Error | null, item?: SyncListPermissionInstance) => any): Promise<boolean>
...
export class SyncListPermissionInstance {
  ...
  constructor(protected _version: Sync, payload: SyncListPermissionPayload, serviceSid: string, listSid: string, identity?: string) {
...
class SyncListPermissionListInstanceImpl implements SyncListPermissionListInstance {
  _version?: Sync;
...
export function SyncListPermissionListInstance(version: Sync, serviceSid: string, listSid: string): SyncListPermissionListInstance {
  const instance = ((identity) => instance.get(identity)) as SyncListPermissionListInstanceImpl;
  ...
  instance.page = function page(params?: any, callback?: any): Promise<SyncListPermissionPage> {
  ...
  instance.getPage = function getPage(targetUrl?: any, callback?: any): Promise<SyncListPermissionPage> {
