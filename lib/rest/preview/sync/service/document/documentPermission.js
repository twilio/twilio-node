 ...
 */
/* jshint ignore:end */
function DocumentPermissionList(version, serviceSid, documentSid) {
  /* jshint ignore:start */
  /**
  ...
  DocumentPermissionListInstance.page = function page(opts, callback) {
    ...
    promise = promise.then(function(payload) {
      deferred.resolve(new DocumentPermissionPage(
        this._version,
        payload,
        this._solution
      ));
 ...
 */
/* jshint ignore:end */
function DocumentPermissionPage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function DocumentPermissionInstance(version, payload, serviceSid, documentSid,
                                     identity) {
 ...
 */
/* jshint ignore:end */
function DocumentPermissionContext(version, serviceSid, documentSid, identity) {
  this._version = version;
...
DocumentPermissionContext.prototype.update = function update(opts, callback) {
  ...
  var deferred = Q.defer();
  var data = values.of({
    'Read': _.get(opts, "read", undefined),
    'Write': _.get(opts, "write", undefined),
    'Manage': _.get(opts, "manage", undefined)
  });
