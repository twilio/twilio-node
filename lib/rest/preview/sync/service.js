...
function ServiceList(version) {
   ...
   * @param {string} [opts.reachabilityWebhooksEnabled] -
   *          The reachability_webhooks_enabled
   * @param {string} [opts.aclEnabled] - The acl_enabled
  ...
  ServiceListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      ...
      'WebhookUrl': _.get(opts, "webhookUrl", undefined),
      'ReachabilityWebhooksEnabled': _.get(opts, "reachabilityWebhooksEnabled", undefined),
      'AclEnabled': _.get(opts, "aclEnabled", undefined)
    });
 ...
 *          The reachability_webhooks_enabled
 * @property {string} aclEnabled - The acl_enabled
