...
export interface SampleContext {
   ...
   */
  remove(callback?: (error: Error | null, item?: SampleInstance) => any): Promise<boolean>
...
export class SampleContextImpl implements SampleContext {
  ...
  constructor(protected _version: Understand, assistantSid: string, taskSid: string, sid: string) {
...
export class SampleInstance {
  ...
  constructor(protected _version: Understand, payload: SamplePayload, assistantSid: string, taskSid: string, sid?: string) {
  ...
  private get _proxy(): SampleContext {
    this._context = this._context || new SampleContextImpl(this._version, this._solution.assistantSid, this._solution.taskSid, this._solution.sid);
...
export function SampleListInstance(version: Understand, assistantSid: string, taskSid: string): SampleListInstance {
  ...
  instance.create = function create(params: any, callback?: any): Promise<SampleInstance> {
