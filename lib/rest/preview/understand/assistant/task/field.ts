...
export interface FieldContext {
   ...
   */
  remove(callback?: (error: Error | null, item?: FieldInstance) => any): Promise<boolean>
...
export function FieldListInstance(version: Understand, assistantSid: string, taskSid: string): FieldListInstance {
