...
var BrandList = require('./business/brand').BrandList;
 ...
 * @memberof Twilio.Preview.TrustedComms.BusinessInstance#
 *
 * @returns {Twilio.Preview.TrustedComms.BusinessContext.BrandList}
 */
/* jshint ignore:end */
BusinessInstance.prototype.brands = function brands() {
  return this._proxy.brands;
};
 ...
 *
 * @property {Twilio.Preview.TrustedComms.BusinessContext.BrandList} brands -
 *          brands resource
...
Object.defineProperty(BusinessContext.prototype,
  'brands', {
    get: function() {
      if (!this._brands) {
        this._brands = new BrandList(this._version, this._solution.sid);
      }
      return this._brands;
    }
});
