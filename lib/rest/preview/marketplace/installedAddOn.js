 ...
 */
/* jshint ignore:end */
function InstalledAddOnList(version) {
  /* jshint ignore:start */
  /**
   ...
   * @param {string} opts.acceptTermsOfService -
  ...
  InstalledAddOnListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      'AvailableAddOnSid': _.get(opts, "availableAddOnSid", undefined),
      'AcceptTermsOfService': _.get(opts, "acceptTermsOfService", undefined),
      'Configuration': serialize.object(_.get(opts, "configuration", undefined)),
    ...
    promise = promise.then(function(payload) {
      deferred.resolve(new InstalledAddOnInstance(
        this._version,
        payload,
        this._solution.sid
      ));
  ...
  InstalledAddOnListInstance.page = function page(opts, callback) {
    ...
    promise = promise.then(function(payload) {
      deferred.resolve(new InstalledAddOnPage(
        this._version,
        payload,
        this._solution
      ));
 ...
 */
/* jshint ignore:end */
function InstalledAddOnPage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function InstalledAddOnInstance(version, payload, sid) {
...
Object.defineProperty(InstalledAddOnInstance.prototype,
  ...
  get: function() {
    if (!this._context) {
      this._context = new InstalledAddOnContext(
        this._version,
        this._solution.sid
      );
    }
 ...
 */
/* jshint ignore:end */
function InstalledAddOnContext(version, sid) {
  this._version = version;
