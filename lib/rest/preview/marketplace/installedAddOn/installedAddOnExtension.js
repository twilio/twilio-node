 ...
 */
/* jshint ignore:end */
function InstalledAddOnExtensionPage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function InstalledAddOnExtensionList(version, installedAddOnSid) {
  /* jshint ignore:start */
  /**
   * @function extensions
  ...
  InstalledAddOnExtensionListInstance.page = function page(opts, callback) {
    ...
    promise = promise.then(function(payload) {
      deferred.resolve(new InstalledAddOnExtensionPage(
        this._version,
        payload,
        this._solution
      ));
 ...
 */
/* jshint ignore:end */
function InstalledAddOnExtensionInstance(version, payload, installedAddOnSid,
                                          sid) {
 ...
 */
/* jshint ignore:end */
function InstalledAddOnExtensionContext(version, installedAddOnSid, sid) {
  this._version = version;
...
InstalledAddOnExtensionContext.prototype.update = function update(opts,
  ...
  var deferred = Q.defer();
  var data = values.of({
    'Enabled': _.get(opts, "enabled", undefined)
  });
