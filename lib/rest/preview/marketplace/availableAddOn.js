 ...
 */
/* jshint ignore:end */
function AvailableAddOnList(version) {
  /* jshint ignore:start */
  /**
  ...
  AvailableAddOnListInstance.page = function page(opts, callback) {
    ...
    promise = promise.then(function(payload) {
      deferred.resolve(new AvailableAddOnPage(
        this._version,
        payload,
        this._solution
      ));
 ...
 */
/* jshint ignore:end */
function AvailableAddOnPage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function AvailableAddOnInstance(version, payload, sid) {
...
Object.defineProperty(AvailableAddOnInstance.prototype,
  ...
  get: function() {
    if (!this._context) {
      this._context = new AvailableAddOnContext(
        this._version,
        this._solution.sid
      );
    }
 ...
 */
/* jshint ignore:end */
function AvailableAddOnContext(version, sid) {
  this._version = version;
...
AvailableAddOnContext.prototype.fetch = function fetch(callback) {
  ...
  promise = promise.then(function(payload) {
    deferred.resolve(new AvailableAddOnInstance(
      this._version,
      payload,
      this._solution.sid
    ));
