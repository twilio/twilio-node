...
AuthorizationDocumentList = function AuthorizationDocumentList(version) {
  ...
  AuthorizationDocumentListInstance.create = function create(opts, callback) {
    ...
    var deferred = Q.defer();
    var data = values.of({
      'HostedNumberOrderSids': _.get(opts, 'hostedNumberOrderSids'),
    ...
    promise = promise.then(function(payload) {
      deferred.resolve(new AuthorizationDocumentInstance(
        this._version,
        payload,
        this._solution.sid
      ));
...
Object.defineProperty(AuthorizationDocumentInstance.prototype,
  ...
  get: function() {
    if (!this._context) {
      this._context = new AuthorizationDocumentContext(
        this._version,
        this._solution.sid
      );
    }
