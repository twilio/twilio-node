...
class AuthorizationDocumentListInstanceImpl implements AuthorizationDocumentListInstance {
...
export function AuthorizationDocumentListInstance(version: HostedNumbers): AuthorizationDocumentListInstance {
  const instance = ((sid) => instance.get(sid)) as AuthorizationDocumentListInstanceImpl;
  ...
  instance.create = function create(params: any, callback?: any): Promise<AuthorizationDocumentInstance> {
