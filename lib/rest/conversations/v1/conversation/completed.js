 ...
 * @param {V1} version - Version that contains the resource
 *
 * @returns {function} - CompletedListInstance
 */
function CompletedList(version) {
  /**
   * @memberof CompletedList
   *
   ...
   * @memberof CompletedList
   *
   * @description Streams CompletedInstance records from the API.
   *
   ...
   * @memberof CompletedList
   *
   * @description Retrieve a single page of CompletedInstance records from the API.
