 ...
 *
 * @property { ConversationParticipantEnumWebhookEnabledType } [xTwilioWebhookEnabled] The X-Twilio-Webhook-Enabled HTTP request header
...
export interface ParticipantListInstanceCreateOptions {
  xTwilioWebhookEnabled?: ConversationParticipantEnumWebhookEnabledType;
  identity?: string;
...
export class ParticipantInstance {
  ...
  constructor(protected _version: V1, payload: ParticipantPayload, conversationSid: string, sid?: string) {
