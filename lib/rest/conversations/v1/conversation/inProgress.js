 ...
 * @param {V1} version - Version that contains the resource
 *
 * @returns {function} - InProgressListInstance
 */
function InProgressList(version) {
  ...
  /**
   * @memberof InProgressList
   *
   * @description Streams InProgressInstance records from the API.
   *
   ...
   * @memberof InProgressList
   *
   * @description Retrieve a single page of InProgressInstance records from the API.
