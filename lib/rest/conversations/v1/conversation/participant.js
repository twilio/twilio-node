...
function ParticipantList(version, conversationSid) {
   ...
   */
  ParticipantListInstance.read = function stream() {
   ...
   */
  ParticipantListInstance.read = function list() {
    return this.page();
  };
   ...
   */
  ParticipantListInstance.read = function page(page_token=values.unset,
