 ...
 *
 * @property { ServiceConversationScopedWebhookEnumTarget } target 
 * @property { string } [configurationUrl] The absolute url the webhook request should be sent to.
 * @property { ServiceConversationScopedWebhookEnumMethod } [configurationMethod] 
...
export interface WebhookListInstanceCreateOptions {
  ...
  configurationMethod?: ServiceConversationScopedWebhookEnumMethod;
...
export function WebhookListInstance(version: V1, chatServiceSid: string, conversationSid: string): WebhookListInstance {
  ...
  instance.create = function create(params: any, callback?: any): Promise<WebhookInstance> {
    ...
    operationPromise = operationPromise.then(payload => new WebhookInstance(operationVersion, payload, this._solution.chatServiceSid, this._solution.conversationSid));
...
export class WebhookContextImpl implements WebhookContext {
  ...
  fetch(callback?: any): Promise<WebhookInstance> {
    ...
    operationPromise = operationPromise.then(payload => new WebhookInstance(operationVersion, payload, this._solution.chatServiceSid, this._solution.conversationSid, this._solution.sid));
...
export class WebhookInstance {
  ...
  constructor(protected _version: V1, payload: WebhookPayload, chatServiceSid: string, conversationSid: string, sid?: string) {
