 ...
 *
 * @property { ServiceConversationMessageEnumWebhookEnabledType } [xTwilioWebhookEnabled] The X-Twilio-Webhook-Enabled HTTP request header
...
export interface MessageListInstanceCreateOptions {
  xTwilioWebhookEnabled?: ServiceConversationMessageEnumWebhookEnabledType;
  author?: string;
  body?: string;
  dateCreated?: Date;
  dateUpdated?: Date;
 ...
 *
 * @property { ServiceConversationMessageEnumOrderType } [order] The sort order of the returned messages. Can be: &#x60;asc&#x60; (ascending) or &#x60;desc&#x60; (descending), with &#x60;asc&#x60; as the default.
...
export interface MessageContext {
  ...
  delivery_receipt: DeliveryReceiptListInstance;
...
export class MessageContextImpl implements MessageContext {
  ...
  protected _delivery_receipt?: DeliveryReceiptListInstance;
  ...
  get delivery_receipt(): DeliveryReceiptListInstance {
    this._delivery_receipt = this._delivery_receipt || DeliveryReceiptListInstance(this._version, this._solution.chatServiceSid, this._solution.conversationSid, this._solution.sid);
    return this._delivery_receipt;
  }
...
export class MessageInstance {
  ...
  constructor(protected _version: V1, payload: MessagePayload, chatServiceSid: string, conversationSid: string, sid?: string) {
  ...
  /**
   * Access the delivery_receipt.
   */
  delivery_receipt(): DeliveryReceiptListInstance {
    return this._proxy.delivery_receipt;
  }
