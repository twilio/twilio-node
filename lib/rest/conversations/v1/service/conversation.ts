 ...
 *
 * @property { ServiceConversationEnumWebhookEnabledType } [xTwilioWebhookEnabled] The X-Twilio-Webhook-Enabled HTTP request header
 */
export interface ConversationContextRemoveOptions {
  xTwilioWebhookEnabled?: ServiceConversationEnumWebhookEnabledType;
}
 ...
 * @property { ServiceConversationEnumState } [state] 
...
export interface ConversationContext {
   ...
   */
  remove(callback?: (error: Error | null, item?: ConversationInstance) => any): Promise<boolean>;
  /**
   * Remove a ConversationInstance
   *
