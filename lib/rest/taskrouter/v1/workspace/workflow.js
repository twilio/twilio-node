...
function WorkflowList(version, workspaceSid) {
  ...
  WorkflowListInstance.create = function create(friendlyName, configuration,
    ...
    var data = values.of({
      ...
      'FallbackAssignmentCallbackUrl': opts.fallbackAssignmentCallbackUrl || values.unset,
      'TaskReservationTimeout': opts.taskReservationTimeout || values.unset
    });
...
WorkflowContext.prototype.update = function update(opts) {
  ...
  var data = values.of({
    'FriendlyName': opts.friendlyName || values.unset,
    'AssignmentCallbackUrl': opts.assignmentCallbackUrl || values.unset,
    'FallbackAssignmentCallbackUrl': opts.fallbackAssignmentCallbackUrl || values.unset,
    'Configuration': opts.configuration || values.unset,
    'TaskReservationTimeout': opts.taskReservationTimeout || values.unset,
  });
