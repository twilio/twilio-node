...
function WorkflowList(version, workspaceSid) {
   ...
   */
  WorkflowListInstance.each = function each(opts) {
    opts = opts || {};
   ...
   */
  WorkflowListInstance.create = function create(opts) {
    if (_.isUndefined(opts)) {
      throw new Error('Required parameters are missing. Please provide: friendlyName, configuration, assignmentCallbackUrl.');  // jshint ignore:line
    }
