 ...
 * @param {string} workspaceSid - The workspace_sid
 *
 * @returns {function} - WorkflowListInstance
 */
function WorkflowList(version, workspaceSid) {
   ...
   * @memberof WorkflowList
   *
   * @description Streams WorkflowInstance records from the API.
   *
   ...
   * @memberof WorkflowList
   *
   * @description Retrieve a single page of WorkflowInstance records from the API.
   ...
   * @memberof WorkflowList
   *
   * @description Create a new WorkflowInstance
   *
   * If a function is passed as the first argument, it will be used as the callback function.
   *
   * @param {object} opts - ...
   ...
   * @memberof WorkflowList
   *
   * @description Constructs a WorkflowContext
   *
...
/**
 * @description Fetch a WorkflowInstance
 *
...
/**
 * @description Update the WorkflowInstance
 *
 * If a function is passed as the first argument, it will be used as the callback function.
 *
 * @param {object|function} opts - ...
...
/**
 * @description Deletes the WorkflowInstance
 *
 ...
 * @description Initialize the WorkflowContext
 *
 * @property {WorkflowStatisticsList} statistics - statistics resource
 *
 * @param {V1} version - Version that contains the resource
 * @param {sid} workspaceSid - The workspace_sid
 * @param {sid} sid - The sid
