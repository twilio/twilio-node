...
function WorkflowList(version, workspaceSid) {
   ...
   */
  WorkflowListInstance.read = function stream(opts) {
   ...
   */
  WorkflowListInstance.read = function list(opts) {
    return this.page();
  };
   ...
   */
  WorkflowListInstance.read = function page(opts, page_token=values.unset,
