...
function WorkflowList(version, workspaceSid) {
  ...
  WorkflowListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      ...
      'AssignmentCallbackUrl': _.get(opts, "assignmentCallbackUrl", undefined),
      'FallbackAssignmentCallbackUrl': _.get(opts, "fallbackAssignmentCallbackUrl", undefined),
      'TaskReservationTimeout': _.get(opts, "taskReservationTimeout", undefined)
    });
 ...
 */
/* jshint ignore:end */
function WorkflowPage(version, response, solution) {
  // Path Solution
