 ...
 * @param {string} workspaceSid - The workspace_sid
 *
 * @returns {function} - TaskQueuesStatisticsListInstance
 */
function TaskQueuesStatisticsList(version, workspaceSid) {
  ...
  /**
   * @memberof TaskQueuesStatisticsList
   *
   * @description Streams TaskQueuesStatisticsInstance records from the API.
   *
   ...
   * @memberof TaskQueuesStatisticsList
   *
   * @description Retrieve a single page of TaskQueuesStatisticsInstance records from the API.
