...
function TaskList(version, workspaceSid) {
  ...
  TaskListInstance.page = function page(opts, callback) {
    ...
    var deferred = Q.defer();
    var data = values.of({
      'Priority': _.get(opts, "priority", undefined),
      'AssignmentStatus': _.get(opts, "assignmentStatus", undefined),
      'WorkflowSid': _.get(opts, "workflowSid", undefined),
      'WorkflowName': _.get(opts, "workflowName", undefined),
      'TaskQueueSid': _.get(opts, "taskQueueSid", undefined),
      'TaskQueueName': _.get(opts, "taskQueueName", undefined),
      'EvaluateTaskAttributes': _.get(opts, "evaluateTaskAttributes", undefined),
      'Ordering': _.get(opts, "ordering", undefined),
      'HasAddons': _.get(opts, "hasAddons", undefined),
  ...
  TaskListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      ...
      'Priority': _.get(opts, "priority", undefined),
      'TaskChannel': _.get(opts, "taskChannel", undefined),
      'WorkflowSid': _.get(opts, "workflowSid", undefined),
      'Attributes': _.get(opts, "attributes", undefined)
    });
 ...
 */
/* jshint ignore:end */
function TaskPage(version, response, solution) {
  // Path Solution
...
TaskContext.prototype.update = function update(opts, callback) {
  ...
  var data = values.of({
    'Attributes': _.get(opts, "attributes", undefined),
    'AssignmentStatus': _.get(opts, "assignmentStatus", undefined),
    'Reason': _.get(opts, "reason", undefined),
    'Priority': _.get(opts, "priority", undefined),
    'TaskChannel': _.get(opts, "taskChannel", undefined)
  });
