...
function TaskList(version, workspaceSid) {
  ...
  TaskListInstance.page = function page(opts) {
    var params = values.of({
      ...
      'AssignmentStatus': opts.assignmentStatus || values.unset,
      'WorkflowSid': opts.workflowSid || values.unset,
      'WorkflowName': opts.workflowName || values.unset,
...
TaskContext.prototype.update = function update(opts) {
  ...
  opts = opts || {};
  var data = values.of({
    'Attributes': opts.attributes || values.unset,
    'AssignmentStatus': opts.assignmentStatus || values.unset,
    'Reason': opts.reason || values.unset,
    'Priority': opts.priority || values.unset,
  });
