 ...
 */
/* jshint ignore:end */
function WorkerChannelList(version, workspaceSid, workerSid) {
  /* jshint ignore:start */
  /**
  ...
  WorkerChannelListInstance.page = function page(opts, callback) {
    ...
    promise = promise.then(function(payload) {
      deferred.resolve(new WorkerChannelPage(
        this._version,
        payload,
        this._solution
      ));
 ...
 */
/* jshint ignore:end */
function WorkerChannelPage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function WorkerChannelInstance(version, payload, workspaceSid, workerSid, sid) {
 ...
 */
/* jshint ignore:end */
function WorkerChannelContext(version, workspaceSid, workerSid, sid) {
  this._version = version;
...
WorkerChannelContext.prototype.update = function update(opts, callback) {
  ...
  var deferred = Q.defer();
  var data = values.of({
    'Capacity': _.get(opts, "capacity", undefined),
    'Available': _.get(opts, "available", undefined)
  });
