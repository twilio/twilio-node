 ...
 */
/* jshint ignore:end */
function ReservationList(version, workspaceSid, workerSid) {
  /* jshint ignore:start */
  /**
  ...
  ReservationListInstance.page = function page(opts, callback) {
    ...
    var deferred = Q.defer();
    var data = values.of({
      'ReservationStatus': _.get(opts, "reservationStatus", undefined),
 ...
 */
/* jshint ignore:end */
function ReservationPage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function ReservationInstance(version, payload, workspaceSid, workerSid, sid) {
 ...
 */
/* jshint ignore:end */
function ReservationContext(version, workspaceSid, workerSid, sid) {
  this._version = version;
...
ReservationContext.prototype.update = function update(opts, callback) {
  ...
  var data = values.of({
    'ReservationStatus': _.get(opts, "reservationStatus", undefined),
    'WorkerActivitySid': _.get(opts, "workerActivitySid", undefined),
    'Instruction': _.get(opts, "instruction", undefined),
    'DequeuePostWorkActivitySid': _.get(opts, "dequeuePostWorkActivitySid", undefined),
    'DequeueFrom': _.get(opts, "dequeueFrom", undefined),
    'DequeueRecord': _.get(opts, "dequeueRecord", undefined),
    'DequeueTimeout': _.get(opts, "dequeueTimeout", undefined),
    'DequeueTo': _.get(opts, "dequeueTo", undefined),
    'DequeueStatusCallbackUrl': _.get(opts, "dequeueStatusCallbackUrl", undefined),
    'CallFrom': _.get(opts, "callFrom", undefined),
    'CallRecord': _.get(opts, "callRecord", undefined),
    'CallTimeout': _.get(opts, "callTimeout", undefined),
    'CallTo': _.get(opts, "callTo", undefined),
    'CallUrl': _.get(opts, "callUrl", undefined),
    'CallStatusCallbackUrl': _.get(opts, "callStatusCallbackUrl", undefined),
    'CallAccept': _.get(opts, "callAccept", undefined),
    'RedirectCallSid': _.get(opts, "redirectCallSid", undefined),
    'RedirectAccept': _.get(opts, "redirectAccept", undefined),
    'RedirectUrl': _.get(opts, "redirectUrl", undefined)
  });
