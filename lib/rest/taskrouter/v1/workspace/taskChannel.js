 ...
 * @property {Date} dateCreated - The date this TaskChannel was created.
 * @property {Date} dateUpdated - The date this TaskChannel was updated.
 * @property {string} friendlyName - The friendly name of this TaskChannel
 * @property {string} sid - The unique ID for this TaskChannel.
 ...
 *          The unique ID of the Workspace that this TaskChannel belongs to.
 * @param {sid_like} sid - The unique ID for this TaskChannel.
 */
/* jshint ignore:end */
