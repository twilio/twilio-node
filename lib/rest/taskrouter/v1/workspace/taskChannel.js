 ...
 */
/* jshint ignore:end */
function TaskChannelPage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function TaskChannelList(version, workspaceSid) {
  /* jshint ignore:start */
  /**
 ...
 */
/* jshint ignore:end */
function TaskChannelInstance(version, payload, workspaceSid, sid) {
 ...
 */
/* jshint ignore:end */
function TaskChannelContext(version, workspaceSid, sid) {
  this._version = version;
