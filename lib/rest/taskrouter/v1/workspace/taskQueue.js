...
function TaskQueueList(version, workspaceSid) {
  ...
  TaskQueueListInstance.page = function page(opts) {
    var params = values.of({
      ...
      'EvaluateWorkerAttributes': opts.evaluateWorkerAttributes || values.unset,
  ...
  TaskQueueListInstance.create = function create(friendlyName,
    ...
    var data = values.of({
      ...
      'TargetWorkers': opts.targetWorkers || values.unset,
      'MaxReservedWorkers': opts.maxReservedWorkers || values.unset
    });
...
TaskQueueContext.prototype.update = function update(opts) {
  ...
  var data = values.of({
    'FriendlyName': opts.friendlyName || values.unset,
    'TargetWorkers': opts.targetWorkers || values.unset,
    'ReservationActivitySid': opts.reservationActivitySid || values.unset,
    'AssignmentActivitySid': opts.assignmentActivitySid || values.unset,
    'MaxReservedWorkers': opts.maxReservedWorkers || values.unset,
  });
