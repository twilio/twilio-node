...
function TaskQueueList(version, workspaceSid) {
  ...
  TaskQueueListInstance.page = function page(opts, callback) {
    ...
    var data = values.of({
      ...
      'EvaluateWorkerAttributes': _.get(opts, "evaluateWorkerAttributes", undefined),
  ...
  TaskQueueListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      'FriendlyName': _.get(opts, "friendlyName", undefined),
      'ReservationActivitySid': _.get(opts, "reservationActivitySid", undefined),
      'AssignmentActivitySid': _.get(opts, "assignmentActivitySid", undefined),
      'TargetWorkers': _.get(opts, "targetWorkers", undefined),
      'MaxReservedWorkers': _.get(opts, "maxReservedWorkers", undefined),
      'TaskOrder': _.get(opts, "taskOrder", undefined)
    });
 ...
 */
/* jshint ignore:end */
function TaskQueuePage(version, response, solution) {
  // Path Solution
