 ...
 * @param {string} [opts.dequeueRecord] - No
 * @param {number} [opts.dequeueTimeout] - No
 * @param {string} [opts.dequeueTo] - No
 * @param {string} [opts.dequeueStatusCallbackUrl] - No
 * @param {string} [opts.callFrom] - Yes
 * @param {string} [opts.callRecord] - No
 * @param {number} [opts.callTimeout] - No
 * @param {string} [opts.callTo] - No
 * @param {string} [opts.callUrl] - Yes
 * @param {string} [opts.callStatusCallbackUrl] - No
 * @param {boolean} [opts.callAccept] - No
 * @param {string} [opts.redirectCallSid] - Yes
 * @param {boolean} [opts.redirectAccept] - No
 * @param {string} [opts.redirectUrl] - Yes
 * @param {string} [opts.to] - No
 * @param {string} [opts.from] - No
 ...
 * @param {string|list} [opts.dequeueStatusCallbackEvent] - No
 * @param {string} [opts.postWorkActivitySid] - No
 * @param {function} [callback] - Callback to handle processed record
 *
 * @returns {Promise} Resolves to processed ReservationInstance
 */
