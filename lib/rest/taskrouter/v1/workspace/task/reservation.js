...
function ReservationList(version, workspaceSid, taskSid) {
   ...
   */
  ReservationListInstance.each = function each(opts) {
    opts = opts || {};
 ...
 */
ReservationInstance.prototype.update = function update(opts) {
 ...
 * @returns Updated ReservationInstance
 */
ReservationContext.prototype.update = function update(opts) {
  if (_.isUndefined(opts)) {
    throw new Error('Required parameters are missing. Please provide: reservationStatus.');  // jshint ignore:line
  }
