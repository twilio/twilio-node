...
function ReservationList(version, workspaceSid, taskSid) {
  function ReservationListInstance() {
  }
   ...
   */
  ReservationListInstance.read = function stream() {
   ...
   */
  ReservationListInstance.read = function list() {
    return this.page();
  };
   ...
   */
  ReservationListInstance.read = function page(page_token=values.unset,
