 ...
 * @param {string} taskSid - The task_sid
 *
 * @returns {function} - ReservationListInstance
 */
function ReservationList(version, workspaceSid, taskSid) {
   ...
   *
   * @description Streams ReservationInstance records from the API.
   *
   ...
   * @memberof ReservationList
   *
   * @description Retrieve a single page of ReservationInstance records from the API.
   ...
   * @memberof Twilio.Taskrouter.V1.WorkspaceContext.TaskContext.ReservationList
   *
   * @description Constructs a ReservationContext
   *
...
/**
 * @description Fetch a ReservationInstance
 *
...
/**
 * @description Update the ReservationInstance
 *
 * If a function is passed as the first argument, it will be used as the callback function.
 *
 * @param {object} opts - ...
