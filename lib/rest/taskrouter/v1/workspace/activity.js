 ...
 * @param {string} workspaceSid - The workspace_sid
 *
 * @returns {function} - ActivityListInstance
 */
function ActivityList(version, workspaceSid) {
   ...
   *
   * @description Streams ActivityInstance records from the API.
   *
   ...
   * @memberof ActivityList
   *
   * @description Retrieve a single page of ActivityInstance records from the API.
   ...
   * @memberof ActivityList
   *
   * @description Create a new ActivityInstance
   *
   * If a function is passed as the first argument, it will be used as the callback function.
   *
   * @param {object} opts - ...
   ...
   * @memberof Twilio.Taskrouter.V1.WorkspaceContext.ActivityList
   *
   * @description Constructs a ActivityContext
   *
...
/**
 * @description Fetch a ActivityInstance
 *
...
/**
 * @description Update the ActivityInstance
 *
 * If a function is passed as the first argument, it will be used as the callback function.
 *
 * @param {object} opts - ...
...
/**
 * @description Deletes the ActivityInstance
 *
