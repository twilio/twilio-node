...
function ActivityList(version, workspaceSid) {
   ...
   */
  ActivityListInstance.create = function create(opts) {
    if (_.isUndefined(opts)) {
      throw new Error('Required parameters are missing. Please provide: friendlyName, available.');  // jshint ignore:line
    }
 ...
 */
ActivityInstance.prototype.update = function update(opts) {
 ...
 * @returns Updated ActivityInstance
 */
ActivityContext.prototype.update = function update(opts) {
  if (_.isUndefined(opts)) {
    throw new Error('Required parameters are missing. Please provide: friendlyName.');  // jshint ignore:line
  }
  if (_.isUndefined(opts.friendlyName)) {
    throw new Error('Required parameter "friendlyName" missing.');
  }
