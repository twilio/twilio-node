 ...
 *
 * @function workersRealTimeStatistics
 * @memberof Twilio.Taskrouter.V1.WorkspaceContext.WorkerInstance
 * @instance
 *
 ...
 */
/* jshint ignore:end */
WorkerInstance.prototype.workersRealTimeStatistics = function
    workersRealTimeStatistics() {
  return this._proxy.workersRealTimeStatistics;
};
 ...
 *
 * @function workersCumulativeStatistics
 * @memberof Twilio.Taskrouter.V1.WorkspaceContext.WorkerInstance
 * @instance
 *
 ...
 */
/* jshint ignore:end */
WorkerInstance.prototype.workersCumulativeStatistics = function
    workersCumulativeStatistics() {
  return this._proxy.workersCumulativeStatistics;
};
 ...
 * @description Initialize the WorkerContext
 *
 * @property {Twilio.Taskrouter.V1.WorkspaceContext.WorkerContext.WorkersRealTimeStatisticsList} workersRealTimeStatistics -
 *          workersRealTimeStatistics resource
 * @property {Twilio.Taskrouter.V1.WorkspaceContext.WorkerContext.WorkersCumulativeStatisticsList} workersCumulativeStatistics -
 *          workersCumulativeStatistics resource
...
WorkerContext = function WorkerContext(version, workspaceSid, sid) {
  ...
  // Dependents
  this._workersRealTimeStatistics = undefined;
  this._workersCumulativeStatistics = undefined;
