 ...
 */
/* jshint ignore:end */
function WorkerPage(version, response, solution) {
  // Path Solution
...
function WorkerList(version, workspaceSid) {
  ...
  WorkerListInstance.page = function page(opts, callback) {
    ...
    var deferred = Q.defer();
    var data = values.of({
      'ActivityName': _.get(opts, "activityName", undefined),
      'ActivitySid': _.get(opts, "activitySid", undefined),
      'Available': _.get(opts, "available", undefined),
      'FriendlyName': _.get(opts, "friendlyName", undefined),
      'TargetWorkersExpression': _.get(opts, "targetWorkersExpression", undefined),
