...
function EventList(version, workspaceSid) {
  ...
  EventListInstance.page = function page(opts, callback) {
    ...
    var deferred = Q.defer();
    var data = values.of({
      'EndDate': serialize.iso8601DateTime(_.get(opts, "endDate", undefined)),
      'EventType': _.get(opts, "eventType", undefined),
      'Minutes': _.get(opts, "minutes", undefined),
      'ReservationSid': _.get(opts, "reservationSid", undefined),
      'StartDate': serialize.iso8601DateTime(_.get(opts, "startDate", undefined)),
      'TaskQueueSid': _.get(opts, "taskQueueSid", undefined),
      'TaskSid': _.get(opts, "taskSid", undefined),
      'WorkerSid': _.get(opts, "workerSid", undefined),
 ...
 */
/* jshint ignore:end */
function EventPage(version, response, solution) {
  // Path Solution
