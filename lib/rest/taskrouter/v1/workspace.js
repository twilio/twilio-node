...
function WorkspaceList(version) {
  function WorkspaceListInstance() {
  }
   ...
   */
  WorkspaceListInstance.read = function stream(opts) {
   ...
   */
  WorkspaceListInstance.read = function list(opts) {
    return this.page();
  };
   ...
   */
  WorkspaceListInstance.read = function page(opts, page_token=values.unset,
