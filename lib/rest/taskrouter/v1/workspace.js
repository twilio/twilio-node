...
function WorkspaceList(version) {
  ...
  WorkspaceListInstance.create = function create(friendlyName, opts) {
    ...
    var data = values.of({
      ...
      'EventCallbackUrl': opts.eventCallbackUrl || values.unset,
      'Template': opts.template || values.unset
    });
...
WorkspaceContext.prototype.update = function update(opts) {
  var data = values.of({
    'DefaultActivitySid': opts.defaultActivitySid || values.unset,
    'EventCallbackUrl': opts.eventCallbackUrl || values.unset,
    'FriendlyName': opts.friendlyName || values.unset,
    'TimeoutActivitySid': opts.timeoutActivitySid || values.unset,
  });
