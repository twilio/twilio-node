...
function WorkspaceList(version) {
   ...
   * @param {string} [opts.multiTaskEnabled] - The multi_task_enabled
  ...
  WorkspaceListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      'FriendlyName': _.get(opts, "friendlyName", undefined),
      'EventCallbackUrl': _.get(opts, "eventCallbackUrl", undefined),
      'EventsFilter': _.get(opts, "eventsFilter", undefined),
      'MultiTaskEnabled': _.get(opts, "multiTaskEnabled", undefined),
      'Template': _.get(opts, "template", undefined),
      'PrioritizeQueueOrder': _.get(opts, "prioritizeQueueOrder", undefined)
    });
 ...
 */
/* jshint ignore:end */
function WorkspacePage(version, response, solution) {
  // Path Solution
 ...
 * @property {string} multiTaskEnabled - The multi_task_enabled
...
WorkspaceContext.prototype.update = function update(opts, callback) {
  ...
  var deferred = Q.defer();
  var data = values.of({
    'DefaultActivitySid': _.get(opts, "defaultActivitySid", undefined),
    'EventCallbackUrl': _.get(opts, "eventCallbackUrl", undefined),
    'EventsFilter': _.get(opts, "eventsFilter", undefined),
    'FriendlyName': _.get(opts, "friendlyName", undefined),
    'MultiTaskEnabled': _.get(opts, "multiTaskEnabled", undefined),
    'TimeoutActivitySid': _.get(opts, "timeoutActivitySid", undefined),
    'PrioritizeQueueOrder': _.get(opts, "prioritizeQueueOrder", undefined)
  });
