 ...
 * @param {boolean} [opts.lazyLoading] - Enable lazy loading or not, loading time will decrease in enabled
 *
...
function Twilio(username, password, opts) {
  ...
  if (!opts.lazyLoading) {
    this._accounts = this.accounts;
    this._api = this.api;
    this._authy = this.authy;
    this._autopilot = this.autopilot;
    this._chat = this.chat;
    this._conversations = this.conversations;
    this._fax = this.fax;
    this._flexApi = this.flexApi;
    this._insights = this.insights;
    this._ipMessaging = this.ipMessaging;
    this._lookups = this.lookups;
    this._messaging = this.messaging;
    this._monitor = this.monitor;
    this._notify = this.notify;
    this._numbers = this.numbers;
    this._preview = this.preview;
    this._pricing = this.pricing;
    this._proxy = this.proxy;
    this._serverless = this.serverless;
    this._studio = this.studio;
    this._sync = this.sync;
    this._taskrouter = this.taskrouter;
    this._trunking = this.trunking;
    this._verify = this.verify;
    this._video = this.video;
    this._voice = this.voice;
    this._wireless = this.wireless;
  }
}
