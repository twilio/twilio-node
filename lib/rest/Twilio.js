 ...
 * @constructor
 *
 * @property {Api} api - api domain
 * @property {Conversations} conversations - conversations domain
 * @property {Lookups} lookups - lookups domain
 * @property {Monitor} monitor - monitor domain
 * @property {Pricing} pricing - pricing domain
 * @property {Taskrouter} taskrouter - taskrouter domain
 * @property {Trunking} trunking - trunking domain
 * @property {AddressList} addresses - addresses resource
 * @property {ApplicationList} applications - applications resource
 ...
 * @property {CallList} calls - calls resource
 * @property {ConferenceList} conferences - conferences resource
 * @property {ConnectAppList} connectApps - connectApps resource
 * @property {IncomingPhoneNumberList} incomingPhoneNumbers -
 *          incomingPhoneNumbers resource
 * @property {MessageList} messages - messages resource
 * @property {NotificationList} notifications - notifications resource
 * @property {OutgoingCallerIdList} outgoingCallerIds - outgoingCallerIds resource
 * @property {QueueList} queues - queues resource
 * @property {RecordingList} recordings - recordings resource
 * @property {SandboxList} sandbox - sandbox resource
 * @property {SipList} sip - sip resource
 * @property {SmsList} sms - sms resource
 * @property {TokenList} tokens - tokens resource
 * @property {TranscriptionList} transcriptions - transcriptions resource
 * @property {UsageList} usage - usage resource
