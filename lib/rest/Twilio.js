...
Twilio.prototype.request = function request(opts) {
  ...
  // https://product.edge.region.subdomain.domain
  if (parsedHostname.length === 5) {
  ...
  // https://product.region.subdomain.domain
  if (parsedHostname.length === 4) {
  ...
  // https://product.subdomain.domain
  if (parsedHostname.length === 3) {
