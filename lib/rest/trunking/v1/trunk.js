...
function TrunkList(version) {
  ...
  TrunkListInstance.create = function create(opts) {
    ...
    var data = values.of({
      ...
      'DomainName': opts.domainName || values.unset,
      'DisasterRecoveryUrl': opts.disasterRecoveryUrl || values.unset,
      'DisasterRecoveryMethod': opts.disasterRecoveryMethod || values.unset,
      'Recording': opts.recording || values.unset,
      'Secure': opts.secure || values.unset
    });
