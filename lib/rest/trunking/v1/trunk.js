...
function TrunkList(version) {
   ...
   */
  TrunkListInstance.read = function stream() {
   ...
   */
  TrunkListInstance.read = function list() {
    return this.page();
  };
   ...
   */
  TrunkListInstance.read = function page(page_token=values.unset,
