...
function TrunkList(version) {
  ...
  TrunkListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      ...
      'DisasterRecoveryUrl': _.get(opts, "disasterRecoveryUrl", undefined),
      'DisasterRecoveryMethod': _.get(opts, "disasterRecoveryMethod", undefined),
      'Recording': _.get(opts, "recording", undefined),
      'Secure': _.get(opts, "secure", undefined)
    });
 ...
 */
/* jshint ignore:end */
function TrunkPage(version, response, solution) {
  // Path Solution
