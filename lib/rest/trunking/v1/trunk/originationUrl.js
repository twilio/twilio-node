...
function OriginationUrlList(version, trunkSid) {
   ...
   */
  OriginationUrlListInstance.create = function create(opts) {
    if (_.isUndefined(opts)) {
      throw new Error('Required parameters are missing. Please provide: weight, priority, enabled, friendlyName, sipUrl.');  // jshint ignore:line
    }
   ...
   */
  OriginationUrlListInstance.each = function each(opts) {
    opts = opts || {};
