...
function PhoneNumberList(version, trunkSid) {
   ...
   */
  PhoneNumberListInstance.read = function stream() {
   ...
   */
  PhoneNumberListInstance.read = function list() {
    return this.page();
  };
   ...
   */
  PhoneNumberListInstance.read = function page(page_token=values.unset,
