...
function PhoneNumberList(version, trunkSid) {
   ...
   */
  PhoneNumberListInstance.create = function create(opts) {
    if (_.isUndefined(opts)) {
      throw new Error('Required parameters are missing. Please provide: phoneNumberSid.');  // jshint ignore:line
    }
   ...
   */
  PhoneNumberListInstance.each = function each(opts) {
    opts = opts || {};
