...
TerminatingSipDomainList = function TerminatingSipDomainList(version, trunkSid)
  ...
  TerminatingSipDomainListInstance._uri = _.template(
    '/Trunks/<%= trunkSid %>/TerminatingSipDomains' // jshint ignore:line
  )(TerminatingSipDomainListInstance._solution);
  /* jshint ignore:start */
  /**
   ...
   * @param {string} opts.sipDomainSid - The SID of the SIP Domain to associate.
 ...
 * @property {string} trunkSid - Unique string to identify an associated trunk
 * @property {string} links - The links
 *
 * @param {V1} version - Version of the resource
 * @param {TerminatingSipDomainPayload} payload - The instance payload
 * @param {sid} trunkSid - Unique string to identify an associated trunk
 * @param {sid} sid - The unique sid of the domain.
 */
/* jshint ignore:end */
 ...
 *
 * @param {V1} version - Version of the resource
 * @param {sid} trunkSid - The unique sid of the trunk.
 * @param {sid} sid - The unique sid of the domain.
 */
/* jshint ignore:end */
TerminatingSipDomainContext = function TerminatingSipDomainContext(version,
  ...
  this._uri = _.template(
    '/Trunks/<%= trunkSid %>/TerminatingSipDomains/<%= sid %>' // jshint ignore:line
  )(this._solution);
};
