 ...
 */
/* jshint ignore:end */
function RolePage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function RoleList(version, serviceSid) {
  /* jshint ignore:start */
  /**
   * @function roles
  ...
  RoleListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      ...
      'Permission': _.get(opts, "permission", undefined)
    });
 ...
 */
/* jshint ignore:end */
function RoleInstance(version, payload, serviceSid, sid) {
 ...
 */
/* jshint ignore:end */
function RoleContext(version, serviceSid, sid) {
  this._version = version;
