 ...
 */
/* jshint ignore:end */
function UserChannelList(version, serviceSid, userSid) {
  /* jshint ignore:start */
  /**
 ...
 */
/* jshint ignore:end */
function UserChannelPage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function UserChannelInstance(version, payload, serviceSid, userSid) {
