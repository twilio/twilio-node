...
export class CredentialInstance {
  ...
  constructor(protected _version: V2, payload: CredentialPayload, sid?: string) {
...
export class CredentialPage extends Page<V2, CredentialPayload, CredentialResource, CredentialInstance> {
  /**
