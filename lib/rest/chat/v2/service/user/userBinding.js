 ...
 * @property {string} userSid - The SID of the User for the binding
 ...
 *          The SID of the Service that the resource is associated with
 * @param {sid} userSid - The SID of the User for the binding
 ...
 * @param {sid_like} userSid - The SID of the User for the binding
 * @param {sid} sid - The unique string that identifies the resource
 */
/* jshint ignore:end */
