 ...
 * @property {string} pluginServiceAttributes - Plugin service Attributes
 * @property {string} integrations - Integration parameters
 * @property {string} outboundCallFlows - Outbound call flows Attributes
