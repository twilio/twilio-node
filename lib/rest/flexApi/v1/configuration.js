 ...
 * @property {object} attributes - Attiributes
 ...
 * @property {object} taskrouterTaskqueues - Array of TaskRouter TaskQueues
 * @property {object} taskrouterSkills - Skill description for TaskRouter workers
 * @property {object} taskrouterWorkerChannels -
 *          TaskRouter default channel capacities and availability for workers
 * @property {object} taskrouterWorkerAttributes - The taskrouter_worker_attributes
 ...
 * @property {object} uiAttributes - UI Attributes
 ...
 * @property {object} crmAttributes - CRM Attributes
 * @property {object} publicAttributes - Public Attributes
 * @property {boolean} pluginServiceEnabled - Is plugin service Enabled
 * @property {object} pluginServiceAttributes - Plugin service Attributes
 * @property {object} integrations - Integration parameters
 * @property {object} outboundCallFlows - Outbound call flows Attributes
 * @property {string} featuresEnabled - List of enabled features
 * @property {string} serverlessServiceSids - List of serverless services sids
