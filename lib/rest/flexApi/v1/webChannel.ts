...
export interface WebChannelContext {
   ...
   */
  remove(callback?: (error: Error | null, item?: WebChannelInstance) => any): Promise<boolean>
...
export function WebChannelListInstance(version: V1): WebChannelListInstance {
  ...
  instance.create = function create(params: any, callback?: any): Promise<WebChannelInstance> {
