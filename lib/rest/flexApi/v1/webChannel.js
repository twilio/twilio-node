...
WebChannelList = function WebChannelList(version) {
   ...
   * @param {string} opts.identity - Chat identity
   * @param {string} opts.customerFriendlyName - Customer friendly name
 ...
 *
 * @param {object} [opts] - Options for request
 * @param {web_channel.chat_status} [opts.chatStatus] - Chat status
 * @param {string} [opts.postEngagementData] - Post-engagement data
 * @param {function} [callback] - Callback to handle processed record
 *
 * @returns {Promise} Resolves to processed WebChannelInstance
 */
