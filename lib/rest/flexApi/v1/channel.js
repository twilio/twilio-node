...
ChannelList = function ChannelList(version) {
   ...
   *
   * @param {object} opts - Options for request
   * @param {string} opts.flexFlowSid - The unique ID of the FlexFlow
   * @param {string} opts.identity - Chat User identity
   * @param {string} opts.chatUserFriendlyName - Customer friendly name
   * @param {string} opts.chatFriendlyName - Chat channel friendly name
   * @param {string} [opts.target] - Target Contact Identity
   * @param {string} [opts.chatUniqueName] - Chat channel unique name
   * @param {string} [opts.preEngagementData] - Pre-engagement data
   * @param {string} [opts.taskSid] - TaskRouter Task Sid.
   * @param {string} [opts.taskAttributes] -
   *          Task attributes to be added for the TaskRouter Task
   * @param {boolean} [opts.longLived] - Long Lived flag
 ...
 * @property {string} flexFlowSid - The unique ID of the FlexFlow
 * @property {string} sid - Flex Chat Channel Sid
 * @property {string} userSid - Chat User Sid.
 * @property {string} taskSid - TaskRouter Task Sid.
 ...
 * @param {sid} sid - Flex Chat Channel Sid
 */
/* jshint ignore:end */
