...
ServiceList = function ServiceList(version) {
   ...
   *
   * @param {object} opts - Options for request
   * @param {string} opts.uniqueName - A unique, addressable name of this Service.
 ...
 *
 * @property {string} sid - Service Sid.
 * @property {string} accountSid - Account Sid.
 * @property {string} friendlyName - A human-readable description of this Service.
 * @property {string} uniqueName - A unique, URL-friendly name of this Service.
 * @property {boolean} includeCredentials -
 *          Whether to inject Account credentials into a Function invocation context.
 * @property {Date} dateCreated - The date that this Service was created.
 * @property {Date} dateUpdated - The date that this Service was updated.
 * @property {string} url - The URL of this Service.
 * @property {string} links - Nested resource URLs.
 *
 * @param {V1} version - Version of the resource
 * @param {ServicePayload} payload - The instance payload
 * @param {sid_like} sid - Serverless Service Sid or unique name.
 */
/* jshint ignore:end */
