...
BuildList = function BuildList(version, serviceSid) {
  ...
  BuildListInstance._uri = _.template(
    '/Services/<%= serviceSid %>/Builds' // jshint ignore:line
  )(BuildListInstance._solution);
  /* jshint ignore:start */
  /**
...
BuildContext = function BuildContext(version, serviceSid, sid) {
  ...
  this._uri = _.template(
    '/Services/<%= serviceSid %>/Builds/<%= sid %>' // jshint ignore:line
  )(this._solution);
};
