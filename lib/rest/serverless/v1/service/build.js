...
BuildList = function BuildList(version, serviceSid) {
   ...
   *
   * @param {object} [opts] - Options for request
   * @param {string|list} [opts.assetVersions] - The asset_versions
   * @param {string|list} [opts.functionVersions] - The function_versions
   * @param {string} [opts.dependencies] - The dependencies
 ...
 * @property {build.status} status - The status
 * @property {string} assetVersions - The asset_versions
 * @property {string} functionVersions - The function_versions
 * @property {string} dependencies - The dependencies
