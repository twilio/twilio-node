...
FunctionVersionList = function FunctionVersionList(version, serviceSid,
  ...
  FunctionVersionListInstance._uri = _.template(
    '/Services/<%= serviceSid %>/Functions/<%= functionSid %>/Versions' // jshint ignore:line
   ...
   * @param {function_version.visibility} opts.visibility -
   ...
   */
  /* jshint ignore:end */
  FunctionVersionListInstance.create = function create(opts, callback) {
    if (_.isUndefined(opts)) {
      throw new Error('Required parameter "opts" missing.');
    }
    if (_.isUndefined(opts.path)) {
      throw new Error('Required parameter "opts.path" missing.');
    }
    if (_.isUndefined(opts.visibility)) {
      throw new Error('Required parameter "opts.visibility" missing.');
    }

    var deferred = Q.defer();
    var data = values.of({'Path': _.get(opts, 'path'), 'Visibility': _.get(opts, 'visibility')});
 ...
 *
 * @property {string} sid - Function Version Sid.
 * @property {string} accountSid - Account Sid.
 * @property {string} serviceSid - Service Sid.
 * @property {string} functionSid - Function Sid.
 * @property {string} path -
 *          The URL-friendly string by which this Function Version can be referenced.
 * @property {string} preSignedUploadUrl -
 ...
 *          The access control which determines how the Function Version can be accessed.
 * @property {Date} dateCreated - The date that this Function Version was created.
 * @property {string} url - The URL of this Function Version.
 *
 * @param {V1} version - Version of the resource
 * @param {FunctionVersionPayload} payload - The instance payload
 * @param {sid} serviceSid - Service Sid.
 * @param {sid} functionSid - Function Sid.
 * @param {sid} sid - Function Version Sid.
 */
/* jshint ignore:end */
FunctionVersionInstance = function FunctionVersionInstance(version, payload,
  ...
  this.preSignedUploadUrl = payload.pre_signed_upload_url; // jshint ignore:line
...
FunctionVersionContext = function FunctionVersionContext(version, serviceSid,
  ...
  this._uri = _.template(
    '/Services/<%= serviceSid %>/Functions/<%= functionSid %>/Versions/<%= sid %>' // jshint ignore:line
  )(this._solution);
};
