...
FunctionVersionList = function FunctionVersionList(version, serviceSid,
   ...
   * @param {function_version.visibility} opts.visibility - The visibility
 ...
 * @property {string} functionSid - The function_sid
 * @property {string} path - The path
 * @property {string} preSignedUploadUrl - The pre_signed_upload_url
 * @property {function_version.visibility} visibility - The visibility
 ...
 * @param {sid} functionSid - The function_sid
