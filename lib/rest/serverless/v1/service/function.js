...
FunctionList = function FunctionList(version, serviceSid) {
  ...
  FunctionListInstance._uri = _.template(
    '/Services/<%= serviceSid %>/Functions' // jshint ignore:line
  )(FunctionListInstance._solution);
  /* jshint ignore:start */
  /**
 ...
 *
 * @property {string} sid - Function Sid.
 * @property {string} accountSid - Account Sid.
 * @property {string} serviceSid - Service Sid.
 * @property {string} friendlyName - A human-readable description of this Function.
 * @property {Date} dateCreated - The date that this Function was created.
 * @property {Date} dateUpdated - The date that this Function was updated.
 * @property {string} url - The URL of this Function.
...
FunctionContext = function FunctionContext(version, serviceSid, sid) {
  ...
  this._uri = _.template(
    '/Services/<%= serviceSid %>/Functions/<%= sid %>' // jshint ignore:line
  )(this._solution);
