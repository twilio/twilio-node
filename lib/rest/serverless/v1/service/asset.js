...
AssetList = function AssetList(version, serviceSid) {
  ...
  AssetListInstance._uri = _.template(
    '/Services/<%= serviceSid %>/Assets' // jshint ignore:line
   ...
   *
   * @param {object} opts - Options for request
   * @param {string} opts.friendlyName - A human-readable description of this Asset.
 ...
 *
 * @property {string} sid - Asset Sid.
 * @property {string} accountSid - Account Sid.
 * @property {string} serviceSid - Service Sid.
 * @property {string} friendlyName - A human-readable description of this Asset.
 * @property {Date} dateCreated - The date that this Asset was created.
 * @property {Date} dateUpdated - The date that this Asset was updated.
 * @property {string} url - The URL of this Asset.
...
AssetContext = function AssetContext(version, serviceSid, sid) {
  ...
  this._uri = _.template(
    '/Services/<%= serviceSid %>/Assets/<%= sid %>' // jshint ignore:line
  )(this._solution);
