...
VariableList = function VariableList(version, serviceSid, environmentSid) {
  ...
  VariableListInstance._uri = _.template(
    '/Services/<%= serviceSid %>/Environments/<%= environmentSid %>/Variables' // jshint ignore:line
  )(VariableListInstance._solution);
  /* jshint ignore:start */
  /**
   ...
   *
   * @param {object} opts - Options for request
   * @param {string} opts.key - A string by which this Variable can be referenced.
 ...
 *
 * @property {string} sid - Variable Sid.
 * @property {string} accountSid - Account Sid.
 * @property {string} serviceSid - Service Sid.
 * @property {string} environmentSid - Environment Sid.
 * @property {string} key - A string by which this Variable can be referenced.
 * @property {string} value -
 *          A string that contains the actual value of this Variable.
 * @property {Date} dateCreated - The date that this Variable was created.
 * @property {Date} dateUpdated - The date that this Variable was updated.
 * @property {string} url - The URL of this Variable.
 *
 * @param {V1} version - Version of the resource
 * @param {VariablePayload} payload - The instance payload
 * @param {sid} serviceSid - Service Sid.
 * @param {sid} environmentSid - Environment Sid.
 * @param {sid} sid - Variable Sid.
 */
/* jshint ignore:end */
...
VariableContext = function VariableContext(version, serviceSid, environmentSid,
  ...
  this._uri = _.template(
    '/Services/<%= serviceSid %>/Environments/<%= environmentSid %>/Variables/<%= sid %>' // jshint ignore:line
  )(this._solution);
};
