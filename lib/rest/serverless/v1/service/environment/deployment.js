...
DeploymentList = function DeploymentList(version, serviceSid, environmentSid) {
  ...
  DeploymentListInstance._uri = _.template(
    '/Services/<%= serviceSid %>/Environments/<%= environmentSid %>/Deployments' // jshint ignore:line
   ...
   *
   * @param {object} opts - Options for request
   * @param {string} opts.buildSid - Build Sid.
  ...
  DeploymentListInstance.create = function create(opts, callback) {
    ...
    if (_.isUndefined(opts.buildSid)) {
      throw new Error('Required parameter "opts.buildSid" missing.');
    }
 ...
 *
 * @property {string} sid - Deployment Sid.
 ...
 * @property {Date} dateCreated - The date that this Deployment was created.
 * @property {Date} dateUpdated - The date that this Deployment was updated.
 * @property {string} url - The URL of this Deployment.
 *
 * @param {V1} version - Version of the resource
...
DeploymentContext = function DeploymentContext(version, serviceSid,
  ...
  this._uri = _.template(
    '/Services/<%= serviceSid %>/Environments/<%= environmentSid %>/Deployments/<%= sid %>' // jshint ignore:line
  )(this._solution);
};
