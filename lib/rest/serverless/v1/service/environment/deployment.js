...
DeploymentList = function DeploymentList(version, serviceSid, environmentSid) {
   ...
   *
   * @param {object} opts - Options for request
   * @param {string} opts.buildSid - The build_sid
 ...
 * @property {string} environmentSid - The environment_sid
 * @property {string} buildSid - The build_sid
 ...
 * @param {sid} environmentSid - The environment_sid
