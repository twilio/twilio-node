...
LogList = function LogList(version, serviceSid, environmentSid) {
   ...
   * @param {string} [opts.functionSid] - Function Sid.
 ...
 *
 * @property {string} sid - Log Sid.
 * @property {string} accountSid - Account Sid.
 * @property {string} serviceSid - Service Sid.
 * @property {string} environmentSid - Environment Sid.
 * @property {string} deploymentSid - Deployment Sid.
 * @property {string} functionSid - Function Sid.
 * @property {string} requestSid - The request_sid
 * @property {log.level} level - The level
 * @property {string} message - The message
 * @property {Date} dateCreated - The date that this Log was created.
 * @property {string} url - The URL of this Log.
 *
 * @param {V1} version - Version of the resource
 * @param {LogPayload} payload - The instance payload
 * @param {sid} serviceSid - Service Sid.
 * @param {sid} environmentSid - Environment Sid.
 * @param {sid} sid - Log Sid.
 */
/* jshint ignore:end */
