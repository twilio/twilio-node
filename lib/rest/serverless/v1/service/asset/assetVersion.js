...
AssetVersionList = function AssetVersionList(version, serviceSid, assetSid) {
  ...
  AssetVersionListInstance._uri = _.template(
    '/Services/<%= serviceSid %>/Assets/<%= assetSid %>/Versions' // jshint ignore:line
  )(AssetVersionListInstance._solution);
  /* jshint ignore:start */
  /**
   ...
   * @param {asset_version.visibility} opts.visibility -
   ...
   */
  /* jshint ignore:end */
  AssetVersionListInstance.create = function create(opts, callback) {
 ...
 *
 * @property {string} sid - Asset Version Sid.
 * @property {string} accountSid - Account Sid.
 * @property {string} serviceSid - Service Sid.
 * @property {string} assetSid - Asset Sid.
 ...
 * @property {Date} dateCreated - The date that this Asset Version was created.
 * @property {string} url - The URL of this Asset Version.
 *
 * @param {V1} version - Version of the resource
 * @param {AssetVersionPayload} payload - The instance payload
 * @param {sid} serviceSid - Service Sid.
 * @param {sid} assetSid - Asset Sid.
 * @param {sid} sid - Asset Version Sid.
 */
/* jshint ignore:end */
...
AssetVersionContext = function AssetVersionContext(version, serviceSid,
  ...
  this._uri = _.template(
    '/Services/<%= serviceSid %>/Assets/<%= assetSid %>/Versions/<%= sid %>' // jshint ignore:line
  )(this._solution);
};
