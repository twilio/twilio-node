...
AssetVersionList = function AssetVersionList(version, serviceSid, assetSid) {
   ...
   * @param {asset_version.visibility} opts.visibility - The visibility
 ...
 * @property {string} assetSid - The asset_sid
 * @property {string} path - The path
 * @property {asset_version.visibility} visibility - The visibility
 ...
 * @param {sid} assetSid - The asset_sid
