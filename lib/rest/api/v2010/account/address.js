...
function AddressList(version, accountSid) {
   ...
   */
  AddressListInstance.read = function stream(opts) {
   ...
   */
  AddressListInstance.read = function list(opts) {
    return this.page();
  };
   ...
   */
  AddressListInstance.read = function page(opts, page_token=values.unset,
