...
function AddressList(version, accountSid) {
  ...
  AddressListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      'CustomerName': _.get(opts, "customerName", undefined),
      'Street': _.get(opts, "street", undefined),
      'City': _.get(opts, "city", undefined),
      'Region': _.get(opts, "region", undefined),
      'PostalCode': _.get(opts, "postalCode", undefined),
      'IsoCountry': _.get(opts, "isoCountry", undefined),
      'FriendlyName': _.get(opts, "friendlyName", undefined),
      'EmergencyEnabled': _.get(opts, "emergencyEnabled", undefined)
    });
 ...
 */
/* jshint ignore:end */
function AddressPage(version, response, solution) {
  // Path Solution
