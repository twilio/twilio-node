...
function CredentialListList(version, accountSid) {
   ...
   */
  CredentialListListInstance.each = function each(opts) {
    opts = opts || {};
   ...
   */
  CredentialListListInstance.create = function create(opts) {
 ...
 */
CredentialListInstance.prototype.update = function update(opts) {
 ...
 * @returns Updated CredentialListInstance
 */
CredentialListContext.prototype.update = function update(opts) {
  if (_.isUndefined(opts)) {
    throw new Error('Required parameters are missing. Please provide: friendlyName.');  // jshint ignore:line
  }
  if (_.isUndefined(opts.friendlyName)) {
