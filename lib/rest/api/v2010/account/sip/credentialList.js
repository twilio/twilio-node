...
/**
 * @description Update the CredentialListInstance
 *
 * If a function is passed as the first argument, it will be used as the callback function.
 *
 * @param {object} opts - ...
 ...
 *
 * @returns {Promise} Resolves to updated CredentialListInstance
 */
 ...
 * @description Initialize the CredentialListContext
 *
 * @property {CredentialList} credentials - credentials resource
 *
 * @param {V2010} version - Version that contains the resource
 * @param {sid} accountSid - The account_sid
 * @param {sid} sid - Fetch by unique credential Sid
