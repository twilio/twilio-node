...
function CredentialListMappingList(version, accountSid, domainSid) {
   ...
   */
  CredentialListMappingListInstance.read = function stream() {
   ...
   */
  CredentialListMappingListInstance.read = function list() {
    return this.page();
  };
   ...
   */
  CredentialListMappingListInstance.read = function page(page_token=values.unset,
