...
function DomainList(version, accountSid) {
  ...
  DomainListInstance.create = function create(opts, callback) {
    ...
    var deferred = Q.defer();
    var data = values.of({
      'DomainName': _.get(opts, "domainName", undefined),
      'FriendlyName': _.get(opts, "friendlyName", undefined),
      'AuthType': _.get(opts, "authType", undefined),
      ...
      'VoiceStatusCallbackUrl': _.get(opts, "voiceStatusCallbackUrl", undefined),
      'VoiceStatusCallbackMethod': _.get(opts, "voiceStatusCallbackMethod", undefined)
    });
