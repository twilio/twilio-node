...
function DomainList(version, accountSid) {
   ...
   */
  DomainListInstance.each = function each(opts) {
    opts = opts || {};
   ...
   */
  DomainListInstance.list = function list(opts) {
    opts = opts || {};
    var allResources = [];
   ...
   */
  DomainListInstance.page = function page(opts) {
    opts = opts || {};
   ...
   */
  DomainListInstance.create = function create(opts) {
    if (_.isUndefined(opts)) {
      throw new Error('Required parameters are missing. Please provide: domainName.');  // jshint ignore:line
    }
