...
function CredentialList(version, accountSid, credentialListSid) {
   ...
   */
  CredentialListInstance.each = function each(opts) {
    opts = opts || {};
   ...
   */
  CredentialListInstance.create = function create(opts) {
    if (_.isUndefined(opts)) {
      throw new Error('Required parameters are missing. Please provide: username, password.');  // jshint ignore:line
    }
 ...
 */
CredentialInstance.prototype.update = function update(opts) {
 ...
 * @returns Updated CredentialInstance
 */
CredentialContext.prototype.update = function update(opts) {
  if (_.isUndefined(opts)) {
    throw new Error('Required parameters are missing. Please provide: username, password.');  // jshint ignore:line
  }
  if (_.isUndefined(opts.username)) {
