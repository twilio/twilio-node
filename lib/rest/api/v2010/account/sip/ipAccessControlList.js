...
function IpAccessControlListList(version, accountSid) {
   ...
   */
  IpAccessControlListListInstance.read = function stream() {
   ...
   */
  IpAccessControlListListInstance.read = function list() {
    return this.page();
  };
   ...
   */
  IpAccessControlListListInstance.read = function page(page_token=values.unset,
