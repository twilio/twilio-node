...
function IpAddressList(version, accountSid, ipAccessControlListSid) {
   ...
   */
  IpAddressListInstance.each = function each(opts) {
    opts = opts || {};
   ...
   */
  IpAddressListInstance.create = function create(opts) {
    if (_.isUndefined(opts)) {
      throw new Error('Required parameters are missing. Please provide: friendlyName, ipAddress.');  // jshint ignore:line
    }
 ...
 */
IpAddressInstance.prototype.update = function update(opts) {
 ...
 * @returns Updated IpAddressInstance
 */
IpAddressContext.prototype.update = function update(opts) {
  if (_.isUndefined(opts)) {
    throw new Error('Required parameters are missing. Please provide: ipAddress, friendlyName.');  // jshint ignore:line
  }
  if (_.isUndefined(opts.ipAddress)) {
    throw new Error('Required parameter "ipAddress" missing.');
  }
