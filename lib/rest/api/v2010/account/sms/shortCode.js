 ...
 *          A 34 character string that uniquely identifies this resource.
 *
 * @returns {function} - ShortCodeListInstance
 */
function ShortCodeList(version, accountSid) {
  ...
  /**
   * @memberof ShortCodeList
   *
   * @description Streams ShortCodeInstance records from the API.
   *
   ...
   * @memberof ShortCodeList
   *
   * @description Retrieve a single page of ShortCodeInstance records from the API.
   ...
   * @memberof Twilio.Api.V2010.AccountContext.SmsContext.ShortCodeList
   *
   * @description Constructs a ShortCodeContext
   *
...
/**
 * @description Fetch a ShortCodeInstance
 *
 * @param {function} [callback] - Callback to handle fetched record
 *
 * @returns {Promise} Resolves to fetched ShortCodeInstance
 */
...
/**
 * @description Update the ShortCodeInstance
 *
 * If a function is passed as the first argument, it will be used as the callback function.
 *
 * @param {object|function} opts - ...
 ...
 *
 * @returns {Promise} Resolves to updated ShortCodeInstance
 */
