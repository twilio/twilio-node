 ...
 *          A 34 character string that uniquely identifies this resource.
 *
 * @returns {function} - SmsMessageListInstance
 */
function SmsMessageList(version, accountSid) {
  ...
  /**
   * @memberof SmsMessageList
   *
   * @description Create a new SmsMessageInstance
   *
   ...
   * @memberof SmsMessageList
   *
   * @description Streams SmsMessageInstance records from the API.
   *
   ...
   * @memberof SmsMessageList
   *
   * @description Retrieve a single page of SmsMessageInstance records from the API.
   ...
   * @memberof Twilio.Api.V2010.AccountContext.SmsContext.SmsMessageList
   *
   * @description Constructs a SmsMessageContext
   *
...
/**
 * @description Deletes the SmsMessageInstance
 *
...
/**
 * @description Fetch a SmsMessageInstance
 *
...
/**
 * @description Update the SmsMessageInstance
 *
 * If a function is passed as the first argument, it will be used as the callback function.
 *
 * @param {object|function} opts - ...
