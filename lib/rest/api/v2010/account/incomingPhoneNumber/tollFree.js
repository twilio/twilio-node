...
function TollFreeList(version, ownerAccountSid) {
   ...
   */
  TollFreeListInstance.read = function stream(opts) {
   ...
   */
  TollFreeListInstance.read = function list(opts) {
    return this.page();
  };
   ...
   */
  TollFreeListInstance.read = function page(opts, page_token=values.unset,
