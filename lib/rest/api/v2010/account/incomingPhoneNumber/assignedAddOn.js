 ...
 */
/* jshint ignore:end */
function AssignedAddOnList(version, accountSid, resourceSid) {
  /* jshint ignore:start */
  /**
  ...
  AssignedAddOnListInstance.create = function create(opts, callback) {
    ...
    var deferred = Q.defer();
    var data = values.of({
      'InstalledAddOnSid': _.get(opts, "installedAddOnSid", undefined)
    });
 ...
 */
/* jshint ignore:end */
function AssignedAddOnPage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function AssignedAddOnInstance(version, payload, accountSid, resourceSid, sid) {
 ...
 */
/* jshint ignore:end */
function AssignedAddOnContext(version, accountSid, resourceSid, sid) {
  this._version = version;
