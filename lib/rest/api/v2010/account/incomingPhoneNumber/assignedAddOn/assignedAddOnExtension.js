 ...
 */
/* jshint ignore:end */
function AssignedAddOnExtensionList(version, accountSid, resourceSid,
                                     assignedAddOnSid) {
  /* jshint ignore:start */
  /**
   * @function extensions
  ...
  AssignedAddOnExtensionListInstance.page = function page(opts, callback) {
    ...
    promise = promise.then(function(payload) {
      deferred.resolve(new AssignedAddOnExtensionPage(
        this._version,
        payload,
        this._solution
      ));
 ...
 */
/* jshint ignore:end */
function AssignedAddOnExtensionPage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function AssignedAddOnExtensionInstance(version, payload, accountSid,
                                         resourceSid, assignedAddOnSid, sid) {
 ...
 */
/* jshint ignore:end */
function AssignedAddOnExtensionContext(version, accountSid, resourceSid,
