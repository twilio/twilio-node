...
function ApplicationList(version, accountSid) {
  ...
  ApplicationListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      ...
      'SmsStatusCallback': _.get(opts, "smsStatusCallback", undefined),
      'MessageStatusCallback': _.get(opts, "messageStatusCallback", undefined)
    });
 ...
 */
/* jshint ignore:end */
function ApplicationPage(version, response, solution) {
  // Path Solution
