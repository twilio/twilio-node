...
function ApplicationList(version, accountSid) {
  function ApplicationListInstance() {
  }
   ...
   */
  ApplicationListInstance.read = function stream(opts) {
   ...
   */
  ApplicationListInstance.read = function list(opts) {
    return this.page();
  };
   ...
   */
  ApplicationListInstance.read = function page(opts, page_token=values.unset,
