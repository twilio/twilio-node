 ...
 */
ParticipantInstance.prototype.update = function update(opts) {
 ...
 * @returns Updated ParticipantInstance
 */
ParticipantContext.prototype.update = function update(opts) {
  if (_.isUndefined(opts)) {
    throw new Error('Required parameters are missing. Please provide: muted.');  // jshint ignore:line
  }
