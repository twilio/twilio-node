...
function ParticipantList(version, accountSid, conferenceSid) {
  function ParticipantListInstance() {
  }
   ...
   */
  ParticipantListInstance.read = function stream(opts) {
   ...
   */
  ParticipantListInstance.read = function list(opts) {
    return this.page();
  };
   ...
   */
  ParticipantListInstance.read = function page(opts, page_token=values.unset,
