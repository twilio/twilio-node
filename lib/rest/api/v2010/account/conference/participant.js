...
function ParticipantList(version, accountSid, conferenceSid) {
  ...
  ParticipantListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      ...
      'Muted': _.get(opts, "muted", undefined),
      'Beep': _.get(opts, "beep", undefined),
      'StartConferenceOnEnter': _.get(opts, "startConferenceOnEnter", undefined),
      'EndConferenceOnExit': _.get(opts, "endConferenceOnExit", undefined),
      'WaitUrl': _.get(opts, "waitUrl", undefined),
      'WaitMethod': _.get(opts, "waitMethod", undefined),
      'EarlyMedia': _.get(opts, "earlyMedia", undefined),
      'MaxParticipants': _.get(opts, "maxParticipants", undefined),
      'ConferenceRecord': _.get(opts, "conferenceRecord", undefined),
      'ConferenceTrim': _.get(opts, "conferenceTrim", undefined),
      'ConferenceStatusCallback': _.get(opts, "conferenceStatusCallback", undefined),
      'ConferenceStatusCallbackMethod': _.get(opts, "conferenceStatusCallbackMethod", undefined),
      'ConferenceStatusCallbackEvent': _.get(opts, "conferenceStatusCallbackEvent", undefined)
    });
  ...
  ParticipantListInstance.page = function page(opts, callback) {
    ...
    var data = values.of({
      'Muted': _.get(opts, "muted", undefined),
      'Hold': _.get(opts, "hold", undefined),
...
ParticipantContext.prototype.update = function update(opts, callback) {
  ...
  var data = values.of({
    'Muted': _.get(opts, "muted", undefined),
    'Hold': _.get(opts, "hold", undefined),
    'HoldUrl': _.get(opts, "holdUrl", undefined),
    'HoldMethod': _.get(opts, "holdMethod", undefined)
  });
