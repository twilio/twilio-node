 ...
 */
/* jshint ignore:end */
function ConnectAppPage(version, response, solution) {
  // Path Solution
...
ConnectAppContext.prototype.update = function update(opts, callback) {
  ...
  var deferred = Q.defer();
  var data = values.of({
    'AuthorizeRedirectUrl': _.get(opts, "authorizeRedirectUrl", undefined),
    'CompanyName': _.get(opts, "companyName", undefined),
    'DeauthorizeCallbackMethod': _.get(opts, "deauthorizeCallbackMethod", undefined),
    'DeauthorizeCallbackUrl': _.get(opts, "deauthorizeCallbackUrl", undefined),
    'Description': _.get(opts, "description", undefined),
    'FriendlyName': _.get(opts, "friendlyName", undefined),
    'HomepageUrl': _.get(opts, "homepageUrl", undefined),
    'Permissions': _.get(opts, "permissions", undefined)
  });
