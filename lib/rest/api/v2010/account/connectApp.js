...
ConnectAppContext.prototype.update = function update(opts) {
  ...
  opts = opts || {};
  var data = values.of({
    'AuthorizeRedirectUrl': opts.authorizeRedirectUrl || values.unset,
    'CompanyName': opts.companyName || values.unset,
    'DeauthorizeCallbackMethod': opts.deauthorizeCallbackMethod || values.unset,
    'DeauthorizeCallbackUrl': opts.deauthorizeCallbackUrl || values.unset,
    'Description': opts.description || values.unset,
    'FriendlyName': opts.friendlyName || values.unset,
    'HomepageUrl': opts.homepageUrl || values.unset,
    'Permissions': opts.permissions || values.unset,
  });
