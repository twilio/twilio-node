...
function NotificationList(version, accountSid) {
   ...
   * @param {moment} [opts.messageDateBefore] - Filter by date
   * @param {moment} [opts.messageDate] - Filter by date
   * @param {moment} [opts.messageDateAfter] - Filter by date
   */
  NotificationListInstance.each = function each(opts) {
    opts = opts || {};
