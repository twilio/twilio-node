 ...
 */
/* jshint ignore:end */
function PayloadPage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function PayloadList(version, accountSid, referenceSid, addOnResultSid) {
  /* jshint ignore:start */
  /**
   * @function payloads
 ...
 */
/* jshint ignore:end */
function PayloadInstance(version, payload, accountSid, referenceSid,
                          addOnResultSid, sid) {
 ...
 */
/* jshint ignore:end */
function PayloadContext(version, accountSid, referenceSid, addOnResultSid, sid)
                         {
  this._version = version;
