 ...
 */
/* jshint ignore:end */
function AddOnResultList(version, accountSid, referenceSid) {
  /* jshint ignore:start */
  /**
 ...
 */
/* jshint ignore:end */
function AddOnResultPage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function AddOnResultInstance(version, payload, accountSid, referenceSid, sid) {
 ...
 */
/* jshint ignore:end */
function AddOnResultContext(version, accountSid, referenceSid, sid) {
  this._version = version;
