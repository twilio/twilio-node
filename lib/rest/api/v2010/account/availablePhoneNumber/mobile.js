...
function MobileList(version, accountSid, countryCode) {
  ...
  MobileListInstance.page = function page(opts, callback) {
    ...
    var data = values.of({
      ...
      'Contains': _.get(opts, "contains", undefined),
      'SmsEnabled': _.get(opts, "smsEnabled", undefined),
      'MmsEnabled': _.get(opts, "mmsEnabled", undefined),
      'VoiceEnabled': _.get(opts, "voiceEnabled", undefined),
      'ExcludeAllAddressRequired': _.get(opts, "excludeAllAddressRequired", undefined),
      'ExcludeLocalAddressRequired': _.get(opts, "excludeLocalAddressRequired", undefined),
      'ExcludeForeignAddressRequired': _.get(opts, "excludeForeignAddressRequired", undefined),
      'Beta': _.get(opts, "beta", undefined),
      'NearNumber': _.get(opts, "nearNumber", undefined),
      'NearLatLong': _.get(opts, "nearLatLong", undefined),
      'Distance': _.get(opts, "distance", undefined),
      'InPostalCode': _.get(opts, "inPostalCode", undefined),
      'InRegion': _.get(opts, "inRegion", undefined),
      'InRateCenter': _.get(opts, "inRateCenter", undefined),
      'InLata': _.get(opts, "inLata", undefined),
