...
function MobileList(version, accountSid, countryCode) {
  ...
  MobileListInstance._uri = _.template(
    '/Accounts/{account_sid}/AvailablePhoneNumbers/{country_code}/Mobile.json',
    this._solution
  );
  /**
   ...
   */
  MobileListInstance.read = function stream(opts) {
   ...
   */
  MobileListInstance.read = function list(opts) {
    return this.page();
  };
   ...
   */
  MobileListInstance.read = function page(opts, page_token=values.unset,
