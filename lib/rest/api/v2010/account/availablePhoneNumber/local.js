...
function LocalList(version, accountSid, countryCode) {
  ...
  LocalListInstance.page = function page(opts) {
    var params = values.of({
      ...
      'Contains': opts.contains || values.unset,
      'SmsEnabled': opts.smsEnabled || values.unset,
      'MmsEnabled': opts.mmsEnabled || values.unset,
      'VoiceEnabled': opts.voiceEnabled || values.unset,
      'ExcludeAllAddressRequired': opts.excludeAllAddressRequired || values.unset,
      'ExcludeLocalAddressRequired': opts.excludeLocalAddressRequired || values.unset,
      'ExcludeForeignAddressRequired': opts.excludeForeignAddressRequired || values.unset,
