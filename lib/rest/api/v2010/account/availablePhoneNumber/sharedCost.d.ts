...
interface SharedCostListInstance {
   ...
   */
  each(opts?: SharedCostListInstanceEachOptions, callback?: Function);
  /**
...
export { SharedCostInstance, SharedCostList, SharedCostListInstance, SharedCostPage, SharedCostPayload, SharedCostResource, SharedCostSolution }
