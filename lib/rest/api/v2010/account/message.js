...
function MessageList(version, accountSid) {
  ...
  MessageListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      ...
      'Body': _.get(opts, "body", undefined),
      'MediaUrl': _.get(opts, "mediaUrl", undefined),
      'StatusCallback': _.get(opts, "statusCallback", undefined),
      'ApplicationSid': _.get(opts, "applicationSid", undefined),
      'MaxPrice': _.get(opts, "maxPrice", undefined),
      'ProvideFeedback': _.get(opts, "provideFeedback", undefined)
    });
  ...
  MessageListInstance.page = function page(opts, callback) {
    ...
    var data = values.of({
      'To': _.get(opts, "to", undefined),
      'From': _.get(opts, "from", undefined),
      'DateSent<': serialize.iso8601DateTime(_.get(opts, "dateSentBefore", undefined)),
      'DateSent': serialize.iso8601DateTime(_.get(opts, "dateSent", undefined)),
      'DateSent>': serialize.iso8601DateTime(_.get(opts, "dateSentAfter", undefined)),
