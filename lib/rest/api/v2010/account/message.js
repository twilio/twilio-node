...
function MessageList(version, accountSid) {
  ...
  MessageListInstance.create = function create(to, from, opts) {
    ...
    var data = values.of({
      ...
      'Body': opts.body || values.unset,
      'MediaUrl': opts.mediaUrl || values.unset
    });
  ...
  MessageListInstance.page = function page(opts) {
    var params = values.of({
      ...
      'DateSent<': opts.datesentbefore || values.unset,
      'DateSent': opts.dateSent || values.unset,
      'DateSent>': opts.datesentafter || values.unset,
