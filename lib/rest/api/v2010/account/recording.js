...
function RecordingList(version, accountSid) {
  ...
  RecordingListInstance.page = function page(opts, callback) {
    ...
    var deferred = Q.defer();
    var data = values.of({
      'DateCreated<': serialize.iso8601DateTime(_.get(opts, "dateCreatedBefore", undefined)),
      'DateCreated': serialize.iso8601DateTime(_.get(opts, "dateCreated", undefined)),
      'DateCreated>': serialize.iso8601DateTime(_.get(opts, "dateCreatedAfter", undefined)),
      'CallSid': _.get(opts, "callSid", undefined),
 ...
 */
/* jshint ignore:end */
function RecordingPage(version, response, solution) {
  // Path Solution
