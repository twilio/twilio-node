...
export interface DomainContext {
  ...
  ip_access_control_list_mappings: IpAccessControlListMappingListInstance;
  credential_list_mappings: CredentialListMappingListInstance;
  auth_types: AuthTypesListInstance;
   ...
   */
  remove(callback?: (error: Error | null, item?: DomainInstance) => any): Promise<boolean>
...
export class DomainContextImpl implements DomainContext {
  ...
  protected _ip_access_control_list_mappings?: IpAccessControlListMappingListInstance;
  protected _credential_list_mappings?: CredentialListMappingListInstance;
  protected _auth_types?: AuthTypesListInstance;
  ...
  get ip_access_control_list_mappings(): IpAccessControlListMappingListInstance {
    this._ip_access_control_list_mappings = this._ip_access_control_list_mappings || IpAccessControlListMappingListInstance(this._version, this._solution.accountSid, this._solution.sid);
    return this._ip_access_control_list_mappings;
  }

  get credential_list_mappings(): CredentialListMappingListInstance {
    this._credential_list_mappings = this._credential_list_mappings || CredentialListMappingListInstance(this._version, this._solution.accountSid, this._solution.sid);
    return this._credential_list_mappings;
  }

  get auth_types(): AuthTypesListInstance {
    this._auth_types = this._auth_types || AuthTypesListInstance(this._version, this._solution.accountSid, this._solution.sid);
    return this._auth_types;
  }
...
export class DomainInstance {
   ...
   */
  ip_access_control_list_mappings(): IpAccessControlListMappingListInstance {
    return this._proxy.ip_access_control_list_mappings;
  }
   ...
   */
  credential_list_mappings(): CredentialListMappingListInstance {
    return this._proxy.credential_list_mappings;
  }

  /**
   * Access the auth_types.
   */
  auth_types(): AuthTypesListInstance {
    return this._proxy.auth_types;
  }
