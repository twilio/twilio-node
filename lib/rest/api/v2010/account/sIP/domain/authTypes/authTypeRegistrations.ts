...
export interface AuthTypeRegistrationsListInstance {
  ...
  auth_registrations_credential_list_mapping: AuthRegistrationsCredentialListMappingListInstance;
...
class AuthTypeRegistrationsListInstanceImpl implements AuthTypeRegistrationsListInstance {
  ...
  _auth_registrations_credential_list_mapping?: AuthRegistrationsCredentialListMappingListInstance;
}
...
export function AuthTypeRegistrationsListInstance(version: V2010, accountSid: string, domainSid: string): AuthTypeRegistrationsListInstance {
  ...
  Object.defineProperty(instance, "auth_registrations_credential_list_mapping", {
    get: function auth_registrations_credential_list_mapping() {
      if (!this._auth_registrations_credential_list_mapping) {
        this._auth_registrations_credential_list_mapping = AuthRegistrationsCredentialListMappingListInstance(this._version, this._solution.accountSid, this._solution.domainSid);
      }
      return this._auth_registrations_credential_list_mapping;
    }
  });
