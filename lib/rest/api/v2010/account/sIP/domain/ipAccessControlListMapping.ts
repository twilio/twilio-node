...
export function IpAccessControlListMappingListInstance(version: V2010, accountSid: string, domainSid: string): IpAccessControlListMappingListInstance {
  const instance = ((sid) => instance.get(sid)) as IpAccessControlListMappingListInstanceImpl;
  ...
  instance.create = function create(params: any, callback?: any): Promise<IpAccessControlListMappingInstance> {
...
export interface IpAccessControlListMappingContext {
   ...
   */
  remove(callback?: (error: Error | null, item?: IpAccessControlListMappingInstance) => any): Promise<boolean>
