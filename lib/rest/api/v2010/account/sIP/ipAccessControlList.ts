...
export interface IpAccessControlListContext {
  ...
  ip_addresses: IpAddressListInstance;
   ...
   */
  remove(callback?: (error: Error | null, item?: IpAccessControlListInstance) => any): Promise<boolean>
...
export class IpAccessControlListContextImpl implements IpAccessControlListContext {
  ...
  protected _ip_addresses?: IpAddressListInstance;
  ...
  get ip_addresses(): IpAddressListInstance {
    this._ip_addresses = this._ip_addresses || IpAddressListInstance(this._version, this._solution.accountSid, this._solution.sid);
...
export class IpAccessControlListInstance {
   ...
   */
  ip_addresses(): IpAddressListInstance {
    return this._proxy.ip_addresses;
  }
