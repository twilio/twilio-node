...
function IncomingPhoneNumberList(version, ownerAccountSid) {
   ...
   */
  IncomingPhoneNumberListInstance.read = function stream(opts) {
   ...
   */
  IncomingPhoneNumberListInstance.read = function list(opts) {
    return this.page();
  };
   ...
   */
  IncomingPhoneNumberListInstance.read = function page(opts,
