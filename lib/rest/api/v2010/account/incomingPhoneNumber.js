 ...
 */
/* jshint ignore:end */
function IncomingPhoneNumberPage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function IncomingPhoneNumberList(version, accountSid) {
  /* jshint ignore:start */
  /**
  ...
  IncomingPhoneNumberListInstance.page = function page(opts, callback) {
    ...
    var deferred = Q.defer();
    var data = values.of({
      'Beta': _.get(opts, "beta", undefined),
      'FriendlyName': _.get(opts, "friendlyName", undefined),
      'PhoneNumber': _.get(opts, "phoneNumber", undefined),
  ...
  IncomingPhoneNumberListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      'PhoneNumber': _.get(opts, "phoneNumber", undefined),
      'AreaCode': _.get(opts, "areaCode", undefined),
      'ApiVersion': _.get(opts, "apiVersion", undefined),
      'FriendlyName': _.get(opts, "friendlyName", undefined),
      'SmsApplicationSid': _.get(opts, "smsApplicationSid", undefined),
      'SmsFallbackMethod': _.get(opts, "smsFallbackMethod", undefined),
      'SmsFallbackUrl': _.get(opts, "smsFallbackUrl", undefined),
      'SmsMethod': _.get(opts, "smsMethod", undefined),
      'SmsUrl': _.get(opts, "smsUrl", undefined),
      'StatusCallback': _.get(opts, "statusCallback", undefined),
      'StatusCallbackMethod': _.get(opts, "statusCallbackMethod", undefined),
      'VoiceApplicationSid': _.get(opts, "voiceApplicationSid", undefined),
      'VoiceCallerIdLookup': _.get(opts, "voiceCallerIdLookup", undefined),
      'VoiceFallbackMethod': _.get(opts, "voiceFallbackMethod", undefined),
      'VoiceFallbackUrl': _.get(opts, "voiceFallbackUrl", undefined),
      'VoiceMethod': _.get(opts, "voiceMethod", undefined),
      'VoiceUrl': _.get(opts, "voiceUrl", undefined),
      'EmergencyStatus': _.get(opts, "emergencyStatus", undefined),
      'EmergencyAddressSid': _.get(opts, "emergencyAddressSid", undefined),
      'TrunkSid': _.get(opts, "trunkSid", undefined)
    });
 ...
 */
/* jshint ignore:end */
function IncomingPhoneNumberInstance(version, payload, accountSid, sid) {
 ...
 */
/* jshint ignore:end */
function IncomingPhoneNumberContext(version, accountSid, sid) {
  this._version = version;
