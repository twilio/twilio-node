...
function IncomingPhoneNumberList(version, ownerAccountSid) {
  ...
  IncomingPhoneNumberListInstance.page = function page(opts) {
    var params = values.of({
      'Beta': opts.beta || values.unset,
      'FriendlyName': opts.friendlyName || values.unset,
      'PhoneNumber': opts.phoneNumber || values.unset,
  ...
  IncomingPhoneNumberListInstance.create = function create(opts) {
    ...
    opts = opts || {};
    var data = values.of({
      'ApiVersion': opts.apiVersion || values.unset,
      'FriendlyName': opts.friendlyName || values.unset,
      'SmsApplicationSid': opts.smsApplicationSid || values.unset,
      'SmsFallbackMethod': opts.smsFallbackMethod || values.unset,
      'SmsFallbackUrl': opts.smsFallbackUrl || values.unset,
      ...
      'VoiceApplicationSid': opts.voiceApplicationSid || values.unset,
      'VoiceCallerIdLookup': opts.voiceCallerIdLookup || values.unset,
      'VoiceFallbackMethod': opts.voiceFallbackMethod || values.unset,
      'VoiceFallbackUrl': opts.voiceFallbackUrl || values.unset,
      'VoiceMethod': opts.voiceMethod || values.unset,
      'VoiceUrl': opts.voiceUrl || values.unset,
      'PhoneNumber': opts.phoneNumber || values.unset,
      'AreaCode': opts.areaCode || values.unset
    });
...
IncomingPhoneNumberContext.prototype.update = function update(opts) {
  var data = values.of({
    'AccountSid': opts.accountSid || values.unset,
    'ApiVersion': opts.apiVersion || values.unset,
    'FriendlyName': opts.friendlyName || values.unset,
    'SmsApplicationSid': opts.smsApplicationSid || values.unset,
    'SmsFallbackMethod': opts.smsFallbackMethod || values.unset,
