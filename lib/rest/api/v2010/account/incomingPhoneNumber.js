 ...
 *          A 34 character string that uniquely identifies this resource.
 *
 * @returns {function} - IncomingPhoneNumberListInstance
 */
function IncomingPhoneNumberList(version, ownerAccountSid) {
  ...
  /**
   * @memberof IncomingPhoneNumberList
   *
   * @description Streams IncomingPhoneNumberInstance records from the API.
   *
   ...
   * @memberof IncomingPhoneNumberList
   *
   * @description Retrieve a single page of IncomingPhoneNumberInstance records from the API.
   ...
   * @memberof IncomingPhoneNumberList
   *
   * @description Create a new IncomingPhoneNumberInstance
   *
   * If a function is passed as the first argument, it will be used as the callback function.
   *
   * @param {object|function} opts - ...
   ...
   * @memberof Twilio.Api.V2010.AccountContext.IncomingPhoneNumberList
   *
   * @description Constructs a IncomingPhoneNumberContext
   *
...
/**
 * @description Update the IncomingPhoneNumberInstance
 *
 * If a function is passed as the first argument, it will be used as the callback function.
 *
 * @param {object|function} opts - ...
...
/**
 * @description Fetch a IncomingPhoneNumberInstance
 *
...
/**
 * @description Deletes the IncomingPhoneNumberInstance
 *
