...
function ConferenceList(version, accountSid) {
  ...
  ConferenceListInstance.page = function page(opts) {
    var params = values.of({
      'DateCreated<': opts.datecreatedbefore || values.unset,
      'DateCreated': opts.dateCreated || values.unset,
      'DateCreated>': opts.datecreatedafter || values.unset,
      'DateUpdated<': opts.dateupdatedbefore || values.unset,
      'DateUpdated': opts.dateUpdated || values.unset,
      'DateUpdated>': opts.dateupdatedafter || values.unset,
