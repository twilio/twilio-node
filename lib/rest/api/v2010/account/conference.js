 ...
 */
/* jshint ignore:end */
function ConferencePage(version, response, solution) {
  // Path Solution
...
function ConferenceList(version, accountSid) {
  ...
  ConferenceListInstance.page = function page(opts, callback) {
    ...
    var deferred = Q.defer();
    var data = values.of({
      'DateCreated<': serialize.iso8601Date(_.get(opts, "dateCreatedBefore", undefined)),
      'DateCreated': serialize.iso8601Date(_.get(opts, "dateCreated", undefined)),
      'DateCreated>': serialize.iso8601Date(_.get(opts, "dateCreatedAfter", undefined)),
      'DateUpdated<': serialize.iso8601Date(_.get(opts, "dateUpdatedBefore", undefined)),
      'DateUpdated': serialize.iso8601Date(_.get(opts, "dateUpdated", undefined)),
      'DateUpdated>': serialize.iso8601Date(_.get(opts, "dateUpdatedAfter", undefined)),
