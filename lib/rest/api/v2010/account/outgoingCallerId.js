...
function OutgoingCallerIdList(version, accountSid) {
  function OutgoingCallerIdListInstance() {
  }
   ...
   */
  OutgoingCallerIdListInstance.read = function stream(opts) {
   ...
   */
  OutgoingCallerIdListInstance.read = function list(opts) {
    return this.page();
  };
   ...
   */
  OutgoingCallerIdListInstance.read = function page(opts, page_token=values.unset,
