...
function CallList(version, accountSid) {
  ...
  CallListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      'To': _.get(opts, "to", undefined),
      'From': _.get(opts, "from", undefined),
      'Url': _.get(opts, "url", undefined),
      'ApplicationSid': _.get(opts, "applicationSid", undefined),
      'Method': _.get(opts, "method", undefined),
      'FallbackUrl': _.get(opts, "fallbackUrl", undefined),
      'FallbackMethod': _.get(opts, "fallbackMethod", undefined),
      'StatusCallback': _.get(opts, "statusCallback", undefined),
      'StatusCallbackEvent': _.get(opts, "statusCallbackEvent", undefined),
      'StatusCallbackMethod': _.get(opts, "statusCallbackMethod", undefined),
      'SendDigits': _.get(opts, "sendDigits", undefined),
      'IfMachine': _.get(opts, "ifMachine", undefined),
      'Timeout': _.get(opts, "timeout", undefined),
      'Record': _.get(opts, "record", undefined),
      'RecordingChannels': _.get(opts, "recordingChannels", undefined),
      'RecordingStatusCallback': _.get(opts, "recordingStatusCallback", undefined),
      'RecordingStatusCallbackMethod': _.get(opts, "recordingStatusCallbackMethod", undefined),
      'SipAuthUsername': _.get(opts, "sipAuthUsername", undefined),
      'SipAuthPassword': _.get(opts, "sipAuthPassword", undefined),
      'MachineDetection': _.get(opts, "machineDetection", undefined),
      'MachineDetectionTimeout': _.get(opts, "machineDetectionTimeout", undefined)
    });
  ...
  CallListInstance.page = function page(opts, callback) {
    ...
    var data = values.of({
      'To': _.get(opts, "to", undefined),
      'From': _.get(opts, "from", undefined),
      'ParentCallSid': _.get(opts, "parentCallSid", undefined),
      'Status': _.get(opts, "status", undefined),
      'StartTime<': serialize.iso8601DateTime(_.get(opts, "startTimeBefore", undefined)),
      'StartTime': serialize.iso8601DateTime(_.get(opts, "startTime", undefined)),
      'StartTime>': serialize.iso8601DateTime(_.get(opts, "startTimeAfter", undefined)),
      'EndTime<': serialize.iso8601DateTime(_.get(opts, "endTimeBefore", undefined)),
      'EndTime': serialize.iso8601DateTime(_.get(opts, "endTime", undefined)),
      'EndTime>': serialize.iso8601DateTime(_.get(opts, "endTimeAfter", undefined)),
