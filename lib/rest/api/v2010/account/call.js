...
function CallList(version, accountSid) {
   ...
   */
  CallListInstance.create = function create(opts) {
   ...
   * @param {moment} [opts.startTimeBefore] - StartTime to filter on
   * @param {moment} [opts.startTime] - StartTime to filter on
   * @param {moment} [opts.startTimeAfter] - StartTime to filter on
   * @param {moment} [opts.endTimeBefore] - EndTime to filter on
   * @param {moment} [opts.endTime] - EndTime to filter on
   * @param {moment} [opts.endTimeAfter] - EndTime to filter on
   */
  CallListInstance.each = function each(opts) {
    opts = opts || {};
