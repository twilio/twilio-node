...
function CallList(version, accountSid) {
  ...
  CallListInstance.create = function create(to, from, opts) {
    ...
    var data = values.of({
      'To': to,
      'From': from,
      'Method': opts.method || values.unset,
      'FallbackUrl': opts.fallbackUrl || values.unset,
      'FallbackMethod': opts.fallbackMethod || values.unset,
      'StatusCallback': opts.statusCallback || values.unset,
      'StatusCallbackMethod': opts.statusCallbackMethod || values.unset,
      'SendDigits': opts.sendDigits || values.unset,
      'IfMachine': opts.ifMachine || values.unset,
      'Timeout': opts.timeout || values.unset,
      'Record': opts.record || values.unset,
      'Url': opts.url || values.unset,
      'ApplicationSid': opts.applicationSid || values.unset
    });
  ...
  CallListInstance.page = function page(opts) {
    var params = values.of({
      'To': opts.to || values.unset,
      'From': opts.from || values.unset,
      'ParentCallSid': opts.parentCallSid || values.unset,
      'Status': opts.status || values.unset,
      'StartTime<': opts.starttimebefore || values.unset,
      'StartTime': opts.startTime || values.unset,
      'StartTime>': opts.starttimeafter || values.unset,
      'EndTime<': opts.endtimebefore || values.unset,
      'EndTime': opts.endTime || values.unset,
      'EndTime>': opts.endtimeafter || values.unset,
