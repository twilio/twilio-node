 ...
 * @param {string} messageSid - A string that uniquely identifies this message
 *
 * @returns {function} - MediaListInstance
 */
function MediaList(version, accountSid, messageSid) {
   ...
   * @memberof MediaList
   *
   * @description Streams MediaInstance records from the API.
   *
   ...
   * @memberof MediaList
   *
   * @description Retrieve a single page of MediaInstance records from the API.
   ...
   * @memberof MediaList
   *
   * @description Constructs a MediaContext
   *
...
/**
 * @description Deletes the MediaInstance
 *
...
/**
 * @description Fetch a MediaInstance
 *
