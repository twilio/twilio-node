 ...
 */
/* jshint ignore:end */
function FeedbackPage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function FeedbackList(version, accountSid, messageSid) {
  /* jshint ignore:start */
  /**
   * @function feedback
  ...
  FeedbackListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      'Outcome': _.get(opts, "outcome", undefined)
    });
 ...
 */
/* jshint ignore:end */
function FeedbackInstance(version, payload, accountSid, messageSid) {
