...
function AvailablePhoneNumberCountryList(version, accountSid) {
   ...
   */
  AvailablePhoneNumberCountryListInstance.stream = function stream(opts) {
   ...
   */
  AvailablePhoneNumberCountryListInstance.list = function list(opts) {
    opts = opts || {};
   ...
   */
  AvailablePhoneNumberCountryListInstance.page = function page(opts) {
    opts = opts || {};
