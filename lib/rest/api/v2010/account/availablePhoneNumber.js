...
function AvailablePhoneNumberCountryList(version, accountSid) {
   ...
   */
  AvailablePhoneNumberCountryListInstance.read = function stream() {
   ...
   */
  AvailablePhoneNumberCountryListInstance.read = function list() {
    return this.page();
  };
   ...
   */
  AvailablePhoneNumberCountryListInstance.read = function
      page(page_token=values.unset, page_number=values.unset,
