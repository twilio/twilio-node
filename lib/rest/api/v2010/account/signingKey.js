 ...
 */
/* jshint ignore:end */
function SigningKeyPage(version, response, accountSid) {
 ...
 */
/* jshint ignore:end */
function SigningKeyList(version, accountSid) {
  /* jshint ignore:start */
  /**
  ...
  SigningKeyListInstance.page = function page(opts, callback) {
    ...
    promise = promise.then(function(payload) {
      deferred.resolve(new SigningKeyPage(
        this._version,
        payload,
        this._solution.accountSid,
        this._solution.sid
 ...
 */
/* jshint ignore:end */
function SigningKeyInstance(version, payload, accountSid, sid) {
...
Object.defineProperty(SigningKeyInstance.prototype,
  ...
  get: function() {
    if (!this._context) {
      this._context = new SigningKeyContext(
        this._version,
        this._solution.accountSid,
        this._solution.sid
      );
 ...
 */
/* jshint ignore:end */
function SigningKeyContext(version, accountSid, sid) {
  this._version = version;
