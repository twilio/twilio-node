...
export class StreamContextImpl implements StreamContext {
  ...
  update(params: any, callback?: any): Promise<StreamInstance> {
    ...
    operationPromise = operationPromise.then(payload => new StreamInstance(operationVersion, payload, this._solution.accountSid, this._solution.callSid, this._solution.sid));
...
export function StreamListInstance(version: V2010, accountSid: string, callSid: string): StreamListInstance {
  ...
  instance.create = function create(params: any, callback?: any): Promise<StreamInstance> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    operationPromise = operationPromise.then(payload => new StreamInstance(operationVersion, payload, this._solution.accountSid, this._solution.callSid));
