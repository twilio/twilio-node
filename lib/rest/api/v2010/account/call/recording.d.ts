...
interface RecordingListCreateOptions {
  /**
...
interface RecordingListInstance {
   ...
   */
  create(opts?: RecordingListCreateOptions): Promise<RecordingInstance>;
  /**
   * create a RecordingInstance
   *
   * @param opts - Options for request
   ...
   */
  create(opts: RecordingListCreateOptions, callback: (error: Error | null, items: RecordingInstance) => any): void;
  /**
   * create a RecordingInstance
   *
   * @param callback - Callback to handle processed record
   */
  create(callback: (error: Error | null, items: RecordingInstance) => any): void;
  /**
...
export { RecordingContext, RecordingInstance, RecordingList, RecordingListCreateOptions, RecordingListEachOptions, RecordingListFetchOptions, RecordingListInstance, RecordingListOptions, RecordingListPageOptions, RecordingPage, RecordingPayload, RecordingResource, RecordingSolution, RecordingSource, RecordingStatus }
