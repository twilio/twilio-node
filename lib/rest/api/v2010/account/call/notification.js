 ...
 */
NotificationInstance.prototype.delete = function delete() {
...
function NotificationContext(version, accountSid, callSid, sid) {
  ...
  this._uri = _.template(
    '/Accounts/<% account_sid %>/Calls/<% call_sid %>/Notifications/<% sid %>.json', // jshint ignore:line
    this._solution
  );
}
 ...
 * @returns true if delete succeeds, false otherwise
 */
NotificationContext.prototype.delete = function delete() {
