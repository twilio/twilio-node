 ...
 *          A 34 character string that uniquely identifies this resource.
 *
 * @returns {function} - LastMonthListInstance
 */
function LastMonthList(version, accountSid) {
  ...
  /**
   * @memberof LastMonthList
   *
   * @description Streams LastMonthInstance records from the API.
   *
   ...
   * @memberof LastMonthList
   *
   * @description Retrieve a single page of LastMonthInstance records from the API.
