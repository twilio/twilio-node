...
function TodayList(version, accountSid) {
   ...
   */
  TodayListInstance.read = function stream() {
   ...
   */
  TodayListInstance.read = function list() {
    return this.page();
  };
   ...
   */
  TodayListInstance.read = function page(page_token=values.unset,
