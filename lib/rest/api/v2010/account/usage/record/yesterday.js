...
function YesterdayList(version, accountSid) {
  function YesterdayListInstance() {
  }
   ...
   */
  YesterdayListInstance.read = function stream() {
   ...
   */
  YesterdayListInstance.read = function list() {
    return this.page();
  };
   ...
   */
  YesterdayListInstance.read = function page(page_token=values.unset,
