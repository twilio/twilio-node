 ...
 *
 * @property { UsageRecordYesterdayEnumCategory } [category] The [usage category](https://www.twilio.com/docs/usage/api/usage-record#usage-categories) of the UsageRecord resources to read. Only UsageRecord resources in the specified category are retrieved.
...
export function YesterdayListInstance(version: V2010, accountSid: string): YesterdayListInstance {
  ...
  instance.page = function page(params?: any, callback?: any): Promise<YesterdayPage> {
    ...
    operationPromise = operationPromise.then(payload => new YesterdayPage(operationVersion, payload, this._solution));
  ...
  instance.getPage = function getPage(targetUrl?: any, callback?: any): Promise<YesterdayPage> {
    let operationPromise = this._version._domain.twilio.request({method: 'get', uri: targetUrl});

    operationPromise = operationPromise.then(payload => new YesterdayPage(this._version, payload, this._solution));
    operationPromise = this._version.setPromiseCallback(operationPromise,callback);
    return operationPromise;
  }
