 ...
 *
 * @property { UsageRecordAllTimeEnumCategory } [category] The [usage category](https://www.twilio.com/docs/usage/api/usage-record#usage-categories) of the UsageRecord resources to read. Only UsageRecord resources in the specified category are retrieved.
...
export function AllTimeListInstance(version: V2010, accountSid: string): AllTimeListInstance {
  ...
  instance.page = function page(params?: any, callback?: any): Promise<AllTimePage> {
    ...
    operationPromise = operationPromise.then(payload => new AllTimePage(operationVersion, payload, this._solution));
  ...
  instance.getPage = function getPage(targetUrl?: any, callback?: any): Promise<AllTimePage> {
    let operationPromise = this._version._domain.twilio.request({method: 'get', uri: targetUrl});

    operationPromise = operationPromise.then(payload => new AllTimePage(this._version, payload, this._solution));
    operationPromise = this._version.setPromiseCallback(operationPromise,callback);
    return operationPromise;
  }
