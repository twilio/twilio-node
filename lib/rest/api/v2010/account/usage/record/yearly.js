 ...
 *          A 34 character string that uniquely identifies this resource.
 *
 * @returns {function} - YearlyListInstance
 */
function YearlyList(version, accountSid) {
   ...
   * @memberof YearlyList
   *
   * @description Streams YearlyInstance records from the API.
   *
   ...
   * @memberof YearlyList
   *
   * @description Retrieve a single page of YearlyInstance records from the API.
