 ...
 *          A 34 character string that uniquely identifies this resource.
 *
 * @returns {function} - MonthlyListInstance
 */
function MonthlyList(version, accountSid) {
  /**
   * @memberof MonthlyList
   *
   ...
   * @memberof MonthlyList
   *
   * @description Streams MonthlyInstance records from the API.
   *
   ...
   * @memberof MonthlyList
   *
   * @description Retrieve a single page of MonthlyInstance records from the API.
