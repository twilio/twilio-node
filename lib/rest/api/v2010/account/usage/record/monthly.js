...
function MonthlyList(version, accountSid) {
   ...
   */
  MonthlyListInstance.read = function stream() {
   ...
   */
  MonthlyListInstance.read = function list() {
    return this.page();
  };
   ...
   */
  MonthlyListInstance.read = function page(page_token=values.unset,
