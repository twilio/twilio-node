 ...
 *          A 34 character string that uniquely identifies this resource.
 *
 * @returns {function} - DailyListInstance
 */
function DailyList(version, accountSid) {
   ...
   * @memberof DailyList
   *
   * @description Streams DailyInstance records from the API.
   *
   ...
   * @memberof DailyList
   *
   * @description Retrieve a single page of DailyInstance records from the API.
