 ...
 *          A 34 character string that uniquely identifies this resource.
 *
 * @returns {function} - ThisMonthListInstance
 */
function ThisMonthList(version, accountSid) {
  /**
   * @memberof ThisMonthList
   *
   ...
   * @memberof ThisMonthList
   *
   * @description Streams ThisMonthInstance records from the API.
   *
   ...
   * @memberof ThisMonthList
   *
   * @description Retrieve a single page of ThisMonthInstance records from the API.
