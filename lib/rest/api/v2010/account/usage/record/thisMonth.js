...
function ThisMonthList(version, accountSid) {
  function ThisMonthListInstance() {
  }
   ...
   */
  ThisMonthListInstance.read = function stream() {
   ...
   */
  ThisMonthListInstance.read = function list() {
    return this.page();
  };
   ...
   */
  ThisMonthListInstance.read = function page(page_token=values.unset,
