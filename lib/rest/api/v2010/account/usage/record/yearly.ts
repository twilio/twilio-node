 ...
 *
 * @property { UsageRecordYearlyEnumCategory } [category] The [usage category](https://www.twilio.com/docs/usage/api/usage-record#usage-categories) of the UsageRecord resources to read. Only UsageRecord resources in the specified category are retrieved.
...
export function YearlyListInstance(version: V2010, accountSid: string): YearlyListInstance {
  ...
  instance.page = function page(params?: any, callback?: any): Promise<YearlyPage> {
