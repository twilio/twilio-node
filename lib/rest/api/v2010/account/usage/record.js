 ...
 *          A 34 character string that uniquely identifies this resource.
 *
 * @returns {function} - RecordListInstance
 */
function RecordList(version, accountSid) {
   ...
   * @memberof RecordList
   *
   * @description Streams RecordInstance records from the API.
   *
   ...
   * @memberof RecordList
   *
   * @description Retrieve a single page of RecordInstance records from the API.
