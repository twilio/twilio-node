...
var AllTimeList = require('./record/allTime');
var DailyList = require('./record/daily');
var LastMonthList = require('./record/lastMonth');
var ListResource = require('../../../../../base/ListResource');
var MonthlyList = require('./record/monthly');
var ThisMonthList = require('./record/thisMonth');
var TodayList = require('./record/today');
var YearlyList = require('./record/yearly');
var YesterdayList = require('./record/yesterday');
...
function RecordList(version, accountSid) {
   ...
   */
  RecordListInstance.read = function stream(opts) {
   ...
   */
  RecordListInstance.read = function list(opts) {
    return this.page();
  };
   ...
   */
  RecordListInstance.read = function page(opts, page_token=values.unset,
