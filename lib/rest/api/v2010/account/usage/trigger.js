...
function TriggerList(version, accountSid) {
   ...
   */
  TriggerListInstance.read = function stream(opts) {
   ...
   */
  TriggerListInstance.read = function list(opts) {
    return this.page();
  };
   ...
   */
  TriggerListInstance.read = function page(opts, page_token=values.unset,
