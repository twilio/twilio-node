...
function TriggerList(version, accountSid) {
  ...
  TriggerListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      ...
      'TriggerValue': _.get(opts, "triggerValue", undefined),
      'UsageCategory': _.get(opts, "usageCategory", undefined),
      'CallbackMethod': _.get(opts, "callbackMethod", undefined),
      'FriendlyName': _.get(opts, "friendlyName", undefined),
      'Recurring': _.get(opts, "recurring", undefined),
      'TriggerBy': _.get(opts, "triggerBy", undefined)
    });
 ...
 */
/* jshint ignore:end */
function TriggerPage(version, response, solution) {
  // Path Solution
