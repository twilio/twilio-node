 ...
 *          A 34 character string that uniquely identifies this resource.
 *
 * @returns {function} - TriggerListInstance
 */
function TriggerList(version, accountSid) {
   ...
   * @memberof TriggerList
   *
   * @description Create a new TriggerInstance
   *
   ...
   * @memberof TriggerList
   *
   * @description Streams TriggerInstance records from the API.
   *
   ...
   * @memberof TriggerList
   *
   * @description Retrieve a single page of TriggerInstance records from the API.
   ...
   * @memberof TriggerList
   *
   * @description Constructs a TriggerContext
   *
...
/**
 * @description Fetch a TriggerInstance
 *
...
/**
 * @description Update the TriggerInstance
 *
 * If a function is passed as the first argument, it will be used as the callback function.
 *
 * @param {object|function} opts - ...
...
/**
 * @description Deletes the TriggerInstance
 *
