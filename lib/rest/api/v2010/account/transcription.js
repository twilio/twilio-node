...
function TranscriptionList(version, accountSid) {
   ...
   */
  TranscriptionListInstance.stream = function stream(opts) {
   ...
   */
  TranscriptionListInstance.list = function list(opts) {
    opts = opts || {};
   ...
   */
  TranscriptionListInstance.page = function page(opts) {
    opts = opts || {};
