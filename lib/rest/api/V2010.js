...
var AccountContext = require("lib/rest/api/v2010/account.js").AccountContext;
var AccountList = require("lib/rest/api/v2010/account.js").AccountList;
...
Object.defineProperty(V2010.prototype, 'account', {
    get: function() {
        this._account = this._account || new AccountContext(this, this._domain.twilio);
