...
FaxMediaList = function FaxMediaList(version, faxSid) {
  ...
  FaxMediaListInstance.page = function page(opts, callback) {
    ...
    promise = promise.then(function(payload) {
      deferred.resolve(new FaxMediaPage(
        this._version,
        payload,
        this._solution
      ));
 ...
 * @property {string} faxSid - The fax_sid
 * @property {string} contentType - The content_type
...
Object.defineProperty(FaxMediaInstance.prototype,
  ...
  get: function() {
    if (!this._context) {
      this._context = new FaxMediaContext(
        this._version,
        this._solution.faxSid,
        this._solution.sid
      );
