...
ServiceList = function ServiceList(version) {
   ...
   * @param {string} [opts.stickySender] - The sticky_sender
   * @param {string} [opts.mmsConverter] - The mms_converter
   * @param {string} [opts.smartEncoding] - The smart_encoding
   * @param {service.scan_message_content} [opts.scanMessageContent] -
   *          The scan_message_content
   * @param {string} [opts.fallbackToLongCode] - The fallback_to_long_code
   * @param {string} [opts.areaCodeGeomatch] - The area_code_geomatch
  ...
  ServiceListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      ...
      'StickySender': _.get(opts, 'stickySender'),
      'MmsConverter': _.get(opts, 'mmsConverter'),
      'SmartEncoding': _.get(opts, 'smartEncoding'),
      'ScanMessageContent': _.get(opts, 'scanMessageContent'),
      'FallbackToLongCode': _.get(opts, 'fallbackToLongCode'),
      'AreaCodeGeomatch': _.get(opts, 'areaCodeGeomatch'),
 ...
 * @property {string} stickySender - The sticky_sender
 * @property {string} mmsConverter - The mms_converter
 * @property {string} smartEncoding - The smart_encoding
 * @property {service.scan_message_content} scanMessageContent -
 *          The scan_message_content
 * @property {string} fallbackToLongCode - The fallback_to_long_code
 * @property {string} areaCodeGeomatch - The area_code_geomatch
