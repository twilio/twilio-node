...
function ServiceList(version) {
  ...
  ServiceListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      ...
      'InboundRequestUrl': _.get(opts, "inboundRequestUrl", undefined),
      'InboundMethod': _.get(opts, "inboundMethod", undefined),
      ...
      'StickySender': _.get(opts, "stickySender", undefined),
      'MmsConverter': _.get(opts, "mmsConverter", undefined)
    });
