...
SessionList = function SessionList(version) {
   ...
   * @param {string} [opts.createdBy] - The Identity of the session's creator
 ...
 * @property {string} createdBy - The Identity of the session's creator
 * @property {Date} dateCreated -
 *          The ISO 8601 date and time in GMT when the resource was created
 * @property {Date} dateUpdated -
 *          The ISO 8601 date and time in GMT when the resource was last updated
 * @property {string} url - The absolute URL of the session
