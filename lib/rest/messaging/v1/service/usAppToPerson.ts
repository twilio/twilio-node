...
export interface UsAppToPersonListInstance {
  ...
  us_app_to_person_usecase: UsAppToPersonUsecaseListInstance;
...
class UsAppToPersonListInstanceImpl implements UsAppToPersonListInstance {
  ...
  _us_app_to_person_usecase?: UsAppToPersonUsecaseListInstance;
}
...
export function UsAppToPersonListInstance(version: V1, messagingServiceSid: string): UsAppToPersonListInstance {
  ...
  Object.defineProperty(instance, "us_app_to_person_usecase", {
    get: function us_app_to_person_usecase() {
      if (!this._us_app_to_person_usecase) {
        this._us_app_to_person_usecase = UsAppToPersonUsecaseListInstance(this._version, this._solution.messagingServiceSid);
      }
      return this._us_app_to_person_usecase;
    }
  });
