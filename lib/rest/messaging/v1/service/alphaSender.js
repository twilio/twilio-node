 ...
 */
/* jshint ignore:end */
function AlphaSenderPage(version, response, solution) {
  // Path Solution
 ...
 */
/* jshint ignore:end */
function AlphaSenderList(version, serviceSid) {
  /* jshint ignore:start */
  /**
  ...
  AlphaSenderListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      'AlphaSender': _.get(opts, "alphaSender", undefined)
    });
 ...
 */
/* jshint ignore:end */
function AlphaSenderInstance(version, payload, serviceSid, sid) {
 ...
 */
/* jshint ignore:end */
function AlphaSenderContext(version, serviceSid, sid) {
  this._version = version;
