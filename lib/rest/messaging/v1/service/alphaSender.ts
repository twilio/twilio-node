...
export interface AlphaSenderContext {
   ...
   */
  remove(callback?: (error: Error | null, item?: AlphaSenderInstance) => any): Promise<boolean>
...
export function AlphaSenderListInstance(version: V1, serviceSid: string): AlphaSenderListInstance {
  ...
  instance.create = function create(params: any, callback?: any): Promise<AlphaSenderInstance> {
