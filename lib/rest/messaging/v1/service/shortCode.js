 ...
 */
/* jshint ignore:end */
function ShortCodeList(version, serviceSid) {
  /* jshint ignore:start */
  /**
   * @function shortCodes
  ...
  ShortCodeListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      'ShortCodeSid': _.get(opts, "shortCodeSid", undefined)
    });
 ...
 */
/* jshint ignore:end */
function ShortCodeInstance(version, payload, serviceSid, sid) {
 ...
 */
/* jshint ignore:end */
function ShortCodeContext(version, serviceSid, sid) {
  this._version = version;
