...
MessageList = function MessageList(version, sessionSid) {
   ...
   *
   * @returns {Twilio.Messaging.V1.SessionContext.MessageContext}
   */
  /* jshint ignore:end */
  ...
  // Path Solution
  MessageListInstance._solution = {sessionSid: sessionSid};
  MessageListInstance._uri = `/Sessions/${sessionSid}/Messages`;
  /* jshint ignore:start */
  /**
   * create a MessageInstance
   *
   * @function create
   * @memberof Twilio.Messaging.V1.SessionContext.MessageList#
   *
   * @param {object} [opts] - Options for request
   * @param {string} [opts.author] - The identity of the message's author
   ...
   * @param {string} [opts.body] - The message body
  ...
  MessageListInstance.get = function get(sid) {
    return new MessageContext(this._version, this._solution.sessionSid, sid);
  };
 ...
 * access, please contact help@twilio.com.
 *
 * @constructor Twilio.Messaging.V1.SessionContext.MessagePage
 *
 ...
 * @memberof Twilio.Messaging.V1.SessionContext.MessagePage#
 *
...
MessagePage.prototype.getInstance = function getInstance(payload) {
  return new MessageInstance(this._version, payload, this._solution.sessionSid);
};
 ...
 * access, please contact help@twilio.com.
 *
 * @constructor Twilio.Messaging.V1.SessionContext.MessageInstance
 *
 ...
 * @property {string} sessionSid - The SID of the Session for the message
 * @property {string} sid - The unique string that identifies the resource
 * @property {number} index - The index of the message within the Session
 ...
 * @property {string} url - The absolute URL of the message
 *
 * @param {V1} version - Version of the resource
 * @param {MessagePayload} payload - The instance payload
 * @param {sid} sessionSid - The SID of the Session for the message
 * @param {sid} sid - The SID that identifies the resource to fetch
 */
/* jshint ignore:end */
MessageInstance = function MessageInstance(version, payload, sessionSid, sid) {
...
Object.defineProperty(MessageInstance.prototype,
  ...
  get: function() {
    if (!this._context) {
      this._context = new MessageContext(this._version, this._solution.sessionSid, this._solution.sid);
    }
 ...
 *
 * @function fetch
 * @memberof Twilio.Messaging.V1.SessionContext.MessageInstance#
 *
 * @param {function} [callback] - Callback to handle processed record
 *
 * @returns {Promise} Resolves to processed MessageInstance
 ...
 * access, please contact help@twilio.com.
 *
 * @constructor Twilio.Messaging.V1.SessionContext.MessageContext
 *
 * @param {V1} version - Version of the resource
 * @param {sid} sessionSid - The SID of the Session with the message to fetch
 * @param {sid} sid - The SID that identifies the resource to fetch
 */
/* jshint ignore:end */
MessageContext = function MessageContext(version, sessionSid, sid) {
  this._version = version;

  // Path Solution
  this._solution = {sessionSid: sessionSid, sid: sid, };
  this._uri = `/Sessions/${sessionSid}/Messages/${sid}`;
};
 ...
 *
 * @function fetch
 * @memberof Twilio.Messaging.V1.SessionContext.MessageContext#
 *
 * @param {function} [callback] - Callback to handle processed record
 *
 * @returns {Promise} Resolves to processed MessageInstance
