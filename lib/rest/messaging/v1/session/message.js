...
MessageList = function MessageList(version, sessionSid) {
  ...
  MessageListInstance._uri = _.template(
    '/Sessions/<%= sessionSid %>/Messages' // jshint ignore:line
   ...
   * @param {string} [opts.body] - The contents of the message.
 ...
 * @property {string} sessionSid - The unique id of the Session for this message.
 * @property {string} sid -
 *          A 34 character string that uniquely identifies this resource.
 ...
 * @param {sid} sessionSid - The unique id of the Session for this message.
...
MessageContext = function MessageContext(version, sessionSid, sid) {
  ...
  this._uri = _.template(
    '/Sessions/<%= sessionSid %>/Messages/<%= sid %>' // jshint ignore:line
  )(this._solution);
};
