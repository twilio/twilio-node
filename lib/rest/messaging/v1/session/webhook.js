...
WebhookList = function WebhookList(version, sessionSid) {
   ...
   *
   * @returns {Twilio.Messaging.V1.SessionContext.WebhookContext}
   */
  /* jshint ignore:end */
  ...
  // Path Solution
  WebhookListInstance._solution = {sessionSid: sessionSid};
  WebhookListInstance._uri = `/Sessions/${sessionSid}/Webhooks`;
  /* jshint ignore:start */
  /**
   ...
   *
   * @function each
   * @memberof Twilio.Messaging.V1.SessionContext.WebhookList#
   *
   ...
   *
   * @param {object} opts - Options for request
   * @param {webhook.target} opts.target - The target of the webhook
   ...
   * @param {boolean} [opts.configuration.bufferMessages] -
   *          Whether buffering should be applied to messages
   * @param {number} [opts.configuration.bufferWindow] -
  ...
  WebhookListInstance.create = function create(opts, callback) {
    ...
    var data = values.of({
      ...
      'Configuration.BufferMessages': serialize.bool(_.get(opts, 'configuration.bufferMessages')),
      'Configuration.BufferWindow': _.get(opts, 'configuration.bufferWindow')
    });
  ...
  WebhookListInstance.get = function get(sid) {
    return new WebhookContext(this._version, this._solution.sessionSid, sid);
  };
 ...
 * access, please contact help@twilio.com.
 *
 * @constructor Twilio.Messaging.V1.SessionContext.WebhookPage
 *
 ...
 * @memberof Twilio.Messaging.V1.SessionContext.WebhookPage#
 *
...
WebhookPage.prototype.getInstance = function getInstance(payload) {
  return new WebhookInstance(this._version, payload, this._solution.sessionSid);
};
 ...
 * access, please contact help@twilio.com.
 *
 * @constructor Twilio.Messaging.V1.SessionContext.WebhookInstance
 *
 * @property {string} sid - The unique string that identifies the resource
 * @property {string} accountSid - The SID of the Account that created the resource
 * @property {string} sessionSid - The SID of the Session for the webhook
 * @property {string} target - The target of the webhook
 * @property {string} url - The absolute URL of the webhook
 * @property {object} configuration - The configuration of the webhook
 ...
 * @param {sid} sessionSid - The SID of the Session for the webhook
 * @param {sid} sid - The SID of the resource to fetch
 */
/* jshint ignore:end */
WebhookInstance = function WebhookInstance(version, payload, sessionSid, sid) {
...
Object.defineProperty(WebhookInstance.prototype,
  ...
  get: function() {
    if (!this._context) {
      this._context = new WebhookContext(this._version, this._solution.sessionSid, this._solution.sid);
    }
 ...
 *
 * @function fetch
 * @memberof Twilio.Messaging.V1.SessionContext.WebhookInstance#
 *
 * @param {function} [callback] - Callback to handle processed record
 *
 * @returns {Promise} Resolves to processed WebhookInstance
 ...
 * access, please contact help@twilio.com.
 *
 * @constructor Twilio.Messaging.V1.SessionContext.WebhookContext
 *
 * @param {V1} version - Version of the resource
 * @param {sid} sessionSid -
 *          The SID of the Session with the Webhook resource to fetch
 * @param {sid} sid - The SID of the resource to fetch
 */
/* jshint ignore:end */
WebhookContext = function WebhookContext(version, sessionSid, sid) {
  this._version = version;

  // Path Solution
  this._solution = {sessionSid: sessionSid, sid: sid, };
  this._uri = `/Sessions/${sessionSid}/Webhooks/${sid}`;
};
 ...
 *
 * @function fetch
 * @memberof Twilio.Messaging.V1.SessionContext.WebhookContext#
 *
 * @param {function} [callback] - Callback to handle processed record
 *
 * @returns {Promise} Resolves to processed WebhookInstance
