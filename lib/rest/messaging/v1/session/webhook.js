...
WebhookList = function WebhookList(version, sessionSid) {
  ...
  WebhookListInstance._uri = _.template(
    '/Sessions/<%= sessionSid %>/Webhooks' // jshint ignore:line
 ...
 * @property {string} sessionSid - The unique id of the Session for this webhook.
 * @property {string} target - The target of this webhook.
 * @property {string} url - An absolute URL for this webhook.
 * @property {string} configuration - The configuration of this webhook.
 ...
 * @param {sid} sessionSid - The unique id of the Session for this webhook.
...
WebhookContext = function WebhookContext(version, sessionSid, sid) {
  ...
  this._uri = _.template(
    '/Sessions/<%= sessionSid %>/Webhooks/<%= sid %>' // jshint ignore:line
  )(this._solution);
};
