 ...
 *
 * @constructor Twilio.Messaging.V1.SessionContext.ParticipantList
 *
 ...
 */
/* jshint ignore:end */
ParticipantList = function ParticipantList(version, sessionSid) {
  /* jshint ignore:start */
  /**
   ...
   *
   * @returns {Twilio.Messaging.V1.SessionContext.ParticipantContext}
   */
  /* jshint ignore:end */
  ...
  // Path Solution
  ParticipantListInstance._solution = {sessionSid: sessionSid};
  ParticipantListInstance._uri = `/Sessions/${sessionSid}/Participants`;
  /* jshint ignore:start */
  /**
   * create a ParticipantInstance
   *
   * @function create
   * @memberof Twilio.Messaging.V1.SessionContext.ParticipantList#
   *
   ...
   * @param {string} [opts.userAddress] - The address of the participant's device
  ...
  ParticipantListInstance.get = function get(sid) {
    return new ParticipantContext(this._version, this._solution.sessionSid, sid);
  };
 ...
 * access, please contact help@twilio.com.
 *
 * @constructor Twilio.Messaging.V1.SessionContext.ParticipantPage
 *
 ...
 * @memberof Twilio.Messaging.V1.SessionContext.ParticipantPage#
 *
...
ParticipantPage.prototype.getInstance = function getInstance(payload) {
  return new ParticipantInstance(this._version, payload, this._solution.sessionSid);
};
 ...
 * access, please contact help@twilio.com.
 *
 * @constructor Twilio.Messaging.V1.SessionContext.ParticipantInstance
 *
 * @property {string} accountSid - The SID of the Account that created the resource
 * @property {string} serviceSid - The SID of the Service the session belongs to
 * @property {string} messagingServiceSid -
 *          The SID of the SMS Service the session belongs to
 * @property {string} sessionSid - The SID of the Session for the participant
 * @property {string} sid - The unique string that identifies the resource
 * @property {string} identity - The string that identifies the resource's User
 * @property {string} twilioAddress -
 *          The address of the Twilio phone number that the participant is in contact with
 * @property {string} userAddress - The address of the participant's device
 * @property {string} attributes -
 *          The JSON string that stores application-specific data
 * @property {participant.participant_type} type -
 *          The type of messaging used by the participant
 * @property {Date} dateCreated -
 *          The ISO 8601 date and time in GMT when the resource was created
 * @property {Date} dateUpdated -
 *          The ISO 8601 date and time in GMT when the resource was last updated
 * @property {string} url - The absolute URL of the participant
 *
 * @param {V1} version - Version of the resource
 * @param {ParticipantPayload} payload - The instance payload
 * @param {sid} sessionSid - The SID of the Session for the participant
 * @param {sid_like} sid - The SID that identifies the resource to fetch
 */
/* jshint ignore:end */
ParticipantInstance = function ParticipantInstance(version, payload, sessionSid,
                                                    sid) {
  ...
  this.twilioAddress = payload.twilio_address; // jshint ignore:line
  this.userAddress = payload.user_address; // jshint ignore:line
  ...
  this._solution = {sessionSid: sessionSid, sid: sid || this.sid, };
};
 ...
 *
 * @function update
 * @memberof Twilio.Messaging.V1.SessionContext.ParticipantInstance#
 *
 * @param {object} [opts] - Options for request
 * @param {string} [opts.attributes] -
 *          A JSON string that stores application-specific data
 ...
 * access, please contact help@twilio.com.
 *
 * @constructor Twilio.Messaging.V1.SessionContext.ParticipantContext
 *
 * @param {V1} version - Version of the resource
 * @param {sid} sessionSid - The SID of the Session with the participant to fetch
 * @param {sid_like} sid - The SID that identifies the resource to fetch
 */
/* jshint ignore:end */
ParticipantContext = function ParticipantContext(version, sessionSid, sid) {
  this._version = version;

  // Path Solution
  this._solution = {sessionSid: sessionSid, sid: sid, };
  this._uri = `/Sessions/${sessionSid}/Participants/${sid}`;
};
 ...
 *
 * @function update
 * @memberof Twilio.Messaging.V1.SessionContext.ParticipantContext#
 *
 * @param {object} [opts] - Options for request
 * @param {string} [opts.attributes] -
 *          A JSON string that stores application-specific data
