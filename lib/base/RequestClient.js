...
RequestClient.prototype.request = function(opts) {
  ...
  var options = {
    ...
    agent: opts.forever === true ? new Agent({keepAlive: true}) : undefined,
  };
  ...
  if (!_.isNull(opts.data)) {
    ...
    options.allowGetBody = options.method === 'GET';
  }

  if (!_.isNull(opts.params)) {
    options.searchParams = queryString.stringify(opts.params);
  }
