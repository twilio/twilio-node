...
function debugLogRequest(options) {
  ...
  console.log(`${options.config.method} ${options.config.url}`);
  ...
  if (customHeaders) {
    ...
    customHeaders.forEach((header) => console.log(`${header}: ${options.headers[header]}`));
  }
