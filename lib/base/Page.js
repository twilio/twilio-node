...
Page.prototype.nextPage = function() {
  ...
  var constuctor = this.constructor;
  var version = this._version;
  var solution = this._solution;

  var promise = version._domain.twilio.request({
    method: 'GET', 
    uri: this.nextPageUrl
  });

  promise = promise.then(function(response) {
    return new constuctor(version, response, solution);
  });
...
Page.prototype.previousPage = function() {
  ...
  promise.then(function(response) {
    return new constructor(this._version, response, this._solution);
  });
