...
module.exports.prefixedCollapsibleMap = function(m, prefix) {
  if (!m || typeof m !== 'object' || m.__proto__ !== Object.prototype) {
    return {};
  }
  ...
  function flatten(m, result, previous) {
    ...
    Object.keys(m).forEach((key) => {
      ...
      if (typeof m[key] === 'object' && Object.getPrototypeOf(m[key]) !== Object.getPrototypeOf(Object)) {
...
module.exports.map = function(input, transform) {
  if (typeof input === 'array' || (typeof input === 'object' && Object.prototype.toString.call(input) === '[object Array]')) {
