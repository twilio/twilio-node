 ...
 */
Client.prototype.getCallList = function(filters, suc, err) {
 ...
 */
Client.prototype.getCallInstance = function(sid, suc, err) {
    if(!sid) {
        throw new Error('Sid argument required');
    }
 ...
 */
Client.prototype.makeCall = function(from, to, url, opts, suc, err) {
    if(!from || !to || !url) {
 ...
 */
Client.prototype.sendSms = function(from, to, body, uri, suc, err) {
    if(!from || !to || !body) {
 ...
 */
Client.prototype.getRecordingUri = function(sid, encoding, suc, err) {
    if(!sid) {
        throw new Error('Sid argument required');
    }
 ...
 */
Client.prototype.getRecordingList = function(filters, suc, err) {
 ...
 */
Client.prototype.getTranscriptionList = function(suc, err) {
 ...
 */
Client.prototype.getTranscriptionInstance = function(sid, suc, err) {
    if(!sid) {
        throw new Error('Sid argument required');
    }
 ...
 * @param {String} sid: The transcription sid.
 */
Client.prototype.getTranscriptionText = function(sid, suc, err) {
    if(!sid) {
        throw new Error('Sid argument required');
    }
 ...
 */
Client.prototype.getNotificationList = function(filters, suc, err) {
 ...
 */
Client.prototype.getNotificationInstance = function(sid, suc, err) {
    if(!sid) {
        throw new Error('Sid argument required');
    }
 ...
 */
Client.prototype.deleteNotification = function(sid, suc, err) {
    if(!sid) {
        throw new Error('Sid argument required');
    }
...
Client.prototype.addIncomingCallCallback = function(incomingNumber, callback) {
    ...
    if(!self.expressApp) {
        ...
        self.expressApp.use(express.bodyDecoder());
        self.expressApp.use(express.logger());
...
Client.prototype.getGenericCallbackUri = function(callback) {
    var self = this;
    this.gathers = this.gathers || 0;
    ...
    var url = 'http://' + self.hostname + ':' + self.port + '/gather/' + this.gathers;
    self.expressApp.post('/gather/' + this.gathers, callback);
