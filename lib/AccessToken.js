 ...
 * @param {string} options.roleSid - SID of the deployment role to be
 *                 assigned to the user
 * @param {string} options.credentialSid - The Push Credentials SID
 */
function IpMessagingGrant(options) {
  options = options || {};
  this.serviceSid = options.serviceSid;
  this.endpointId = options.endpointId;
  this.roleSid = options.roleSid;
...
_.extend(IpMessagingGrant.prototype, {
  ...
  toPayload: function() {
    ...
    if (this.roleSid) {
      grant.deployment_role_sid = this.roleSid;
    }
    if (this.credentialSid) {
      grant.push_credential_sid = this.credentialSid;
    }
    return grant;
  }
});
 ...
 *                 profile unique ID
 */
function ConversationGrant(options) {
  options = options || {};
  this.configurationProfileSid = options.configurationProfileSid;
}

_.extend(ConversationGrant.prototype, {
  key: 'rtc',
  toPayload: function() {
    var grant = {};
...
AccessToken.ConversationGrant = ConversationGrant;
