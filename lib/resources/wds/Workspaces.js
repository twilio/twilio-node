/**
 @module resources/wds/Workspaces
 The Twilio WDS "Workspaces" Resource.
 */
var _ = require('underscore');
var generate = require('../generate');

module.exports = function (client) {
    var baseResourceUrl = '/Accounts/' + client.accountSid + '/Workspaces';

//    //Define sub-resources on the accounts resource, with the given account SID
//    function mixinResources(obj, workspaceSid) {
//        var subresources = {
//            statistics:require('./Statistics')(client, workspaceSid)
//        };
//
...
//    }
    ...
    function Workspaces(sid) {
        ...
        resourceApi.taskQueues = function(taskQueueSid) {
            ...
            taskQueueResourceApi.statistics.get = generate(client, 'GET', baseResourceUrl + '/' + sid + '/Statistics/TaskQueues/' + taskQueueSid);
        ...
        resourceApi.taskQueues.statistics.get = generate(client, 'GET', baseResourceUrl + '/' + sid + '/Statistics/TaskQueues');
        ...
        resourceApi.workers = function(workerSid) {
            ...
            workerResourceApi.statistics.get = generate(client, 'GET', baseResourceUrl + '/' + sid + '/Statistics/Workers/' + workerSid);
        ...
        resourceApi.workers.statistics.get = generate(client, 'GET', baseResourceUrl + '/' + sid + '/Statistics/Workers');
        ...
        resourceApi.workflows = function(workflowSid) {
            ...
            workflowResourceApi.statistics.get = generate(client, 'GET', baseResourceUrl + '/' + sid + '/Statistics/Workflows/' + workflowSid);
    ...
    //Define other sub-resources of Workspaces
//    mixinResources(Workspaces, client.workspaceSid);
