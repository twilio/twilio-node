...
function WorkflowRuleTarget(options) {
    ...
    if (!options.queue) { throw new Error('queue for WorkflowRuleTarget is required'); }
...
function WorkflowRule(options) {
    ...
    if (!options.expression) { throw new Error('expression for WorkflowRule is required'); }
    if (!options.targets) { throw new Error('targets for WorkflowRule is required'); }
