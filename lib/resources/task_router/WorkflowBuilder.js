    ...
    fromJSON: function(jsonObj) {
        ...
        for (var property in workflowConfigurationObj) {
            ...
            if (property == "default_filter") {
                var defaultFilter = workflowConfigurationObj['default_filter'];
                var queueDefaultFilter = defaultFilter.queue;
                var expressionDefaultFilter = defaultFilter.expression;
                var priorityDefaultFilter = defaultFilter.priority;
                var timeoutDefaultFilter = defaultFilter.timeout;
            ...
            if (property == "filters") {
                ...
                for (var workflowRuleIdx in workflowConfigurationObj['filters']) {
                    ...
                    var friendlyName = workflowRule.friendly_name;
                    var targets = [];
