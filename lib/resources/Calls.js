...
module.exports = function (client, accountSid) {
    ...
    Calls.feedbackSummary = function(feedbackSummarySid) {
        var feedbackSummaryResourceApi = {
            get: generate(client, 'GET', baseResourceUrl + '/FeedbackSummary/' + feedbackSummarySid),
            delete: generate(client, 'DELETE', baseResourceUrl + '/FeedbackSummary/' + feedbackSummarySid)
        };

        return feedbackSummaryResourceApi;
    };

    Calls.feedbackSummary.post = generate(client, 'POST', baseResourceUrl + '/FeedbackSummary');
    Calls.feedbackSummary.create = Calls.feedbackSummary.post;
