...
export class ModularTwilioClient extends Client {
  ...
  constructor(username?: string, password?: string, opts?: ModularClientOptions) {
  ...
  get api(): import("../rest/Api") {
    ...
    if (!this._api) {
      throw new Error('API service not enabled. Add "api" to services array in client options.');
    }
    return this._api;
  }
  ...
  get messaging(): import("../rest/Messaging") {
    ...
    if (!this._messaging) {
      throw new Error('Messaging service not enabled. Add "messaging" to services array in client options.');
    }
  ...
  get voice(): import("../rest/Voice") {
    ...
    if (!this._voice) {
      throw new Error('Voice service not enabled. Add "voice" to services array in client options.');
    }
    return this._voice;
  }
  ...
  get verify(): import("../rest/Verify") {
    ...
    if (!this._verify) {
      throw new Error('Verify service not enabled. Add "verify" to services array in client options.');
    }
    return this._verify;
  }
  ...
  get lookups(): import("../rest/Lookups") {
    ...
    if (!this._lookups) {
      throw new Error('Lookups service not enabled. Add "lookups" to services array in client options.');
    }
  ...
  get conversations(): import("../rest/Conversations") {
    ...
    if (!this._conversations) {
      throw new Error('Conversations service not enabled. Add "conversations" to services array in client options.');
    }
  ...
  get video(): import("../rest/Video") {
    ...
    if (!this._video) {
      throw new Error('Video service not enabled. Add "video" to services array in client options.');
    }
    return this._video;
  }
  ...
  get sync(): import("../rest/Sync") {
    ...
    if (!this._sync) {
      throw new Error('Sync service not enabled. Add "sync" to services array in client options.');
    }
    return this._sync;
  }
  ...
  private _shouldLoadService(serviceName: string): boolean {
    ...
    return this._requestedServices.includes(serviceName as keyof ModularTwilioClient);
  }
