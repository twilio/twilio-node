...
export class RateLimitContextImpl implements RateLimitContext {
  ...
  get buckets(): BucketListInstance {
    this._buckets = this._buckets || BucketListInstance(this._version, this._solution.serviceSid, this._solution.sid);
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<RateLimitInstance>) => any): Promise<ApiResponse<RateLimitInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<RateLimitResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<RateLimitInstance> => ({
      ...response,
  ...
  updateWithHttpInfo(params?: RateLimitContextUpdateOptions | ((error: Error | null, item?: ApiResponse<RateLimitInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<RateLimitInstance>) => any): Promise<ApiResponse<RateLimitInstance>> {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.updateWithResponseInfo<RateLimitResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<RateLimitInstance> => ({
      ...response,
      body: new RateLimitInstance(operationVersion, response.body, instance._solution.serviceSid, instance._solution.sid)
    }));
...
export class RateLimitInstance {
  ...
  constructor(protected _version: V2, payload: RateLimitResource, serviceSid: string, sid?: string) {
  ...
  updateWithHttpInfo(params: RateLimitContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<RateLimitInstance>) => any): Promise<ApiResponse<RateLimitInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<RateLimitInstance>) => any): Promise<ApiResponse<RateLimitInstance>>
    {
...
export function RateLimitListInstance(version: V2, serviceSid: string): RateLimitListInstance {
  if (!isValidPathParam(serviceSid)) {
    throw new Error('Parameter \'serviceSid\' is not valid.');
  }
  ...
  instance.create = function create(params: RateLimitListInstanceCreateOptions, callback?: (error: Error | null, items: RateLimitInstance) => any): Promise<RateLimitInstance> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: RateLimitListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<RateLimitInstance>) => any): Promise<ApiResponse<RateLimitInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<RateLimitResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<RateLimitInstance> => ({
      ...response,
  ...
  instance.page = function page(params?: RateLimitListInstancePageOptions | ((error: Error | null, items: RateLimitPage) => any), callback?: (error: Error | null, items: RateLimitPage) => any): Promise<RateLimitPage> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: RateLimitPage) => any): Promise<RateLimitPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: RateLimitListInstancePageOptions | ((error: Error | null, items: ApiResponse<RateLimitPage>) => any), callback?: (error: Error | null, items: ApiResponse<RateLimitPage>) => any): Promise<ApiResponse<RateLimitPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<RateLimitPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<RateLimitPage>) => any): Promise<ApiResponse<RateLimitPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<RateLimitPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
