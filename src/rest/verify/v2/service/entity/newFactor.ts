...
export function NewFactorListInstance(version: V2, serviceSid: string, identity: string): NewFactorListInstance {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: NewFactorListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<NewFactorInstance>) => any): Promise<ApiResponse<NewFactorInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
