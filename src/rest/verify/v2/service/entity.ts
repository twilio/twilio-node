...
export class EntityContextImpl implements EntityContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<EntityInstance>) => any): Promise<ApiResponse<EntityInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<EntityResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<EntityInstance> => ({
      ...response,
...
export function EntityListInstance(version: V2, serviceSid: string): EntityListInstance {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: EntityListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<EntityInstance>) => any): Promise<ApiResponse<EntityInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<EntityResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<EntityInstance> => ({
      ...response,
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: EntityListInstancePageOptions | ((error: Error | null, items: ApiResponse<EntityPage>) => any), callback?: (error: Error | null, items: ApiResponse<EntityPage>) => any): Promise<ApiResponse<EntityPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<EntityPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<EntityPage>) => any): Promise<ApiResponse<EntityPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<EntityPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
