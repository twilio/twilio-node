...
export class AccessTokenContextImpl implements AccessTokenContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<AccessTokenInstance>) => any): Promise<ApiResponse<AccessTokenInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<AccessTokenResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<AccessTokenInstance> => ({
      ...response,
...
export class AccessTokenInstance {
  ...
  constructor(protected _version: V2, payload: AccessTokenResource, serviceSid: string, sid?: string) {
...
export function AccessTokenListInstance(version: V2, serviceSid: string): AccessTokenListInstance {
  ...
  instance.create = function create(params: AccessTokenListInstanceCreateOptions, callback?: (error: Error | null, items: AccessTokenInstance) => any): Promise<AccessTokenInstance> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: AccessTokenListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<AccessTokenInstance>) => any): Promise<ApiResponse<AccessTokenInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<AccessTokenResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<AccessTokenInstance> => ({
      ...response,
