...
export function ConversationWithParticipantsListInstance(version: V1, chatServiceSid: string): ConversationWithParticipantsListInstance {
...
export class ConversationWithParticipantsInstance {
  ...
  constructor(protected _version: V1, payload: ConversationWithParticipantsResource, chatServiceSid: string) {
