...
export class ConferenceParticipantContextImpl implements ConferenceParticipantContext {
  ...
  fetchWithHttpInfo(params?: ConferenceParticipantContextFetchOptions | ((error: Error | null, item?: ApiResponse<ConferenceParticipantInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<ConferenceParticipantInstance>) => any): Promise<ApiResponse<ConferenceParticipantInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<ConferenceParticipantResource>({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<ConferenceParticipantInstance> => ({
      ...response,
...
export class ConferenceParticipantInstance {
  ...
  constructor(protected _version: V1, payload: ConferenceParticipantResource, conferenceSid: string, participantSid?: string) {
  ...
  fetch(params: ConferenceParticipantContextFetchOptions, callback?: (error: Error | null, item?: ConferenceParticipantInstance) => any): Promise<ConferenceParticipantInstance>;
    ...
    fetch(params?: any, callback?: (error: Error | null, item?: ConferenceParticipantInstance) => any): Promise<ConferenceParticipantInstance>
    {
  ...
  fetchWithHttpInfo(params: ConferenceParticipantContextFetchOptions, callback?: (error: Error | null, item?: ApiResponse<ConferenceParticipantInstance>) => any): Promise<ApiResponse<ConferenceParticipantInstance>>;
    ...
    fetchWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<ConferenceParticipantInstance>) => any): Promise<ApiResponse<ConferenceParticipantInstance>>
    {
...
export function ConferenceParticipantListInstance(version: V1, conferenceSid: string): ConferenceParticipantListInstance {
  ...
  const instance = ((participantSid, ) => instance.get(participantSid, )) as ConferenceParticipantListInstance;
  ...
  instance.page = function page(params?: ConferenceParticipantListInstancePageOptions | ((error: Error | null, items: ConferenceParticipantPage) => any), callback?: (error: Error | null, items: ConferenceParticipantPage) => any): Promise<ConferenceParticipantPage> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: ConferenceParticipantPage) => any): Promise<ConferenceParticipantPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: ConferenceParticipantListInstancePageOptions | ((error: Error | null, items: ApiResponse<ConferenceParticipantPage>) => any), callback?: (error: Error | null, items: ApiResponse<ConferenceParticipantPage>) => any): Promise<ApiResponse<ConferenceParticipantPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<ConferenceParticipantPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<ConferenceParticipantPage>) => any): Promise<ApiResponse<ConferenceParticipantPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<ConferenceParticipantPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
