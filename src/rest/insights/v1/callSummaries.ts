...
export function CallSummariesListInstance(version: V1): CallSummariesListInstance {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: CallSummariesListInstancePageOptions | ((error: Error | null, items: ApiResponse<CallSummariesPage>) => any), callback?: (error: Error | null, items: ApiResponse<CallSummariesPage>) => any): Promise<ApiResponse<CallSummariesPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<CallSummariesPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<CallSummariesPage>) => any): Promise<ApiResponse<CallSummariesPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<CallSummariesPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
