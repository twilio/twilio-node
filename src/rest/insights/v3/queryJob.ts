...
/**
 * The error details for a failed operation, embedded inside a 200 OK operation envelope.
 */
...
export class QueryJobContextImpl implements QueryJobContext {
  ...
  fetchWithHttpInfo(
    ...
    let operationPromise = operationVersion
      .fetchWithResponseInfo<QueryJobResource>({
        uri: instance._uri,
        method: "get",
        headers,
      })
 ...
 */
type QueryJobResource =
  | QueryJobStatusResponse_ResponseResource
  | QueryJobSubmitResponse_ResponseResource;
...
export function QueryJobListInstance(version: V3): QueryJobListInstance {
  const instance = ((operationId) =>
    instance.get(operationId)) as QueryJobListInstance;
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(
    ...
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion
      .createWithResponseInfo<QueryJobResource>({
        uri: instance._uri,
        method: "post",
        data,
        headers,
...
export class QueryJobPage extends TokenPage<
  V3,
  QueryJobPayload,
  QueryJobResource,
  QueryJobInstance
