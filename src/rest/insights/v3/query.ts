...
export function QueryListInstance(version: V3): QueryListInstance {
  ...
  instance.create = function create(params: InsightsQueryRequest, headers?: any, callback?: (error: Error | null, items: QueryInstance) => any): Promise<QueryInstance> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: InsightsQueryRequest, headers?: any, callback?: (error: Error | null, items: ApiResponse<QueryInstance>) => any): Promise<ApiResponse<QueryInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationPromise = operationVersion.createWithResponseInfo<QueryResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<QueryInstance> => ({
      ...response,
  ...
  instance.fetch = function fetch(params: QueryListInstanceFetchOptions, callback?: (error: Error | null, items: QueryInstance) => any): Promise<QueryInstance> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
  ...
  instance.fetchWithHttpInfo = function fetchWithHttpInfo(params: QueryListInstanceFetchOptions, callback?: (error: Error | null, items: ApiResponse<QueryInstance>) => any): Promise<ApiResponse<QueryInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.fetchWithResponseInfo<QueryResource>({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<QueryInstance> => ({
      ...response,
      body: new QueryInstance(operationVersion, response.body)
    }));
