...
export class AccountSecretInstance {
  ...
  constructor(protected _version: V1, payload: AccountSecretResource, key?: string) {
  ...
  private get _proxy(): AccountSecretContext {
    this._context = this._context || new AccountSecretContextImpl(this._version, this._solution.key);
  ...
  update(params: AccountSecretContextUpdateOptions, callback?: (error: Error | null, item?: AccountSecretInstance) => any): Promise<AccountSecretInstance>;
    ...
    update(params?: any, callback?: (error: Error | null, item?: AccountSecretInstance) => any): Promise<AccountSecretInstance>
    {
...
export function AccountSecretListInstance(version: V1): AccountSecretListInstance {
  ...
  instance.create = function create(params: AccountSecretListInstanceCreateOptions, callback?: (error: Error | null, items: AccountSecretInstance) => any): Promise<AccountSecretInstance> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
  ...
  instance.page = function page(params?: AccountSecretListInstancePageOptions | ((error: Error | null, items: AccountSecretPage) => any), callback?: (error: Error | null, items: AccountSecretPage) => any): Promise<AccountSecretPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: AccountSecretPage) => any): Promise<AccountSecretPage> {
...
export class AccountSecretPage extends Page<V1, AccountSecretPayload, AccountSecretResource, AccountSecretInstance> {
/**
