...
export class DeviceContextImpl implements DeviceContext {
  ...
  get deviceConfigs(): DeviceConfigListInstance {
    this._deviceConfigs = this._deviceConfigs || DeviceConfigListInstance(this._version, this._solution.sid);
    return this._deviceConfigs;
  }

  get deviceSecrets(): DeviceSecretListInstance {
    this._deviceSecrets = this._deviceSecrets || DeviceSecretListInstance(this._version, this._solution.sid);
...
export class DeviceInstance {
  ...
  private get _proxy(): DeviceContext {
    this._context = this._context || new DeviceContextImpl(this._version, this._solution.sid);
