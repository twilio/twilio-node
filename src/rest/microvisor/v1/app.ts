...
export class AppContextImpl implements AppContext {
  ...
  get appManifests(): AppManifestListInstance {
    this._appManifests = this._appManifests || AppManifestListInstance(this._version, this._solution.sid);
...
export function AppListInstance(version: V1): AppListInstance {
  ...
  instance.page = function page(params?: AppListInstancePageOptions | ((error: Error | null, items: AppPage) => any), callback?: (error: Error | null, items: AppPage) => any): Promise<AppPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: AppPage) => any): Promise<AppPage> {
