...
export class EndUserContextImpl implements EndUserContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<EndUserInstance>) => any): Promise<ApiResponse<EndUserInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<EndUserResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<EndUserInstance> => ({
      ...response,
  ...
  updateWithHttpInfo(params?: EndUserContextUpdateOptions | ((error: Error | null, item?: ApiResponse<EndUserInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<EndUserInstance>) => any): Promise<ApiResponse<EndUserInstance>> {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.updateWithResponseInfo<EndUserResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<EndUserInstance> => ({
      ...response,
      body: new EndUserInstance(operationVersion, response.body, instance._solution.sid)
    }));
...
export class EndUserInstance {
  ...
  update(params: EndUserContextUpdateOptions, callback?: (error: Error | null, item?: EndUserInstance) => any): Promise<EndUserInstance>;
    ...
    update(params?: any, callback?: (error: Error | null, item?: EndUserInstance) => any): Promise<EndUserInstance>
    {
  ...
  updateWithHttpInfo(params: EndUserContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<EndUserInstance>) => any): Promise<ApiResponse<EndUserInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<EndUserInstance>) => any): Promise<ApiResponse<EndUserInstance>>
    {
...
export function EndUserListInstance(version: V2): EndUserListInstance {
  ...
  instance.create = function create(params: EndUserListInstanceCreateOptions, callback?: (error: Error | null, items: EndUserInstance) => any): Promise<EndUserInstance> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: EndUserListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<EndUserInstance>) => any): Promise<ApiResponse<EndUserInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<EndUserResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<EndUserInstance> => ({
      ...response,
  ...
  instance.page = function page(params?: EndUserListInstancePageOptions | ((error: Error | null, items: EndUserPage) => any), callback?: (error: Error | null, items: EndUserPage) => any): Promise<EndUserPage> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: EndUserPage) => any): Promise<EndUserPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: EndUserListInstancePageOptions | ((error: Error | null, items: ApiResponse<EndUserPage>) => any), callback?: (error: Error | null, items: ApiResponse<EndUserPage>) => any): Promise<ApiResponse<EndUserPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<EndUserPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<EndUserPage>) => any): Promise<ApiResponse<EndUserPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<EndUserPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
