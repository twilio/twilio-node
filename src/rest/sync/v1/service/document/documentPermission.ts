...
export class DocumentPermissionContextImpl implements DocumentPermissionContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<DocumentPermissionInstance>) => any): Promise<ApiResponse<DocumentPermissionInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<DocumentPermissionResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<DocumentPermissionInstance> => ({
      ...response,
  ...
  updateWithHttpInfo(params: DocumentPermissionContextUpdateOptions,callback?: (error: Error | null, item?: ApiResponse<DocumentPermissionInstance>) => any): Promise<ApiResponse<DocumentPermissionInstance>> {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.updateWithResponseInfo<DocumentPermissionResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<DocumentPermissionInstance> => ({
      ...response,
      body: new DocumentPermissionInstance(operationVersion, response.body, instance._solution.serviceSid, instance._solution.documentSid, instance._solution.identity)
    }));
...
export class DocumentPermissionInstance {
  ...
  constructor(protected _version: V1, payload: DocumentPermissionResource, serviceSid: string, documentSid: string, identity?: string) {
  ...
  update(params: DocumentPermissionContextUpdateOptions, callback?: (error: Error | null, item?: DocumentPermissionInstance) => any): Promise<DocumentPermissionInstance>;
    ...
    update(params?: any, callback?: (error: Error | null, item?: DocumentPermissionInstance) => any): Promise<DocumentPermissionInstance>
    {
  ...
  updateWithHttpInfo(params: DocumentPermissionContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<DocumentPermissionInstance>) => any): Promise<ApiResponse<DocumentPermissionInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<DocumentPermissionInstance>) => any): Promise<ApiResponse<DocumentPermissionInstance>>
    {
...
export function DocumentPermissionListInstance(version: V1, serviceSid: string, documentSid: string): DocumentPermissionListInstance {
  ...
  const instance = ((identity, ) => instance.get(identity, )) as DocumentPermissionListInstance;
  ...
  instance.page = function page(params?: DocumentPermissionListInstancePageOptions | ((error: Error | null, items: DocumentPermissionPage) => any), callback?: (error: Error | null, items: DocumentPermissionPage) => any): Promise<DocumentPermissionPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: DocumentPermissionPage) => any): Promise<DocumentPermissionPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: DocumentPermissionListInstancePageOptions | ((error: Error | null, items: ApiResponse<DocumentPermissionPage>) => any), callback?: (error: Error | null, items: ApiResponse<DocumentPermissionPage>) => any): Promise<ApiResponse<DocumentPermissionPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<DocumentPermissionPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<DocumentPermissionPage>) => any): Promise<ApiResponse<DocumentPermissionPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<DocumentPermissionPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
