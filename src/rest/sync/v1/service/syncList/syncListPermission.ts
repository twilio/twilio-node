...
export class SyncListPermissionContextImpl implements SyncListPermissionContext {
  ...
  constructor(protected _version: V1, serviceSid: string, listSid: string, identity: string) {
  ...
  updateWithHttpInfo(params: SyncListPermissionContextUpdateOptions,callback?: (error: Error | null, item?: ApiResponse<SyncListPermissionInstance>) => any): Promise<ApiResponse<SyncListPermissionInstance>> {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.updateWithResponseInfo<SyncListPermissionResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<SyncListPermissionInstance> => ({
      ...response,
      body: new SyncListPermissionInstance(operationVersion, response.body, instance._solution.serviceSid, instance._solution.listSid, instance._solution.identity)
    }));
...
export class SyncListPermissionInstance {
  ...
  constructor(protected _version: V1, payload: SyncListPermissionResource, serviceSid: string, listSid: string, identity?: string) {
  ...
  update(params: SyncListPermissionContextUpdateOptions, callback?: (error: Error | null, item?: SyncListPermissionInstance) => any): Promise<SyncListPermissionInstance>;
    ...
    update(params?: any, callback?: (error: Error | null, item?: SyncListPermissionInstance) => any): Promise<SyncListPermissionInstance>
    {
  ...
  updateWithHttpInfo(params: SyncListPermissionContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<SyncListPermissionInstance>) => any): Promise<ApiResponse<SyncListPermissionInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<SyncListPermissionInstance>) => any): Promise<ApiResponse<SyncListPermissionInstance>>
    {
...
export function SyncListPermissionListInstance(version: V1, serviceSid: string, listSid: string): SyncListPermissionListInstance {
  if (!isValidPathParam(serviceSid)) {
    throw new Error('Parameter \'serviceSid\' is not valid.');
  }
  ...
  const instance = ((identity, ) => instance.get(identity, )) as SyncListPermissionListInstance;
  ...
  instance.page = function page(params?: SyncListPermissionListInstancePageOptions | ((error: Error | null, items: SyncListPermissionPage) => any), callback?: (error: Error | null, items: SyncListPermissionPage) => any): Promise<SyncListPermissionPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: SyncListPermissionPage) => any): Promise<SyncListPermissionPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: SyncListPermissionListInstancePageOptions | ((error: Error | null, items: ApiResponse<SyncListPermissionPage>) => any), callback?: (error: Error | null, items: ApiResponse<SyncListPermissionPage>) => any): Promise<ApiResponse<SyncListPermissionPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<SyncListPermissionPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<SyncListPermissionPage>) => any): Promise<ApiResponse<SyncListPermissionPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<SyncListPermissionPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
