...
export class PhoneNumberContextImpl implements PhoneNumberContext {
  ...
  fetchWithHttpInfo(params?: PhoneNumberContextFetchOptions | ((error: Error | null, item?: ApiResponse<PhoneNumberInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<PhoneNumberInstance>) => any): Promise<ApiResponse<PhoneNumberInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<PhoneNumberResource>({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<PhoneNumberInstance> => ({
      ...response,
...
export class PhoneNumberInstance {
  ...
  constructor(protected _version: V2, payload: PhoneNumberResource, phoneNumber?: string) {
    ...
    this.callerName = payload.caller_name !== null && payload.caller_name !== undefined ? new CallerNameInfo(payload.caller_name) : null;
    this.simSwap = payload.sim_swap !== null && payload.sim_swap !== undefined ? new SimSwapInfo(payload.sim_swap) : null;
    this.callForwarding = payload.call_forwarding !== null && payload.call_forwarding !== undefined ? new CallForwardingInfo(payload.call_forwarding) : null;
    this.lineTypeIntelligence = payload.line_type_intelligence !== null && payload.line_type_intelligence !== undefined ? new LineTypeIntelligenceInfo(payload.line_type_intelligence) : null;
    this.lineStatus = payload.line_status !== null && payload.line_status !== undefined ? new LineStatusInfo(payload.line_status) : null;
    this.identityMatch = payload.identity_match !== null && payload.identity_match !== undefined ? new IdentityMatchInfo(payload.identity_match) : null;
    this.reassignedNumber = payload.reassigned_number !== null && payload.reassigned_number !== undefined ? new ReassignedNumberInfo(payload.reassigned_number) : null;
    this.smsPumpingRisk = payload.sms_pumping_risk !== null && payload.sms_pumping_risk !== undefined ? new SmsPumpingRiskInfo(payload.sms_pumping_risk) : null;
  ...
  fetchWithHttpInfo(params: PhoneNumberContextFetchOptions, callback?: (error: Error | null, item?: ApiResponse<PhoneNumberInstance>) => any): Promise<ApiResponse<PhoneNumberInstance>>;
    ...
    fetchWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<PhoneNumberInstance>) => any): Promise<ApiResponse<PhoneNumberInstance>>
    {
