...
interface PhoneNumberResource {
  ...
  caller_name: Record<string, any>;
  sim_swap: Record<string, any>;
  call_forwarding: Record<string, any>;
  line_status: Record<string, any>;
  line_type_intelligence: Record<string, any>;
  identity_match: Record<string, any>;
  reassigned_number: Record<string, any>;
  sms_pumping_risk: Record<string, any>;
  phone_number_quality_score: Record<string, any>;
  pre_fill: Record<string, any>;
  url: string;
}
...
export class PhoneNumberInstance {
   ...
   */
  identityMatch: Record<string, any>;
  /**
   ...
   */
  reassignedNumber: Record<string, any>;
  /**
   ...
   */
  smsPumpingRisk: Record<string, any>;
  /**
   ...
   */
  phoneNumberQualityScore: Record<string, any>;
  /**
