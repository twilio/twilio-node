...
export class NetworkAccessProfileContextImpl implements NetworkAccessProfileContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<NetworkAccessProfileInstance>) => any): Promise<ApiResponse<NetworkAccessProfileInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<NetworkAccessProfileResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<NetworkAccessProfileInstance> => ({
      ...response,
  ...
  updateWithHttpInfo(params?: NetworkAccessProfileContextUpdateOptions | ((error: Error | null, item?: ApiResponse<NetworkAccessProfileInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<NetworkAccessProfileInstance>) => any): Promise<ApiResponse<NetworkAccessProfileInstance>> {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.updateWithResponseInfo<NetworkAccessProfileResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<NetworkAccessProfileInstance> => ({
      ...response,
      body: new NetworkAccessProfileInstance(operationVersion, response.body, instance._solution.sid)
    }));
...
export class NetworkAccessProfileInstance {
  ...
  constructor(protected _version: V1, payload: NetworkAccessProfileResource, sid?: string) {
  ...
  update(params: NetworkAccessProfileContextUpdateOptions, callback?: (error: Error | null, item?: NetworkAccessProfileInstance) => any): Promise<NetworkAccessProfileInstance>;
    ...
    update(params?: any, callback?: (error: Error | null, item?: NetworkAccessProfileInstance) => any): Promise<NetworkAccessProfileInstance>
    {
  ...
  updateWithHttpInfo(params: NetworkAccessProfileContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<NetworkAccessProfileInstance>) => any): Promise<ApiResponse<NetworkAccessProfileInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<NetworkAccessProfileInstance>) => any): Promise<ApiResponse<NetworkAccessProfileInstance>>
    {
...
export function NetworkAccessProfileListInstance(version: V1): NetworkAccessProfileListInstance {
  const instance = ((sid, ) => instance.get(sid, )) as NetworkAccessProfileListInstance;
  ...
  instance.create = function create(params?: NetworkAccessProfileListInstanceCreateOptions | ((error: Error | null, items: NetworkAccessProfileInstance) => any), callback?: (error: Error | null, items: NetworkAccessProfileInstance) => any): Promise<NetworkAccessProfileInstance> {
    if (params instanceof Function) {
      callback = params;
      params = {} as any;
    } else {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params?: NetworkAccessProfileListInstanceCreateOptions | ((error: Error | null, items: ApiResponse<NetworkAccessProfileInstance>) => any), callback?: (error: Error | null, items: ApiResponse<NetworkAccessProfileInstance>) => any): Promise<ApiResponse<NetworkAccessProfileInstance>> {
    if (params instanceof Function) {
      callback = params;
      params = {} as any;
    } else {
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<NetworkAccessProfileResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<NetworkAccessProfileInstance> => ({
      ...response,
  ...
  instance.page = function page(params?: NetworkAccessProfileListInstancePageOptions | ((error: Error | null, items: NetworkAccessProfilePage) => any), callback?: (error: Error | null, items: NetworkAccessProfilePage) => any): Promise<NetworkAccessProfilePage> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: NetworkAccessProfilePage) => any): Promise<NetworkAccessProfilePage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: NetworkAccessProfileListInstancePageOptions | ((error: Error | null, items: ApiResponse<NetworkAccessProfilePage>) => any), callback?: (error: Error | null, items: ApiResponse<NetworkAccessProfilePage>) => any): Promise<ApiResponse<NetworkAccessProfilePage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<NetworkAccessProfilePage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<NetworkAccessProfilePage>) => any): Promise<ApiResponse<NetworkAccessProfilePage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<NetworkAccessProfilePage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
