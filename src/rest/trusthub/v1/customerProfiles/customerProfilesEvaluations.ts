...
export class CustomerProfilesEvaluationsContextImpl implements CustomerProfilesEvaluationsContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<CustomerProfilesEvaluationsInstance>) => any): Promise<ApiResponse<CustomerProfilesEvaluationsInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<CustomerProfilesEvaluationsResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<CustomerProfilesEvaluationsInstance> => ({
      ...response,
...
export class CustomerProfilesEvaluationsInstance {
  ...
  constructor(protected _version: V1, payload: CustomerProfilesEvaluationsResource, customerProfileSid: string, sid?: string) {
...
export function CustomerProfilesEvaluationsListInstance(version: V1, customerProfileSid: string): CustomerProfilesEvaluationsListInstance {
  if (!isValidPathParam(customerProfileSid)) {
    throw new Error('Parameter \'customerProfileSid\' is not valid.');
  }

  const instance = ((sid, ) => instance.get(sid, )) as CustomerProfilesEvaluationsListInstance;
  ...
  instance.create = function create(params: CustomerProfilesEvaluationsListInstanceCreateOptions, callback?: (error: Error | null, items: CustomerProfilesEvaluationsInstance) => any): Promise<CustomerProfilesEvaluationsInstance> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: CustomerProfilesEvaluationsListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<CustomerProfilesEvaluationsInstance>) => any): Promise<ApiResponse<CustomerProfilesEvaluationsInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<CustomerProfilesEvaluationsResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<CustomerProfilesEvaluationsInstance> => ({
      ...response,
  ...
  instance.page = function page(params?: CustomerProfilesEvaluationsListInstancePageOptions | ((error: Error | null, items: CustomerProfilesEvaluationsPage) => any), callback?: (error: Error | null, items: CustomerProfilesEvaluationsPage) => any): Promise<CustomerProfilesEvaluationsPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: CustomerProfilesEvaluationsPage) => any): Promise<CustomerProfilesEvaluationsPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: CustomerProfilesEvaluationsListInstancePageOptions | ((error: Error | null, items: ApiResponse<CustomerProfilesEvaluationsPage>) => any), callback?: (error: Error | null, items: ApiResponse<CustomerProfilesEvaluationsPage>) => any): Promise<ApiResponse<CustomerProfilesEvaluationsPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<CustomerProfilesEvaluationsPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<CustomerProfilesEvaluationsPage>) => any): Promise<ApiResponse<CustomerProfilesEvaluationsPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<CustomerProfilesEvaluationsPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
