...
export class TrustProductsEntityAssignmentsInstance {
  ...
  constructor(protected _version: V1, payload: TrustProductsEntityAssignmentsResource, trustProductSid: string, sid?: string) {
...
export function TrustProductsEntityAssignmentsListInstance(version: V1, trustProductSid: string): TrustProductsEntityAssignmentsListInstance {
  if (!isValidPathParam(trustProductSid)) {
    throw new Error('Parameter \'trustProductSid\' is not valid.');
  }

  const instance = ((sid, ) => instance.get(sid, )) as TrustProductsEntityAssignmentsListInstance;
  ...
  instance.create = function create(params: TrustProductsEntityAssignmentsListInstanceCreateOptions, callback?: (error: Error | null, items: TrustProductsEntityAssignmentsInstance) => any): Promise<TrustProductsEntityAssignmentsInstance> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: TrustProductsEntityAssignmentsListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<TrustProductsEntityAssignmentsInstance>) => any): Promise<ApiResponse<TrustProductsEntityAssignmentsInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<TrustProductsEntityAssignmentsResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<TrustProductsEntityAssignmentsInstance> => ({
      ...response,
  ...
  instance.page = function page(params?: TrustProductsEntityAssignmentsListInstancePageOptions | ((error: Error | null, items: TrustProductsEntityAssignmentsPage) => any), callback?: (error: Error | null, items: TrustProductsEntityAssignmentsPage) => any): Promise<TrustProductsEntityAssignmentsPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: TrustProductsEntityAssignmentsPage) => any): Promise<TrustProductsEntityAssignmentsPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: TrustProductsEntityAssignmentsListInstancePageOptions | ((error: Error | null, items: ApiResponse<TrustProductsEntityAssignmentsPage>) => any), callback?: (error: Error | null, items: ApiResponse<TrustProductsEntityAssignmentsPage>) => any): Promise<ApiResponse<TrustProductsEntityAssignmentsPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<TrustProductsEntityAssignmentsPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<TrustProductsEntityAssignmentsPage>) => any): Promise<ApiResponse<TrustProductsEntityAssignmentsPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<TrustProductsEntityAssignmentsPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
