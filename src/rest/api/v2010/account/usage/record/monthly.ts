...
export function MonthlyListInstance(version: V2010, accountSid: string): MonthlyListInstance {
  ...
  instance.page = function page(params?: MonthlyListInstancePageOptions | ((error: Error | null, items: MonthlyPage) => any), callback?: (error: Error | null, items: MonthlyPage) => any): Promise<MonthlyPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: MonthlyPage) => any): Promise<MonthlyPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: MonthlyListInstancePageOptions | ((error: Error | null, items: ApiResponse<MonthlyPage>) => any), callback?: (error: Error | null, items: ApiResponse<MonthlyPage>) => any): Promise<ApiResponse<MonthlyPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<MonthlyPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<MonthlyPage>) => any): Promise<ApiResponse<MonthlyPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<MonthlyPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
...
export class MonthlyInstance {
  ...
  constructor(protected _version: V2010, payload: MonthlyResource, accountSid: string) {
...
export class MonthlyPage extends Page<V2010, MonthlyPayload, MonthlyResource, MonthlyInstance> {
/**
