...
export class TranscriptionContextImpl implements TranscriptionContext {
  ...
  constructor(protected _version: V2010, accountSid: string, recordingSid: string, sid: string) {
...
export class TranscriptionInstance {
  ...
  constructor(protected _version: V2010, payload: TranscriptionResource, accountSid: string, recordingSid: string, sid?: string) {
...
export function TranscriptionListInstance(version: V2010, accountSid: string, recordingSid: string): TranscriptionListInstance {
  if (!isValidPathParam(accountSid)) {
    throw new Error('Parameter \'accountSid\' is not valid.');
  }
