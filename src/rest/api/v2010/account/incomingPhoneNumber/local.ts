...
export function LocalListInstance(version: V2010, accountSid: string): LocalListInstance {
  ...
  instance.create = function create(params: LocalListInstanceCreateOptions, callback?: (error: Error | null, items: LocalInstance) => any): Promise<LocalInstance> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: LocalListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<LocalInstance>) => any): Promise<ApiResponse<LocalInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationPromise = operationVersion.createWithResponseInfo<LocalResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<LocalInstance> => ({
      ...response,
  ...
  instance.page = function page(params?: LocalListInstancePageOptions | ((error: Error | null, items: LocalPage) => any), callback?: (error: Error | null, items: LocalPage) => any): Promise<LocalPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: LocalPage) => any): Promise<LocalPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: LocalListInstancePageOptions | ((error: Error | null, items: ApiResponse<LocalPage>) => any), callback?: (error: Error | null, items: ApiResponse<LocalPage>) => any): Promise<ApiResponse<LocalPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<LocalPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<LocalPage>) => any): Promise<ApiResponse<LocalPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<LocalPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
...
export class LocalInstance {
  ...
  constructor(protected _version: V2010, payload: LocalResource, accountSid: string) {
