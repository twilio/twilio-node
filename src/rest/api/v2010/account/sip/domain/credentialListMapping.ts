...
export class CredentialListMappingContextImpl implements CredentialListMappingContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<CredentialListMappingInstance>) => any): Promise<ApiResponse<CredentialListMappingInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<CredentialListMappingResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<CredentialListMappingInstance> => ({
      ...response,
...
export class CredentialListMappingInstance {
  ...
  constructor(protected _version: V2010, payload: CredentialListMappingResource, accountSid: string, domainSid: string, sid?: string) {
...
export function CredentialListMappingListInstance(version: V2010, accountSid: string, domainSid: string): CredentialListMappingListInstance {
  ...
  const instance = ((sid, ) => instance.get(sid, )) as CredentialListMappingListInstance;
  ...
  instance.create = function create(params: CredentialListMappingListInstanceCreateOptions, callback?: (error: Error | null, items: CredentialListMappingInstance) => any): Promise<CredentialListMappingInstance> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: CredentialListMappingListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<CredentialListMappingInstance>) => any): Promise<ApiResponse<CredentialListMappingInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<CredentialListMappingResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<CredentialListMappingInstance> => ({
      ...response,
  ...
  instance.page = function page(params?: CredentialListMappingListInstancePageOptions | ((error: Error | null, items: CredentialListMappingPage) => any), callback?: (error: Error | null, items: CredentialListMappingPage) => any): Promise<CredentialListMappingPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: CredentialListMappingPage) => any): Promise<CredentialListMappingPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: CredentialListMappingListInstancePageOptions | ((error: Error | null, items: ApiResponse<CredentialListMappingPage>) => any), callback?: (error: Error | null, items: ApiResponse<CredentialListMappingPage>) => any): Promise<ApiResponse<CredentialListMappingPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<CredentialListMappingPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<CredentialListMappingPage>) => any): Promise<ApiResponse<CredentialListMappingPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<CredentialListMappingPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
