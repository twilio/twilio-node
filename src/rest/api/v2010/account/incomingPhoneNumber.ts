...
export class IncomingPhoneNumberContextImpl implements IncomingPhoneNumberContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<IncomingPhoneNumberInstance>) => any): Promise<ApiResponse<IncomingPhoneNumberInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<IncomingPhoneNumberResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<IncomingPhoneNumberInstance> => ({
      ...response,
  ...
  updateWithHttpInfo(params?: IncomingPhoneNumberContextUpdateOptions | ((error: Error | null, item?: ApiResponse<IncomingPhoneNumberInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<IncomingPhoneNumberInstance>) => any): Promise<ApiResponse<IncomingPhoneNumberInstance>> {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.updateWithResponseInfo<IncomingPhoneNumberResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<IncomingPhoneNumberInstance> => ({
      ...response,
      body: new IncomingPhoneNumberInstance(operationVersion, response.body, instance._solution.accountSid, instance._solution.sid)
    }));
...
export class IncomingPhoneNumberInstance {
  ...
  constructor(protected _version: V2010, payload: IncomingPhoneNumberResource, accountSid: string, sid?: string) {
  ...
  update(params: IncomingPhoneNumberContextUpdateOptions, callback?: (error: Error | null, item?: IncomingPhoneNumberInstance) => any): Promise<IncomingPhoneNumberInstance>;
    ...
    update(params?: any, callback?: (error: Error | null, item?: IncomingPhoneNumberInstance) => any): Promise<IncomingPhoneNumberInstance>
    {
  ...
  updateWithHttpInfo(params: IncomingPhoneNumberContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<IncomingPhoneNumberInstance>) => any): Promise<ApiResponse<IncomingPhoneNumberInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<IncomingPhoneNumberInstance>) => any): Promise<ApiResponse<IncomingPhoneNumberInstance>>
    {
...
export function IncomingPhoneNumberListInstance(version: V2010, accountSid: string): IncomingPhoneNumberListInstance {
  ...
  const instance = ((sid, ) => instance.get(sid, )) as IncomingPhoneNumberListInstance;
  ...
  Object.defineProperty(instance, "local", {
    get: function local() {
      if (!instance._local) {
        instance._local = LocalListInstance(instance._version, instance._solution.accountSid);
      }
  ...
  Object.defineProperty(instance, "mobile", {
    get: function mobile() {
      if (!instance._mobile) {
        instance._mobile = MobileListInstance(instance._version, instance._solution.accountSid);
      }
  ...
  Object.defineProperty(instance, "tollFree", {
    get: function tollFree() {
      if (!instance._tollFree) {
        instance._tollFree = TollFreeListInstance(instance._version, instance._solution.accountSid);
      }
      return instance._tollFree;
    }
  });

  instance.create = function create(params?: IncomingPhoneNumberListInstanceCreateOptions | ((error: Error | null, items: IncomingPhoneNumberInstance) => any), callback?: (error: Error | null, items: IncomingPhoneNumberInstance) => any): Promise<IncomingPhoneNumberInstance> {
    if (params instanceof Function) {
      callback = params;
      params = {} as any;
    } else {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params?: IncomingPhoneNumberListInstanceCreateOptions | ((error: Error | null, items: ApiResponse<IncomingPhoneNumberInstance>) => any), callback?: (error: Error | null, items: ApiResponse<IncomingPhoneNumberInstance>) => any): Promise<ApiResponse<IncomingPhoneNumberInstance>> {
    if (params instanceof Function) {
      callback = params;
      params = {} as any;
    } else {
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<IncomingPhoneNumberResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<IncomingPhoneNumberInstance> => ({
      ...response,
  ...
  instance.page = function page(params?: IncomingPhoneNumberListInstancePageOptions | ((error: Error | null, items: IncomingPhoneNumberPage) => any), callback?: (error: Error | null, items: IncomingPhoneNumberPage) => any): Promise<IncomingPhoneNumberPage> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: IncomingPhoneNumberPage) => any): Promise<IncomingPhoneNumberPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: IncomingPhoneNumberListInstancePageOptions | ((error: Error | null, items: ApiResponse<IncomingPhoneNumberPage>) => any), callback?: (error: Error | null, items: ApiResponse<IncomingPhoneNumberPage>) => any): Promise<ApiResponse<IncomingPhoneNumberPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<IncomingPhoneNumberPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<IncomingPhoneNumberPage>) => any): Promise<ApiResponse<IncomingPhoneNumberPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<IncomingPhoneNumberPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
