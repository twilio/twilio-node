...
export function NationalListInstance(version: V2010, accountSid: string, countryCode: string): NationalListInstance {
  ...
  instance.page = function page(params?: NationalListInstancePageOptions | ((error: Error | null, items: NationalPage) => any), callback?: (error: Error | null, items: NationalPage) => any): Promise<NationalPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: NationalPage) => any): Promise<NationalPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: NationalListInstancePageOptions | ((error: Error | null, items: ApiResponse<NationalPage>) => any), callback?: (error: Error | null, items: ApiResponse<NationalPage>) => any): Promise<ApiResponse<NationalPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<NationalPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<NationalPage>) => any): Promise<ApiResponse<NationalPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<NationalPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
...
export class NationalInstance {
  ...
  constructor(protected _version: V2010, payload: NationalResource, accountSid: string, countryCode: string) {
