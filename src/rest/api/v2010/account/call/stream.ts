...
export class StreamContextImpl implements StreamContext {
  ...
  updateWithHttpInfo(params: StreamContextUpdateOptions,callback?: (error: Error | null, item?: ApiResponse<StreamInstance>) => any): Promise<ApiResponse<StreamInstance>> {
    ...
    let operationPromise = operationVersion.updateWithResponseInfo<StreamResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<StreamInstance> => ({
      ...response,
...
export class StreamInstance {
  ...
  constructor(protected _version: V2010, payload: StreamResource, accountSid: string, callSid: string, sid?: string) {
  ...
  update(params: StreamContextUpdateOptions, callback?: (error: Error | null, item?: StreamInstance) => any): Promise<StreamInstance>;
    ...
    update(params?: any, callback?: (error: Error | null, item?: StreamInstance) => any): Promise<StreamInstance>
    {
  ...
  updateWithHttpInfo(params: StreamContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<StreamInstance>) => any): Promise<ApiResponse<StreamInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<StreamInstance>) => any): Promise<ApiResponse<StreamInstance>>
    {
...
export function StreamListInstance(version: V2010, accountSid: string, callSid: string): StreamListInstance {
  if (!isValidPathParam(accountSid)) {
    throw new Error('Parameter \'accountSid\' is not valid.');
  }
  ...
  instance.create = function create(params: StreamListInstanceCreateOptions, callback?: (error: Error | null, items: StreamInstance) => any): Promise<StreamInstance> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: StreamListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<StreamInstance>) => any): Promise<ApiResponse<StreamInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<StreamResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<StreamInstance> => ({
      ...response,
