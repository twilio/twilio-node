...
export class RecordingInstance {
  ...
  constructor(protected _version: V2010, payload: RecordingResource, accountSid: string, callSid: string, sid?: string) {
...
export function RecordingListInstance(version: V2010, accountSid: string, callSid: string): RecordingListInstance {
  if (!isValidPathParam(accountSid)) {
    throw new Error('Parameter \'accountSid\' is not valid.');
  }
  ...
  instance.create = function create(params?: RecordingListInstanceCreateOptions | ((error: Error | null, items: RecordingInstance) => any), callback?: (error: Error | null, items: RecordingInstance) => any): Promise<RecordingInstance> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params?: RecordingListInstanceCreateOptions | ((error: Error | null, items: ApiResponse<RecordingInstance>) => any), callback?: (error: Error | null, items: ApiResponse<RecordingInstance>) => any): Promise<ApiResponse<RecordingInstance>> {
    if (params instanceof Function) {
      callback = params;
      params = {} as any;
    } else {
