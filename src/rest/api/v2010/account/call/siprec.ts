...
export class SiprecContextImpl implements SiprecContext {
  ...
  updateWithHttpInfo(params: SiprecContextUpdateOptions,callback?: (error: Error | null, item?: ApiResponse<SiprecInstance>) => any): Promise<ApiResponse<SiprecInstance>> {
    ...
    let operationPromise = operationVersion.updateWithResponseInfo<SiprecResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<SiprecInstance> => ({
      ...response,
...
export class SiprecInstance {
  ...
  updateWithHttpInfo(params: SiprecContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<SiprecInstance>) => any): Promise<ApiResponse<SiprecInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<SiprecInstance>) => any): Promise<ApiResponse<SiprecInstance>>
    {
...
export function SiprecListInstance(version: V2010, accountSid: string, callSid: string): SiprecListInstance {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params?: SiprecListInstanceCreateOptions | ((error: Error | null, items: ApiResponse<SiprecInstance>) => any), callback?: (error: Error | null, items: ApiResponse<SiprecInstance>) => any): Promise<ApiResponse<SiprecInstance>> {
    if (params instanceof Function) {
      callback = params;
      params = {} as any;
    } else {
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<SiprecResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<SiprecInstance> => ({
      ...response,
