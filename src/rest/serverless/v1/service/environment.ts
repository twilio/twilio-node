...
export class EnvironmentContextImpl implements EnvironmentContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<EnvironmentInstance>) => any): Promise<ApiResponse<EnvironmentInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<EnvironmentResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<EnvironmentInstance> => ({
      ...response,
...
export function EnvironmentListInstance(version: V1, serviceSid: string): EnvironmentListInstance {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: EnvironmentListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<EnvironmentInstance>) => any): Promise<ApiResponse<EnvironmentInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<EnvironmentResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<EnvironmentInstance> => ({
      ...response,
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: EnvironmentListInstancePageOptions | ((error: Error | null, items: ApiResponse<EnvironmentPage>) => any), callback?: (error: Error | null, items: ApiResponse<EnvironmentPage>) => any): Promise<ApiResponse<EnvironmentPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<EnvironmentPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<EnvironmentPage>) => any): Promise<ApiResponse<EnvironmentPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<EnvironmentPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
