...
export class AssetVersionContextImpl implements AssetVersionContext {
  ...
  constructor(protected _version: V1, serviceSid: string, assetSid: string, sid: string) {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<AssetVersionInstance>) => any): Promise<ApiResponse<AssetVersionInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<AssetVersionResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<AssetVersionInstance> => ({
      ...response,
...
export class AssetVersionInstance {
  ...
  constructor(protected _version: V1, payload: AssetVersionResource, serviceSid: string, assetSid: string, sid?: string) {
...
export function AssetVersionListInstance(version: V1, serviceSid: string, assetSid: string): AssetVersionListInstance {
  if (!isValidPathParam(serviceSid)) {
    throw new Error('Parameter \'serviceSid\' is not valid.');
  }
  ...
  instance.page = function page(params?: AssetVersionListInstancePageOptions | ((error: Error | null, items: AssetVersionPage) => any), callback?: (error: Error | null, items: AssetVersionPage) => any): Promise<AssetVersionPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: AssetVersionPage) => any): Promise<AssetVersionPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: AssetVersionListInstancePageOptions | ((error: Error | null, items: ApiResponse<AssetVersionPage>) => any), callback?: (error: Error | null, items: ApiResponse<AssetVersionPage>) => any): Promise<ApiResponse<AssetVersionPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<AssetVersionPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<AssetVersionPage>) => any): Promise<ApiResponse<AssetVersionPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<AssetVersionPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
