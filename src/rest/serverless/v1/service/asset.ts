...
export class AssetContextImpl implements AssetContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<AssetInstance>) => any): Promise<ApiResponse<AssetInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<AssetResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<AssetInstance> => ({
      ...response,
  ...
  updateWithHttpInfo(params: AssetContextUpdateOptions,callback?: (error: Error | null, item?: ApiResponse<AssetInstance>) => any): Promise<ApiResponse<AssetInstance>> {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.updateWithResponseInfo<AssetResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<AssetInstance> => ({
      ...response,
      body: new AssetInstance(operationVersion, response.body, instance._solution.serviceSid, instance._solution.sid)
    }));
...
export class AssetInstance {
  ...
  updateWithHttpInfo(params: AssetContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<AssetInstance>) => any): Promise<ApiResponse<AssetInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<AssetInstance>) => any): Promise<ApiResponse<AssetInstance>>
    {
...
export function AssetListInstance(version: V1, serviceSid: string): AssetListInstance {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: AssetListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<AssetInstance>) => any): Promise<ApiResponse<AssetInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<AssetResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<AssetInstance> => ({
      ...response,
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: AssetListInstancePageOptions | ((error: Error | null, items: ApiResponse<AssetPage>) => any), callback?: (error: Error | null, items: ApiResponse<AssetPage>) => any): Promise<ApiResponse<AssetPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<AssetPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<AssetPage>) => any): Promise<ApiResponse<AssetPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<AssetPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
