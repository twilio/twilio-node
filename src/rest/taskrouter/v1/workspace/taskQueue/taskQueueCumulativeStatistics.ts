...
export class TaskQueueCumulativeStatisticsContextImpl implements TaskQueueCumulativeStatisticsContext {
  ...
  fetchWithHttpInfo(params?: TaskQueueCumulativeStatisticsContextFetchOptions | ((error: Error | null, item?: ApiResponse<TaskQueueCumulativeStatisticsInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<TaskQueueCumulativeStatisticsInstance>) => any): Promise<ApiResponse<TaskQueueCumulativeStatisticsInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<TaskQueueCumulativeStatisticsResource>({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<TaskQueueCumulativeStatisticsInstance> => ({
      ...response,
...
export class TaskQueueCumulativeStatisticsInstance {
  ...
  fetchWithHttpInfo(params: TaskQueueCumulativeStatisticsContextFetchOptions, callback?: (error: Error | null, item?: ApiResponse<TaskQueueCumulativeStatisticsInstance>) => any): Promise<ApiResponse<TaskQueueCumulativeStatisticsInstance>>;
    ...
    fetchWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<TaskQueueCumulativeStatisticsInstance>) => any): Promise<ApiResponse<TaskQueueCumulativeStatisticsInstance>>
    {
