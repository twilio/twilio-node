...
export function TaskQueueBulkRealTimeStatisticsListInstance(version: V1, workspaceSid: string): TaskQueueBulkRealTimeStatisticsListInstance {
  ...
  instance.create = function create(params?: object | ((error: Error | null, items: TaskQueueBulkRealTimeStatisticsInstance) => any), callback?: (error: Error | null, items: TaskQueueBulkRealTimeStatisticsInstance) => any): Promise<TaskQueueBulkRealTimeStatisticsInstance> {
