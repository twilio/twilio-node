...
export function TaskQueueBulkRealTimeStatisticsListInstance(version: V1, workspaceSid: string): TaskQueueBulkRealTimeStatisticsListInstance {
  ...
  instance.create = function create(params?: object | ((error: Error | null, items: TaskQueueBulkRealTimeStatisticsInstance) => any), headers?: any, callback?: (error: Error | null, items: TaskQueueBulkRealTimeStatisticsInstance) => any): Promise<TaskQueueBulkRealTimeStatisticsInstance> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params?: object | ((error: Error | null, items: ApiResponse<TaskQueueBulkRealTimeStatisticsInstance>) => any), headers?: any, callback?: (error: Error | null, items: ApiResponse<TaskQueueBulkRealTimeStatisticsInstance>) => any): Promise<ApiResponse<TaskQueueBulkRealTimeStatisticsInstance>> {
    if (params instanceof Function) {
      callback = params;
      params = {} as Partial<object> as object;
    } else {
    ...
    let operationPromise = operationVersion.createWithResponseInfo<TaskQueueBulkRealTimeStatisticsResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<TaskQueueBulkRealTimeStatisticsInstance> => ({
      ...response,
...
export class TaskQueueBulkRealTimeStatisticsInstance {
  ...
  constructor(protected _version: V1, payload: TaskQueueBulkRealTimeStatisticsResource, workspaceSid: string) {
