...
export class WorkerStatisticsContextImpl implements WorkerStatisticsContext {
  ...
  fetchWithHttpInfo(params?: WorkerStatisticsContextFetchOptions | ((error: Error | null, item?: ApiResponse<WorkerStatisticsInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<WorkerStatisticsInstance>) => any): Promise<ApiResponse<WorkerStatisticsInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<WorkerStatisticsResource>({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<WorkerStatisticsInstance> => ({
      ...response,
...
export class WorkerStatisticsInstance {
  ...
  constructor(protected _version: V1, payload: WorkerStatisticsResource, workspaceSid: string, workerSid: string) {
  ...
  fetch(params: WorkerStatisticsContextFetchOptions, callback?: (error: Error | null, item?: WorkerStatisticsInstance) => any): Promise<WorkerStatisticsInstance>;
    ...
    fetch(params?: any, callback?: (error: Error | null, item?: WorkerStatisticsInstance) => any): Promise<WorkerStatisticsInstance>
    {
  ...
  fetchWithHttpInfo(params: WorkerStatisticsContextFetchOptions, callback?: (error: Error | null, item?: ApiResponse<WorkerStatisticsInstance>) => any): Promise<ApiResponse<WorkerStatisticsInstance>>;
    ...
    fetchWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<WorkerStatisticsInstance>) => any): Promise<ApiResponse<WorkerStatisticsInstance>>
    {
