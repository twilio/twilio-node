...
export class WorkflowCumulativeStatisticsContextImpl implements WorkflowCumulativeStatisticsContext {
  ...
  fetchWithHttpInfo(params?: WorkflowCumulativeStatisticsContextFetchOptions | ((error: Error | null, item?: ApiResponse<WorkflowCumulativeStatisticsInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<WorkflowCumulativeStatisticsInstance>) => any): Promise<ApiResponse<WorkflowCumulativeStatisticsInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<WorkflowCumulativeStatisticsResource>({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<WorkflowCumulativeStatisticsInstance> => ({
      ...response,
...
export class WorkflowCumulativeStatisticsInstance {
  ...
  constructor(protected _version: V1, payload: WorkflowCumulativeStatisticsResource, workspaceSid: string, workflowSid: string) {
  ...
  fetchWithHttpInfo(params: WorkflowCumulativeStatisticsContextFetchOptions, callback?: (error: Error | null, item?: ApiResponse<WorkflowCumulativeStatisticsInstance>) => any): Promise<ApiResponse<WorkflowCumulativeStatisticsInstance>>;
    ...
    fetchWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<WorkflowCumulativeStatisticsInstance>) => any): Promise<ApiResponse<WorkflowCumulativeStatisticsInstance>>
    {
...
export function WorkflowCumulativeStatisticsListInstance(version: V1, workspaceSid: string, workflowSid: string): WorkflowCumulativeStatisticsListInstance {
  ...
  const instance = (() => instance.get()) as WorkflowCumulativeStatisticsListInstance;
