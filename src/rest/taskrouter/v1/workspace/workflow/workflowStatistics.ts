...
export class WorkflowStatisticsContextImpl implements WorkflowStatisticsContext {
  ...
  fetchWithHttpInfo(params?: WorkflowStatisticsContextFetchOptions | ((error: Error | null, item?: ApiResponse<WorkflowStatisticsInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<WorkflowStatisticsInstance>) => any): Promise<ApiResponse<WorkflowStatisticsInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<WorkflowStatisticsResource>({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<WorkflowStatisticsInstance> => ({
      ...response,
...
export class WorkflowStatisticsInstance {
  ...
  constructor(protected _version: V1, payload: WorkflowStatisticsResource, workspaceSid: string, workflowSid: string) {
  ...
  fetch(params: WorkflowStatisticsContextFetchOptions, callback?: (error: Error | null, item?: WorkflowStatisticsInstance) => any): Promise<WorkflowStatisticsInstance>;
    ...
    fetch(params?: any, callback?: (error: Error | null, item?: WorkflowStatisticsInstance) => any): Promise<WorkflowStatisticsInstance>
    {
  ...
  fetchWithHttpInfo(params: WorkflowStatisticsContextFetchOptions, callback?: (error: Error | null, item?: ApiResponse<WorkflowStatisticsInstance>) => any): Promise<ApiResponse<WorkflowStatisticsInstance>>;
    ...
    fetchWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<WorkflowStatisticsInstance>) => any): Promise<ApiResponse<WorkflowStatisticsInstance>>
    {
