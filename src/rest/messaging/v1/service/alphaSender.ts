...
export class AlphaSenderContextImpl implements AlphaSenderContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<AlphaSenderInstance>) => any): Promise<ApiResponse<AlphaSenderInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<AlphaSenderResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<AlphaSenderInstance> => ({
      ...response,
...
export class AlphaSenderInstance {
  ...
  constructor(protected _version: V1, payload: AlphaSenderResource, serviceSid: string, sid?: string) {
...
export function AlphaSenderListInstance(version: V1, serviceSid: string): AlphaSenderListInstance {
  if (!isValidPathParam(serviceSid)) {
    throw new Error('Parameter \'serviceSid\' is not valid.');
  }
  ...
  instance.create = function create(params: AlphaSenderListInstanceCreateOptions, callback?: (error: Error | null, items: AlphaSenderInstance) => any): Promise<AlphaSenderInstance> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: AlphaSenderListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<AlphaSenderInstance>) => any): Promise<ApiResponse<AlphaSenderInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationVersion = version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.createWithResponseInfo<AlphaSenderResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<AlphaSenderInstance> => ({
      ...response,
  ...
  instance.page = function page(params?: AlphaSenderListInstancePageOptions | ((error: Error | null, items: AlphaSenderPage) => any), callback?: (error: Error | null, items: AlphaSenderPage) => any): Promise<AlphaSenderPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: AlphaSenderPage) => any): Promise<AlphaSenderPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: AlphaSenderListInstancePageOptions | ((error: Error | null, items: ApiResponse<AlphaSenderPage>) => any), callback?: (error: Error | null, items: ApiResponse<AlphaSenderPage>) => any): Promise<ApiResponse<AlphaSenderPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<AlphaSenderPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<AlphaSenderPage>) => any): Promise<ApiResponse<AlphaSenderPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<AlphaSenderPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
