...
export class DomainConfigContextImpl implements DomainConfigContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<DomainConfigInstance>) => any): Promise<ApiResponse<DomainConfigInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<DomainConfigResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<DomainConfigInstance> => ({
      ...response,
  ...
  updateWithHttpInfo(params?: DomainConfigContextUpdateOptions | ((error: Error | null, item?: ApiResponse<DomainConfigInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<DomainConfigInstance>) => any): Promise<ApiResponse<DomainConfigInstance>> {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.updateWithResponseInfo<DomainConfigResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<DomainConfigInstance> => ({
      ...response,
      body: new DomainConfigInstance(operationVersion, response.body, instance._solution.domainSid)
    }));
...
export class DomainConfigInstance {
  ...
  constructor(protected _version: V1, payload: DomainConfigResource, domainSid?: string) {
  ...
  update(params: DomainConfigContextUpdateOptions, callback?: (error: Error | null, item?: DomainConfigInstance) => any): Promise<DomainConfigInstance>;
    ...
    update(params?: any, callback?: (error: Error | null, item?: DomainConfigInstance) => any): Promise<DomainConfigInstance>
    {
  ...
  updateWithHttpInfo(params: DomainConfigContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<DomainConfigInstance>) => any): Promise<ApiResponse<DomainConfigInstance>>;
    ...
    updateWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<DomainConfigInstance>) => any): Promise<ApiResponse<DomainConfigInstance>>
    {
...
export function DomainConfigListInstance(version: V1): DomainConfigListInstance {
  const instance = ((domainSid, ) => instance.get(domainSid, )) as DomainConfigListInstance;
