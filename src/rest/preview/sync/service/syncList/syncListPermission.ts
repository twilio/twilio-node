...
export class SyncListPermissionContextImpl implements SyncListPermissionContext {
  ...
  constructor(protected _version: Sync, serviceSid: string, listSid: string, identity: string) {
...
export class SyncListPermissionInstance {
  ...
  constructor(protected _version: Sync, payload: SyncListPermissionResource, serviceSid: string, listSid: string, identity?: string) {
    ...
    this._solution = { serviceSid, listSid, identity: identity || this.identity,  };
  }
...
export function SyncListPermissionListInstance(version: Sync, serviceSid: string, listSid: string): SyncListPermissionListInstance {
  if (!isValidPathParam(serviceSid)) {
    throw new Error('Parameter \'serviceSid\' is not valid.');
  }
