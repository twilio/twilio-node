...
export class SyncMapInstance {
  ...
  constructor(protected _version: Sync, payload: SyncMapResource, serviceSid: string, sid?: string) {
...
export function SyncMapListInstance(version: Sync, serviceSid: string): SyncMapListInstance {
  if (!isValidPathParam(serviceSid)) {
    throw new Error('Parameter \'serviceSid\' is not valid.');
  }
