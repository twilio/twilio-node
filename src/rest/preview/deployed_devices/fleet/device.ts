...
export class DeviceInstance {
  ...
  constructor(protected _version: DeployedDevices, payload: DeviceResource, fleetSid: string, sid?: string) {
  ...
  private get _proxy(): DeviceContext {
    this._context = this._context || new DeviceContextImpl(this._version, this._solution.fleetSid, this._solution.sid);
  ...
  update(params: DeviceContextUpdateOptions, callback?: (error: Error | null, item?: DeviceInstance) => any): Promise<DeviceInstance>;
    ...
    update(params?: any, callback?: (error: Error | null, item?: DeviceInstance) => any): Promise<DeviceInstance>
    {
...
export function DeviceListInstance(version: DeployedDevices, fleetSid: string): DeviceListInstance {
  if (!isValidPathParam(fleetSid)) {
    throw new Error('Parameter \'fleetSid\' is not valid.');
  }
  ...
  instance.create = function create(params?: DeviceListInstanceCreateOptions | ((error: Error | null, items: DeviceInstance) => any), callback?: (error: Error | null, items: DeviceInstance) => any): Promise<DeviceInstance> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
  ...
  instance.page = function page(params?: DeviceListInstancePageOptions | ((error: Error | null, items: DevicePage) => any), callback?: (error: Error | null, items: DevicePage) => any): Promise<DevicePage> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: DevicePage) => any): Promise<DevicePage> {
