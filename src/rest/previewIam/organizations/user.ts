...
export interface UserContext {
   ...
   * @returns Resolves to processed UserInstance
   */
  update(params: ScimUser, callback?: (error: Error | null, item?: UserInstance) => any): Promise<UserInstance>;
...
export class UserInstance {
  ...
  constructor(protected _version: Organizations, payload: UserResource, organizationSid?: string, userSid?: string) {
    ...
    this._solution = { organizationSid: organizationSid || this.organizationSid, userSid: userSid || this.userSid,  };
  }
...
export interface UserListInstance {
   ...
   * @returns Resolves to processed UserInstance
   */
  create(params: ScimUser, callback?: (error: Error | null, item?: UserInstance) => any): Promise<UserInstance>;
...
export function UserListInstance(version: Organizations, organizationSid: string): UserListInstance {
  ...
  instance.create = function create(params: ScimUser, callback?: (error: Error | null, items: UserInstance) => any): Promise<UserInstance> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
