...
export function RuleExecutionListInstance(version: V3): RuleExecutionListInstance {
  ...
  instance.create = function create(params: CreateRuleExecutionRequest, headers?: any, callback?: (error: Error | null, items: void) => any): Promise<void> {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: CreateRuleExecutionRequest, headers?: any, callback?: (error: Error | null, items: ApiResponse<void>) => any): Promise<ApiResponse<void>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
