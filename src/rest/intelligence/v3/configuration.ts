...
export class ConfigurationInstance {
  ...
  constructor(protected _version: V3, _payload: ConfigurationResource, id?: string) {
...
export function ConfigurationListInstance(version: V3): ConfigurationListInstance {
  ...
  instance.create = function create(params: CreateConfigurationRequest, headers?: any, callback?: (error: Error | null, items: ConfigurationInstance) => any): Promise<ConfigurationInstance> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: CreateConfigurationRequest, headers?: any, callback?: (error: Error | null, items: ApiResponse<ConfigurationInstance>) => any): Promise<ApiResponse<ConfigurationInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
...
export class ConfigurationPage extends TokenPage<V3, ConfigurationPayload, ConfigurationResource, ConfigurationInstance> {
/**
