...
export class OperatorResultInstance {
  ...
  constructor(protected _version: V3, _payload: OperatorResultResource, operatorResultId?: string) {
    ...
    this.intelligenceConfiguration = payload.intelligenceConfiguration !== null && payload.intelligenceConfiguration !== undefined ? new IntelligenceConfigurationReference(payload.intelligenceConfiguration) : null;
    this.conversationId = (payload.conversationId);
    this.operator = payload.operator !== null && payload.operator !== undefined ? new OperatorReference(payload.operator) : null;
    this.dateCreated = deserialize.iso8601DateTime(payload.dateCreated);
    this.referenceIds = (payload.referenceIds);
    this.executionDetails = payload.executionDetails !== null && payload.executionDetails !== undefined ? new ExecutionDetails(payload.executionDetails) : null;
    this.metadata = payload.metadata !== null && payload.metadata !== undefined ? new OperatorResultsResponseBaseMetadata(payload.metadata) : null;
...
export function OperatorResultListInstance(version: V3): OperatorResultListInstance {
  ...
  instance.page = function page(params?: OperatorResultListInstancePageOptions | ((error: Error | null, items: OperatorResultPage) => any), callback?: (error: Error | null, items: OperatorResultPage) => any): Promise<OperatorResultPage> {
    ...
    data["intelligenceConfigurationId"] = params["intelligenceConfigurationId"];
