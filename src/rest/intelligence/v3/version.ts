...
export class VersionContextImpl implements VersionContext {
  ...
  fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<VersionInstance>) => any): Promise<ApiResponse<VersionInstance>> {
    ...
    let operationPromise = operationVersion.fetchWithResponseInfo<VersionResource>({ uri: instance._uri, method: "get", headers}).then((response) : ApiResponse<VersionInstance> => ({
      ...response,
...
export class VersionInstance {
  ...
  constructor(protected _version: V3, _payload: VersionResource, id: string, versionParam?: number) {
  ...
  private get _proxy(): VersionContext {
    this._context = this._context || new VersionContextImpl(this._version, this._solution.id, this._solution.versionParam);
...
export function VersionListInstance(version: V3, id: string): VersionListInstance {
  if (!isValidPathParam(id)) {
    throw new Error('Parameter \'id\' is not valid.');
  }

  const instance = ((versionParam, ) => instance.get(versionParam, )) as VersionListInstance;
  ...
  instance.page = function page(params?: VersionListInstancePageOptions | ((error: Error | null, items: VersionPage) => any), callback?: (error: Error | null, items: VersionPage) => any): Promise<VersionPage> {
  ...
  instance.getPage = function getPage(targetUrl: string, callback?: (error: Error | null, items: VersionPage) => any): Promise<VersionPage> {
  ...
  instance.pageWithHttpInfo = function pageWithHttpInfo(params?: VersionListInstancePageOptions | ((error: Error | null, items: ApiResponse<VersionPage>) => any), callback?: (error: Error | null, items: ApiResponse<VersionPage>) => any): Promise<ApiResponse<VersionPage>> {
    if (params instanceof Function) {
      callback = params;
      params = {};
    } else {
    ...
    let operationPromise = operationVersion.page({ uri: instance._uri, method: "get", params: data, headers}).then((response) : ApiResponse<VersionPage> => ({
  ...
  instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items?: ApiResponse<VersionPage>) => any): Promise<ApiResponse<VersionPage>> {
    // Use request() directly as it already returns { statusCode, body, headers }
    const operationPromise = instance._version._domain.twilio.request({method: "get", uri: targetUrl});

    let pagePromise = operationPromise.then((response): ApiResponse<VersionPage> => ({
      statusCode: response.statusCode,
      headers: response.headers,
...
export class VersionPage extends TokenPage<V3, VersionPayload, VersionResource, VersionInstance> {
/**
