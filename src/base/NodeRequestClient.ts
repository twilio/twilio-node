...
let axios: any, fs: any, HttpsProxyAgent: any, qs: any, https: any, ValidationToken: any;
let AxiosInstance: any, AxiosRequestConfig: any, AxiosResponse: any, InternalAxiosRequestConfig: any;
let ValidationClientOptions: any;
...
if (isNode()) {
  try {
    ...
    qs = require("qs");
    https = require("https");
    ValidationToken = require("../jwt/validation/ValidationToken");
    const validationClientModule = require("./ValidationClient");
    ValidationClientOptions = validationClientModule.ValidationClientOptions;
    
    // Extract types from axios
    AxiosInstance = axios.AxiosInstance;
    AxiosRequestConfig = axios.AxiosRequestConfig;
    AxiosResponse = axios.AxiosResponse;
    InternalAxiosRequestConfig = axios.InternalAxiosRequestConfig;
  } catch (error) {
    // If imports fail, we'll fall back to fetch-based implementation
  }
}
